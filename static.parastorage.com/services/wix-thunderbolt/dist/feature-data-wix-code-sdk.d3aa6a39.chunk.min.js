  ...
  [3030],
  {
        ...
        l = (function (t) {
          ...
          function l() {
            ...
            for (var e = arguments.length, r = new Array(e), n = 0; n < e; n++)
              r[n] = arguments[n];
            return (
              (t = c.call.apply(c, [this].concat(r))),
              Error.captureStackTrace &&
                Error.captureStackTrace(u(t), t.constructor),
              (t.name = l.name),
              s.markUserError(u(t)),
              t
            );
    ...
    5939: function (t) {
      ...
      t.exports = function (t) {
        ...
        return "undefined" === r
          ...
          : "[object Symbol]" === r
          ? "symbol"
          : "[object Map Iterator]" === r
          ? "mapiterator"
          : "[object Set Iterator]" === r
          ? "setiterator"
          : "[object String Iterator]" === r
          ? "stringiterator"
          : "[object Array Iterator]" === r
          ? "arrayiterator"
          : "[object Int8Array]" === r
          ? "int8array"
          : "[object Uint8Array]" === r
    ...
    2295: function (t, e, r) {
      ...
      function d(t) {
        ...
        else for (var r in ((e = t.constructor()), t)) e[r] = d(t[r]);
        return e;
      }
      var f = r(2712);
      function h(t) {
      ...
      function v(t) {
        ...
        var e = N(t);
        for (var r in e)
          e[r] && e[r].$date && m(e[r].$date)
            ? (e[r] = new Date(e[r].$date))
            : "object" == typeof e[r] && null !== e[r] && (e[r] = v(e[r]));
        return e;
      }
      function g(t) {
        if ("object" != typeof t || h(t)) return t;
        ...
        for (var r in e)
          e[r] && h(e[r])
            ? (e[r] = y(e[r]))
            : "object" == typeof e[r] && null !== e[r] && (e[r] = g(e[r]));
        return e;
      }
      function y(t) {
        return { $date: t.toJSON() };
      }
      function N(t) {
      ...
      function b(t) {
        return t.reduce(function (t, e, r) {
          ...
          return "$match" === i && 0 === r
            ? { preFilteringStep: o }
            : "$match" === i
            ? (0, f.pi)((0, f.pi)({}, t), { postFilteringStep: o })
            : "$group" === i
            ? (0, f.pi)((0, f.pi)({}, t), { processingStep: o })
            : t;
        }, {});
      }
      function _(t) {
    ...
    3710: function (t) {
      ...
      function n(t) {
        ...
        return (function t(i) {
          ...
          if ((n.push(i), "function" == typeof i.toJSON))
            try {
              var o = t(i.toJSON());
              return n.pop(), o;
            } catch (t) {
    ...
    9646: function (t, e, r) {
      ...
      var s = function () {
        ...
        d = function (t) {
          return "WDE0069: Failed to remove items from [".concat(
            t,
        ...
        h = function (t, e) {
          return "WDE0004: Failed to save ["
            .concat(t, "] into [")
            .concat(e, "].\nItems must be JavaScript objects.");
        },
        m = function (t) {
          return "WDE0005: Failed to bulk save items into [".concat(
            t,
            "].\nItems must be an array of JavaScript objects and itemIds must be strings if present."
          );
        },
        v = function (t) {
          return "WDE0006: Failed to bulk save items into [".concat(
            t,
        ...
        y = function (t, e, r, n) {
          return "WDE0008: wixData."
            .concat(t, " expects between ")
            .concat(e, " and ")
            .concat(r, " arguments, but was called with ")
            .concat(n, ".");
        },
        N = {
          aggregateInvalid: function (t, e) {
            return "Failed to perform aggregation on ["
              .concat(t, "].\n")
              .concat(e.join("\n"));
          },
          filterMustBeBuilder: function (t) {
            return "WDE0011: Invalid "
              .concat(t, " usage. ")
              .concat(t, " requires WixDataFilter.");
          },
          filterIsAlreadySet: function (t) {
            return "WDE0012: Invalid ".concat(
              t,
              " usage. Filter is already set."
            );
          },
          groupIsAlreadySet: function (t) {
            return "WDE0013: Invalid ".concat(
              t,
              " usage. Group is already set."
            );
          },
        },
        b = function (t) {
        ...
        A = function (t) {
          return "WDE0018: Options must be an object with one or all of the following boolean properties: ".concat(
            t.join(", "),
            "."
          );
        },
        ...
        E = {
          queryInvalid: function (t, e) {
            return "Failed to perform query on ["
              .concat(t, "].\n")
              .concat(e.join("\n"));
          },
          isNumber: function (t, e, r) {
            return "WDE0032: Invalid "
              .concat(t, " parameter [")
              .concat((0, i.cc)(r), "]. ")
              .concat(t, " parameter must be a ")
              .concat(e, " number.");
          },
          isPositiveNumber: function (t, e) {
            return "WDE0033: Invalid "
              .concat(t, " parameter [")
              .concat(e, "]. ")
              .concat(t, " parameter must be a positive number.");
          },
          isNonNegativeNumber: function (t, e) {
            return "WDE0034: Invalid "
              .concat(t, " parameter [")
              .concat(e, "]. ")
              .concat(t, " parameter must be a non-negative number.");
          },
          isInteger: function (t, e) {
            return "WDE0035: Invalid "
              .concat(t, " parameter [")
              .concat(e, "]. ")
              .concat(t, " parameter must be an integer.");
          },
          isNonEmptyString: function (t) {
            return "WDE0094: Invalid "
              .concat(t, " parameter. ")
              .concat(t, " parameter must be non-empty string.");
          },
          notGreaterThan: function (t, e, r) {
            return "WDE0036: Invalid "
              .concat(t, " parameter [")
              .concat(e, "]. ")
              .concat(t, " parameter cannot exceed ")
              .concat(r, ".");
          },
          invalidSkipParameter: function (t, e) {
            return "WDE0037: Invalid query on ["
              .concat(
                t,
                "].\nInvalid prev positioned query skip on a negative number "
              )
              .concat(e, ".");
          },
          noPrevPage: function (t) {
            return "WDE0159: Invalid query on [".concat(
              t,
              "].\nThere is no prev page."
            );
          },
          noNextPage: function (t) {
            return "WDE0165: Invalid query on [".concat(
              t,
        ...
        w = {
          arityIsZero: function (t) {
            return "WDE0038: Invalid "
              .concat(t, " usage. ")
              .concat(t, " does not take parameters.");
          },
          arityIsOne: function (t) {
            return "WDE0039: Invalid "
              .concat(t, " usage. ")
              .concat(t, " requires one parameter.");
          },
          arityIsTwo: function (t) {
            return "WDE0040: Invalid "
              .concat(t, " usage. ")
              .concat(t, " requires two parameters.");
          },
          arityIsThree: function (t) {
            return "WDE0041: Invalid "
              .concat(t, " usage. ")
              .concat(t, " requires three parameters.");
          },
          arityIsAtLeastTwo: function (t) {
            return "WDE0042: Invalid "
              .concat(t, " usage. ")
              .concat(t, " requires at least two parameters.");
          },
          arityIsAtLeastOne: function (t) {
            return "WDE0043: Invalid "
              .concat(t, " usage. ")
              .concat(t, " requires at least one parameter.");
          },
        },
        T = {
          typeIsString: function (t, e) {
            return "WDE0044: Invalid "
              .concat(t, " parameter value [")
              .concat((0, i.cc)(e), "]. ")
              .concat(t, " parameter must be a String.");
          },
          typeIsStringNumberOrDate: function (t, e) {
            return "WDE0045: Invalid "
              .concat(t, " parameter value [")
              .concat((0, i.cc)(e), "]. Valid ")
              .concat(t, " parameter types are String, Number or Date.");
          },
          sameType: function (t, e, r) {
            return "WDE0046: Invalid "
              .concat(t, " parameter values [")
              .concat((0, i.cc)(e), "] and [")
              .concat(
                (0, i.cc)(r),
          ...
          typeIsStringNumberOrDateForAll: function (t) {
            return "WDE0047: Invalid "
              .concat(t, " usage. ")
              .concat(t, " supports only Number, String or Date items.");
          },
          validFieldName: function (t, e) {
            return "WDE0048: Invalid "
              .concat(t, " field value [")
              .concat((0, i.cc)(e), "]. ")
              .concat(t, " field must be a String.");
          },
          isInstanceOfSameClass: function (t, e, r) {
            return "WDE0049: Invalid "
              .concat(t, " parameter [")
              .concat((0, i.cc)(r), "]. ")
              .concat(t, " expects ")
              .concat(e, " only.");
          ...
          isForCollection: function (t, e, r) {
            return "WDE0050: Invalid "
              .concat(t, " parameter query for [")
              .concat(r, "]. ")
              .concat(t, " accepts ")
              .concat(e, " for the same collection only.");
          },
        ...
        S = {
          objectType: function (t, e) {
            return "WDE0056: "
              .concat(t, " should be an Object. Got ")
              .concat(c(e), " instead");
          },
          arrayType: function (t, e) {
            return "WDE0057: "
              .concat(t, " should be an Array. Got ")
              .concat(c(e), " instead");
          },
          arrayLength: function (t, e, r) {
            return "WDE0057: "
              .concat(c(r), ".length is ")
              .concat(r.length, ". ")
              .concat(t, " Array should have length ")
              .concat(e);
          },
          comparisonOperatorType: function (t, e) {
            return "WDE0058: "
              .concat(t, " should be a Date, Number, or String. Got ")
              .concat(c(e), " instead");
          },
          stringOperatorType: function (t, e) {
            return "WDE0059: "
              .concat(t, " should be a String. Got ")
              .concat(c(e), " instead");
          },
          setOperatorItems: function (t, e) {
            return "WDE0060: "
              .concat(
                t,
                " Array should only contain values of types Date, Number, and String. Got "
              )
              .concat(c(e), " instead");
          },
          inOperatorItems: function (t) {
            return "WDE0061: $in Array should have length 2, and match [String, Number]. Got ".concat(
              c(t),
              " instead"
            );
          },
          matchesOperatorRequiredProperty: function (t, e) {
            return "WDE0062: $matches value "
              .concat(c(e), " does not have property ")
              .concat(t);
          },
          matchesOperatorIgnoreCase: function (t) {
            return "WDE0063: $matches.ignoreCase should equal true. Got ".concat(
              c(t),
              " instead"
            );
          },
          matchesOperatorSpecItems: function (t) {
            return 'WDE0064: $matches.spec Array values should be either {"type":"anyOf","value":" -"} or {"type":"literal","value":String}. Got '.concat(
              c(t),
              " instead"
            );
          },
        ...
        D = {
          typeIsStringOrArrayOfStrings: function (t, e) {
            return "WDE0051: Invalid "
              .concat(t, " parameters [")
              .concat(e.map(i.cc), "]. Valid ")
              .concat(
                t,
                " values are String, Array of String or varargs String."
              );
          },
        },
        P = {
          sortModelType: function (t) {
            return "WDE0065: Sort Model should be an Array. Got ".concat(
              c(t),
              " instead"
            );
          },
          sortModelItemType: function (t) {
            return "WDE0066: Sort Model Array should contain values of type Object only. Got ".concat(
              c(t),
              " instead"
            );
          },
          sortModelItem: function (t) {
            return 'WDE0067: Sort Model Array items should have a single property with value "asc" or "desc". Got '.concat(
              c(t),
              " instead"
            );
          },
      ...
      function B(t) {
        ...
        return (
          ...
          Error.captureStackTrace && Error.captureStackTrace(e, B),
          (e.name = Error.name),
          e
        );
      }
      ...
      var q = (function () {
          ...
          return (
            (t.prototype.arityIsZero = function (t) {
              var e = this;
            ...
            (t.prototype.addValidation = function (t, e) {
              return (
                this._validations.push({ predicateFn: t, messageFn: e }), this
              );
            }),
            t
          );
        ...
        M = (function (t) {
          ...
          return (
            (0, n.ZT)(e, t),
            (e.prototype.validateAndAggregate = function () {
              var t = this,
        ...
        U = (function (t) {
          ...
          return (
            (0, n.ZT)(e, t),
            (e.prototype.validateAndReject = function () {
              var t = this;
        ...
        H = (function (t) {
          ...
          return (
            (0, n.ZT)(e, t),
            (e.prototype.arity = function (t, e, r, n) {
              return this.addValidation(
                function () {
            ...
            (e.prototype.item = function (t, e, r) {
              return this._isObject(t, e).addValidation(
                function () {
                ...
                function () {
                  return (
                    ...
                    t.every(function (t) {
                      return (
                        (0, i.Kn)(t) &&
                        (void 0 === t._id || null === t._id || (0, i.HD)(t._id))
                      );
                    })
                  );
                },
              ...
              return this.addValidation(
                function () {
                  var r =
                    ...
                    e.every(function (e) {
                      return "language" === e
                        ? null == (r = t[e]) || ((0, i.HD)(r) && r.length > 0)
                        : (function (t) {
            ...
            (e.prototype.references = function (t) {
              return this.addValidation(function () {
                return (
                  ...
                  t.every(function (t) {
                    return (
                      (0, i.HD)(t.relationshipName) && J(t.left) && J(t.right)
                    );
                  })
                );
              }, O);
      ...
      function tt(t) {
        ...
        else for (var r in ((e = t.constructor()), t)) e[r] = tt(t[r]);
        return e;
      }
      var et = (function () {
        function t(t, e, r) {
          (this._validations = []),
            (this.operatorName = t),
            (this.ctor = r),
            (this._invalidArguments = tt(e));
        }
        return (
          (t.prototype.typeIsString = function (t) {
            var e = this;
            return this.addValidation(
              function () {
                return X(t);
              ...
              function () {
                return "Invalid "
                  .concat(e.operatorName, " parameter value [")
                  .concat(Y(t), "]. ")
                  .concat(e.operatorName, " parameter must be a String.");
              }
            );
          }),
          ...
          (t.prototype.sameType = function (t, e) {
            ...
            return this.addValidation(
              ...
              function () {
                return "Invalid "
                  .concat(r.operatorName, " parameter values [")
                  .concat(Y(t), "] and [")
                  .concat(Y(e), "]. Both parameters must be of the same type.");
              }
            );
          }),
          (t.prototype.typeIsStringNumberOrDateForAll = function (t) {
            ...
            return this.addValidation(
              ...
              function () {
                return "Invalid "
                  .concat(e.operatorName, " usage. ")
                  .concat(
                    e.operatorName,
                    " supports only Number, String or Date items."
                  );
              }
            );
          }),
          (t.prototype.validFieldName = function (t) {
            ...
            return this.addValidation(
              ...
              function () {
                return "Invalid "
                  .concat(e.operatorName, " field value [")
                  .concat(Y(t), "]. ")
                  .concat(e.operatorName, " field must be a String.");
              }
            );
          }),
          (t.prototype.isInstanceOfSameClass = function (t) {
            ...
            return this.addValidation(
              ...
              function () {
                return "Invalid "
                  .concat(e.operatorName, " parameter [")
                  .concat(Y(t), "]. ")
                  .concat(e.operatorName, " expects FilterBuilder only.");
              }
            );
          }),
          (t.prototype.arityIsOne = function (t) {
            ...
            return this.addValidation(
              ...
              function () {
                return "Invalid "
                  .concat(e.operatorName, " usage. ")
                  .concat(e.operatorName, " requires one parameter.");
              }
            );
          }),
          (t.prototype.arityIsTwo = function (t) {
            ...
            return this.addValidation(
              ...
              function () {
                return "Invalid "
                  .concat(e.operatorName, " usage. ")
                  .concat(e.operatorName, " requires two parameters.");
              }
            );
          }),
          (t.prototype.arityIsThree = function (t) {
            ...
            return this.addValidation(
              ...
              function () {
                return "Invalid "
                  .concat(e.operatorName, " usage. ")
                  .concat(e.operatorName, " requires three parameters.");
              }
            );
          }),
          (t.prototype.arityIsAtLeastTwo = function (t) {
            ...
            return this.addValidation(
              ...
              function () {
                return "Invalid "
                  .concat(e.operatorName, " usage. ")
                  .concat(e.operatorName, " requires at least two parameters.");
              }
            );
          }),
          (t.prototype.addValidation = function (t, e) {
          ...
          if (
            (e.forEach(function (t) {
              !(function (t) {
                ...
                ? (r = (0, n.ev)((0, n.ev)([], r, !0), [t], !1))
                : (i = (0, n.ev)((0, n.ev)([], i, !0), [t], !1));
            }),
            r.length <= 1 ||
              (function (t) {
                var e = t
        ...
        function (t) {
          ...
          return {
            $and: e.reduce(function (t, e) {
              var r = e.$and;
              return r
                ? (0, n.ev)((0, n.ev)([], t, !0), r, !0)
                : (0, n.ev)((0, n.ev)([], t, !0), [e], !1);
            }, []),
          };
        },
        function (t) {
        ...
        return (
          ...
          (function (t) {
            function e(e) {
              ...
              return (
                (r.filterTree = e.filterTree || { $and: [] }),
                (r.invalidArguments = e.invalidArguments || []),
                (r.encoder = e.encoder || {}),
                r
              );
            }
            return (
              ...
              (e.prototype.isNotEmpty = function (t) {
                var e = this._filterValidator(".isNotEmpty")
              ...
              (e.prototype.isEmpty = function (t) {
                var e = this._filterValidator(".isEmpty")
                    .arityIsOne(arguments)
                    .validFieldName(t)
                    .validateAndAggregate(),
                  r = e[0];
              ...
              (e.prototype.or = function (t) {
                var e = this._filterValidator(".or")
                    .arityIsOne(arguments)
                    .isInstanceOfSameClass(t)
                    .validateAndAggregate(),
                  r = e[0];
                if (e[1]) {
              ...
              (e.prototype.and = function (t) {
                var e = this._filterValidator(".and")
                    .arityIsOne(arguments)
                    .isInstanceOfSameClass(t)
                    .validateAndAggregate(),
                  r = e[0];
                if (e[1]) {
                  ...
                  return this._copy(
                    ot.apply(
                      void 0,
                      (0, n.ev)((0, n.ev)([], i, !1), [t.filterTree], !1)
                    ),
                    r.concat(t.invalidArguments)
                  );
                }
              ...
              (e.prototype.not = function (t) {
                var e = this._filterValidator(".not")
                    .arityIsOne(arguments)
                    .isInstanceOfSameClass(t)
                    .validateAndAggregate(),
                  r = e[0];
              ...
              (e.prototype._AndSetOperand = function (t, e, r) {
                var n = Array.prototype.slice.call(r),
                  ...
                  o = n.slice(1),
                  a = Z(o[0]) ? o[0] : o,
                  u = this._filterValidator(e)
                    .arityIsAtLeastTwo(r)
                    .validFieldName(i)
                    .typeIsStringNumberOrDateForAll(a)
                    .validateAndAggregate()[0],
              ...
              (e.prototype._makeNewFilter = function (t, e, r) {
                var n,
                  i = tt(this.filterTree),
                  o = void 0 === r ? null : r,
                  a = this._buildFilter(t, e, o);
                return Z(i.$and)
                  ? (i.$and.push(a), i)
                  : ((n = i), 0 === Object.keys(n).length ? ot(a) : ot(i, a));
              }),
              (e.prototype._buildFilter = function (t, e, r) {
                var n;
                return "$eq" !== e
                  ? (((n = {})[t] = {}), (n[t][e] = this._encode(r)), n)
                  : (((n = {})[t] = this._encode(r)), n);
              }),
              (e.prototype._encode = function (t) {
                return (
                  (e = this.encoder),
                  "function" === L()(e) ? this.encoder(t) : t
                );
                var e;
              }),
      ...
      function ct(t) {
        for (var e = t.split("-"), r = [], n = 0; n < e.length - 1; n++)
          i(r, e[n]), r.push({ type: "anyOf", value: " \t\n-" });
        return i(r, e[e.length - 1]), r;
        function i(t, e) {
          0 !== e.length && t.push({ type: "literal", value: e });
        }
      }
      var st = (function (t) {
        function e(e, r, n, i) {
        ...
        return (
          (0, n.ZT)(e, t),
          (e.prototype.typeIsString = function (t) {
            var e = this;
            return this.addValidation(
              function () {
                return (0, i.HD)(t);
          ...
          (e.prototype.isInstanceOfSameClass = function (t) {
            ...
            return this.addValidation(
              ...
              function () {
                return T.isInstanceOfSameClass(
                  e.operatorName,
                  e.constructorName,
                  t
                );
              ...
              return (
                ...
                (e.prototype._validateCollectionName = function (t, e, r) {
                  ...
                  var i = (function (t, e) {
                      ...
                      return new t.constructor(
                        (0, n.pi)((0, n.pi)({}, t), { collectionName: r })
                      );
                ...
                (e.prototype._matchesUrlized = function (t, e) {
                  var r = this._filterValidator("._matchesUrlized")
                    ...
                    i = r[0];
                  if (r[1]) {
                    var o = this._makeNewFilter.apply(
                      this,
                      (0, n.ev)(
                        [t],
                        (function (t) {
                          return e(t)
                            ? ["$in", [t, Number.parseInt(t)]]
                            : ["$matches", { ignoreCase: !0, spec: ct(t) }];
                          function e(t) {
      ...
      var ht = (function (t) {
          ...
          return (
            (0, n.ZT)(e, t),
            (e.prototype.allStrings = function (t) {
              var e = this;
              return this.addValidation(
                function () {
                  return t.every(i.HD);
                ...
                function () {
                  return D.typeIsStringOrArrayOfStrings(e.operatorName, t);
                }
              );
            }),
            e
              ...
              return (
                ...
                (e.prototype._sortClause = function (t, e, r) {
                  ...
                  var o,
                    ...
                    c =
                      (0, i.kJ)(r[0]) && 1 === r.length
                        ? r[0]
                        : Array.prototype.slice.call(r, 0),
                    s = this._sortValidator(e)
                      .arityIsAtLeastOne(r)
                      .allStrings(c)
                      .validateAndAggregate(),
                    l = s[0];
      ...
      var gt = function (t) {
        t &&
          ((this.count = t.count),
          (this.total = t.total),
          (this.cursors = t.cursors),
          (this.hasNext = t.hasNext),
          (this.hasPrev = t.hasPrev));
      };
      function yt(t, e, r) {
        ...
        bt = (function (t) {
          function e(e) {
            ...
            return (
              ...
              (r.limitNumber = e.limitNumber),
              (r.invalidArguments = e.invalidArguments),
              (r.orderBy = e.orderBy),
              (r.skipNumber = e.skipNumber),
              (r.included = e.included),
              (r.projectedFields = e.projectedFields),
              (r.cursor = e.cursor),
              r
            );
          }
          return (
            ...
            (e.prototype.count = function (t) {
              var e = this;
              return _t(this.invalidArguments, this.collectionName)
                .then(function () {
            ...
            (e.prototype.fields = function () {
              for (var t = [], r = 0; r < arguments.length; r++)
                t[r] = arguments[r];
              for (
                var n = (0, i.d9)(this.projectedFields), o = 0;
                o < t.length;
                o++
              )
                n.push(t[o]);
            ...
            (e.prototype.limit = function (t) {
              var r = this._queryValidator(".limit")
                .arityIsOne(arguments)
                .isPositiveNumber(t)
                .isInteger(t)
                .validateAndAggregate()[0];
            ...
            (e.prototype.skip = function (t) {
              var r = this._queryValidator(".skip")
                .arityIsOne(arguments)
            ...
            (e.prototype.include = function () {
              for (var t = [], r = 0; r < arguments.length; r++)
                t[r] = arguments[r];
              for (var n = (0, i.d9)(this.included), o = 0; o < t.length; o++)
                n.push(t[o]);
              return new e({
                provider: this.provider,
                collectionName: this.collectionName,
            ...
            (e.prototype._setQuerySpecificInvalidArguments = function (t) {
              var e = function (t, e) {
                ...
                r = this._queryValidator(".limit", [])
                  .isPositiveNumber(this.limitNumber)
                  .isInteger(this.limitNumber),
                i = this._queryValidator(".skip", [])
                  .isNonNegativeNumber(this.skipNumber)
                  .isInteger(this.skipNumber),
                o = (0, n.ev)(
                  (0, n.ev)([], e(this.limitNumber, r), !0),
                  e(this.skipNumber, i),
                  !0
                );
              return Object.assign(t, { invalidArguments: o });
            }),
      ...
      function _t(t, e) {
        ...
        return r.length > 0
          ? Promise.reject($(E.queryInvalid(e, r)))
          : Promise.resolve();
      }
      function It(t, e) {
        return new bt({
          ...
          function t(t) {
            ...
            (this._executeQuery = function (t) {
              ...
              (this._withCalculatedSkip = function (t, r) {
                return (
                  (t.skipNumber = yt(e.query, e.length, r)), Promise.resolve(t)
                );
              }),
              t &&
                ((this._items = t.items),
                (this._totalCount = t.totalCount),
                (this._cursors = t.cursors),
                (this._createdByCursor = t.createdByCursor),
                (this._query = t.query),
                (this._partialIncludes = t.partialIncludes),
                (this._pagingFunction = t.pagingFunction),
                (this._hasNext = t.hasNext),
                (this.nextSkipNumber = yt(this.query, this.length, !0)),
                (this.prevSkipNumber = yt(this.query, this.length, !1)));
          }
          return (
            ...
            Object.defineProperty(t.prototype, "totalPages", {
              get: function () {
                ...
                return this.totalCount && this.length + t <= this.totalCount
                  ? Math.ceil(this.totalCount / this.length)
                  : void 0;
              },
              enumerable: !1,
              configurable: !0,
              ...
              get: function () {
                if (0 !== this.length) {
                  ...
                  return this.totalCount <= 0 ||
                    t >= this.totalCount ||
                    void 0 === this.pageSize
                    ? this.hasNext()
                      ? Math.floor(t / this.length)
                      : void 0
                    : Math.floor(t / this.pageSize);
                }
              },
              enumerable: !1,
              configurable: !0,
            ...
            (t.prototype.next = function () {
              ...
              return this.hasNext()
                ? vt(this.nextCursor)
                  ? this._getNewCursorQuery(this.nextCursor, !0)
                      .then(function (e) {
            ...
            (t.prototype.prev = function () {
              ...
              return this.hasPrev()
                ? vt(this.prevCursor)
                  ? this._getNewCursorQuery(this.prevCursor, !1)
                      .then(function (e) {
                        return t._executeQuery(e);
                      })
                      .then(function (e) {
            ...
            (t.prototype.hasPrev = function () {
              return vt(this._createdByCursor) || this._cursors
                ? vt(this.prevCursor)
                : !(
                    0 === (this.query.skipNumber || 0) || this.totalCount <= 0
                  ) && yt(this.query, this.length, !1) >= 0;
            }),
            ...
            (t.prototype._getNewQuery = function (t) {
              return this._withCalculatedSkip(
                new bt({
        ...
        jt = (function (t) {
          ...
          return (
            ...
            (e.prototype.isPositiveNumber = function (t) {
              var e = this;
              return this._isNumber("positive", t).addValidation(
                function () {
            ...
            (e.prototype.isNonNegativeNumber = function (t) {
              var e = this;
              return this._isNumber("non-negative", t).addValidation(
                function () {
                  return !Number.isNaN(t) && t >= 0;
                },
                function () {
            ...
            (function (t) {
              ...
              return (
                ...
                (e.prototype.sum = function (t, e) {
                  var r = this._groupValidator(".sum")
                ...
                (e.prototype.avg = function (t, e) {
                  var r = this._groupValidator(".avg")
                    .arityIsAtLeastOne(arguments)
                    .typeIsString(t)
                    .validateAndAggregate()[0];
                ...
                (e.prototype.min = function (t, e) {
                  var r = this._groupValidator(".min")
                    .arityIsAtLeastOne(arguments)
                    .typeIsString(t)
                    .validateAndAggregate()[0];
                ...
                (e.prototype.max = function (t, e) {
                  var r = this._groupValidator(".max")
                    .arityIsAtLeastOne(arguments)
                    .typeIsString(t)
                    .validateAndAggregate()[0];
                ...
                (e.prototype.count = function () {
                  var t = this._groupValidator(".count")
                      .arityIsZero(arguments)
                      .validateAndAggregate()[0],
                    e = (0, i.d9)(this.groupByTree) || { _id: St() };
                  return (e.count = { $sum: 1 }), this._copy(e, t);
                }),
                (e.prototype._addAccumulator = function (t, e, r, n) {
                  var o,
                    a = (0, i.d9)(this.groupByTree) || { _id: St() },
      ...
      function Tt() {
        ...
        return new Et({ groupByTree: { _id: r } });
      }
      function St() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
      ...
      var Dt = (function (t) {
        function e(e) {
          ...
          return (
            (r.provider = e.provider),
            (r.collectionName = e.collectionName),
            (r.filterTree = e.filterTree),
            (r.havingTree = e.havingTree),
            (r.skipNumber = e.skipNumber || 0),
            (r.limitNumber = e.limitNumber),
            (r.cursor = e.cursor),
            (r.invalidArguments = e.invalidArguments || []),
            r
        ...
        return (
          ...
          (e.prototype.filter = function (t) {
            var r = this._aggregateValidator(".filter")
              .arityIsOne(arguments)
              .filterIsNotSet(this)
              .filterBuilder(t)
              .validateAndAggregate()[0];
          ...
          (e.prototype.group = function () {
            ...
            var o = (0, i.d9)(this.groupByTree),
              a = this._aggregateValidator(".group")
                .arityIsAtLeastOne(arguments)
                .groupIsNotSet(o)
                .validateAndAggregate()[0];
            return (
          ...
          (e.prototype.having = function (t) {
            var r = this._aggregateValidator(".having")
              .arityIsOne(arguments)
              .havingIsNotSet(this)
              .filterBuilder(t)
              .validateAndAggregate()[0];
          ...
          (e.prototype.skip = function (t) {
            var r = this._aggregateValidator(".skip")
              .arityIsOne(arguments)
              .isNonNegativeNumber(t)
              .isInteger(t)
              .validateAndAggregate()[0];
          ...
          (e.prototype.limit = function (t) {
            var r = this._aggregateValidator(".limit")
              .arityIsOne(arguments)
              .isPositiveNumber(t)
              .isInteger(t)
              .validateAndAggregate()[0];
          ...
          (e.prototype.run = function (t) {
            ...
            return ((e = this.invalidArguments),
            (r = this.collectionName),
            e.length > 0
              ? Promise.reject($(N.aggregateInvalid(r, e)))
              : Promise.resolve())
              .then(function () {
                return z().options(t).validateAndReject();
              })
              .then(function () {
                return n.provider.runAggregate(
                  n.collectionName,
                  o,
                  n.limitNumber,
                  t,
          ...
          (e.prototype._buildPipeline = function () {
            return [
              ...
              this.groupByTree ? { $project: Pt(this.groupByTree) } : null,
      ...
      function Pt(t) {
        ...
        return (
          (0, i.Kn)(t._id)
            ...
            : (0, i.HD)(t._id) &&
              "0" !== t._id &&
              r.push((((e = {})[t._id.substr(1)] = "$_id"), e)),
          Object.assign.apply(Object, (0, n.ev)([{}], r, !1))
        );
      }
      function kt(t, e, r, n) {
        return new Dt({
      ...
      var Ct = (function () {
          function t(t) {
            t &&
              ((this._items = t.items),
              (this._hasNext = t.hasNext),
              (this._aggregate = t.aggregate),
              (this._pageSize = t.pageSize),
              (this._cursors = t.cursors),
              (this._createdByCursor = t.createdByCursor));
          }
          return (
            ...
            (t.prototype.next = function () {
              ...
              var t;
              if (vt(this.nextCursor))
                t = this._getNewCursorAggregate(this.nextCursor);
              else {
            ...
            (t.prototype.prev = function () {
              return this.hasPrev()
                ? (vt(this.prevCursor)
                    ? this._getNewCursorAggregate(this.prevCursor)
                    : this._aggregate.skip(
                        Math.max(
                          0,
                          this._aggregate.skipNumber -
                            this._aggregate.limitNumber
                        )
                      )
                  ).run()
                : this._rejectNoPrevPage();
            ...
            (t.prototype._rejectNoPrevPage = function () {
              return Promise.reject(
                $(E.noPrevPage(this._aggregate.collectionName))
              );
            }),
            (t.prototype._rejectNoNextPage = function () {
              return Promise.reject(
                $(E.noNextPage(this._aggregate.collectionName))
              );
            }),
            t
          );
        ...
        xt = (function (t) {
          ...
          return (
            (0, n.ZT)(e, t),
            (e.prototype.filterBuilder = function (t) {
              var e = this;
              return this.addValidation(
                function () {
      ...
      var $t = (function () {
        function t(t) {
          if (t) {
            (this._provider = t.provider),
              (this._collectionName = t.collectionName),
              (this._referenceAttribute = t.referenceAttribute),
              (this._holdingItemId = t.holdingItemId),
              (this._items = t.items),
              (this._totalCount = t.totalCount),
              (this._options = t.options);
            var e = t.options || {},
              r = e.skip,
              n = void 0 === r ? 0 : r,
              i = e.limit;
        ...
        return (
          ...
          (t.prototype.next = function () {
            ...
            return this.hasNext()
              ? vt(this.nextCursor)
                ? this._getNewCursorQuery(this.nextCursor)
                    ._fetch()
                    .then(function (e) {
                      return e._withTotalCount(t._totalCount);
                    })
          ...
          (t.prototype.prev = function () {
            ...
            return this.hasPrev()
              ? vt(this.prevCursor)
                ? this._getNewCursorQuery(this.prevCursor)
                    ._fetch()
                    .then(function (e) {
                      return e._withTotalCount(t._totalCount);
                    })
          ...
          (t.prototype._withChangedSkip = function (t) {
            var e = yt(
              { skipNumber: this._skip, limitNumber: this._limit },
              this._items.length,
              t
            );
            return Ft(
              {
                ...
                pagingMetadata: new gt({ total: this._totalCount }),
              },
              this._provider,
              this._collectionName,
              this._holdingItemId,
              this._referenceAttribute,
              (0, n.pi)((0, n.pi)({}, this._options), {
                skip: e,
                limit: this._limit,
              })
            );
            ...
            (this.get = Mt(function (t, r, n, i) {
              ...
              (this.find = function (t, r, i, o, a, u, c, s) {
                ...
                (l.filterTree = r),
                  ...
                  (l.limitNumber = a),
                  (l.included = c);
                var p = (0, n.pi)((0, n.pi)({}, u), { omitTotalCount: s });
                return l.find(p);
              }),
              ...
              (this.bulkRemove = Mt(function (t, r, i, o) {
                return z()
                  ...
                  .then(function (t) {
                    ...
                    return (0, n.pi)((0, n.pi)({}, t), { errors: e });
                  });
              })),
              ...
              (this.fetchReferenced = Mt(function (t, r, i, o, a) {
                return z()
                  .arity("fetchReferenced", t, 3, 4)
                  .isNonEmptyString(i, "cursor")
                  .validateAndReject()
                  .then(function () {
                    var t = (0, n.pi)({}, a);
                    return (
                      ...
                      (t.cursor = i),
                      e.provider
                        .queryReferenced(r, void 0, void 0, t)
                        .then(function (n) {
                ...
                return (
                  (0, i.kJ)(n)
                    ? ((s = n),
                      ...
                      (l = function () {
                        return z()
                          .arity("insertReference", t, 2, 3)
                          .references(s)
                          .validateAndReject();
                      }))
                    : ((s = zt(a).map(function (t) {
                        return { relationshipName: n, left: o, right: t };
                      })),
                      (c = u),
                      (l = function () {
                        return z()
                          .arity("insertReference", t, 4, 5)
                          .references(s)
                          .validateAndReject();
                      })),
                  l().then(function () {
                    return e.provider.insertReferences(
                      r,
                      (function (t) {
              ...
              (this.replaceReferences = Mt(function (t, r, n, i, o, a) {
                return (
                  ...
                  (i = Jt(i)),
                  z()
                    .arity("replaceReferences", t, 4, 5)
                    .referenceParameter(i)
                    .referenceParameters(o)
                    .validateAndReject()
                    .then(function () {
                      return e.provider.replaceReferences(
                        r,
                        { relationshipName: n, left: i },
                        o.map(function (t) {
                          return { relationshipName: n, right: t, left: i };
                        }),
                        a
                      );
                    })
              ...
              (this.removeReference = Mt(function (t, r, n, i, o, a) {
                return (
                  ...
                  (i = Jt(i)),
                  z()
                    .arity("removeReference", t, 4, 5)
                    .referenceParameter(i)
                    .referenceRemoveParameters(o)
                    .validateAndReject()
                    .then(function () {
                      return 1 === o.length
                        ? e.provider.removeReference(r, n, i, o[0], a)
                        : e.provider.removeReferences(
                            r,
                            o.map(function (t) {
                              return { relationshipName: n, right: t, left: i };
                            }),
              ...
              (this.isReferenced = Mt(function (t, r, n, i, o, a) {
                return z()
                  .arity("isReferenced", t, 4, 5)
                  .referenceParameter(i)
                  .referenceParameter(o)
                  .validateAndReject()
                  .then(function () {
              ...
              (this.aggregate = function (t) {
                return (function (t, e) {
                  return new Dt({ provider: t, collectionName: e });
                })(e.provider, t);
              }),
              (this.provider = t);
          }
          return (
            Object.defineProperty(t.prototype, "wixData", {
              get: function () {
                return this;
              },
              enumerable: !1,
                    ...
                    for (var r in t)
                      t.hasOwnProperty(r) &&
                        ((a.hasOwnProperty(r) &&
                          !0 !==
                            (null ===
                              (e = Object.getOwnPropertyDescriptor(a, r)) ||
                            void 0 === e
                              ? void 0
                              : e.writable)) ||
                          (a[r] = t[r]));
      ...
      r(2295).JV;
      function Qt(t) {
        return "WDE0020" === t || "WDE0024" === t
          ? x.ValidationError
          : "WDE0025" === t
          ? x.SchemaDoesNotExist
          : "WDE0026" === t
          ? x.CollectionDeleted
          : "WDE0027" === t
          ? x.PermissionDenied
          : "WDE0052" === t
          ? x.SiteInTemplateMode
          : "WDE0073" === t
          ? x.ItemDoesNotExist
          : "WDE0074" === t
          ? x.ItemAlreadyExists
        ...
        Kt = function (t) {
          return function (e) {
            ...
            return t("wix-data-error-response", {
              responseData:
                null === (r = null == e ? void 0 : e.response) || void 0 === r
                  ? void 0
                  : r.data,
              status:
                null === (i = null == e ? void 0 : e.response) || void 0 === i
                  ? void 0
                  : i.status,
              requestId:
                null ===
                  (a =
                    null === (o = null == e ? void 0 : e.response) ||
                    void 0 === o
                      ? void 0
                      : o.headers) || void 0 === a
                  ? void 0
              ...
              .then(function () {
                ...
                if (
                  (400 ===
                    ...
                    void 0 === r
                      ? void 0
                      : r.status) &&
                    t("wix-data-error-response-status-400-debug", {
                  ...
                  (function (t) {
                    ...
                    return (
                      413 ===
                      (null === (e = null == t ? void 0 : t.response) ||
                      void 0 === e
                        ? void 0
                        : e.status)
                    );
                ...
                return Xt(o)
                  ...
                  : (function (t) {
                      var e;
                      return null === (e = null == t ? void 0 : t.details) ||
                        void 0 === e
                        ? void 0
                        : e.applicationError;
                    })(o)
                  ...
                  ? (function (t) {
                      var e = (t.details.validationError.fieldViolations || [])
                          .map(function (t) {
                  ...
                  : R(k("Unknown error."), x.UnknownError);
              })
              .then(function (t) {
      ...
      function Xt(t) {
        ...
        return (
          (null ===
            (r =
              null === (e = null == t ? void 0 : t.details) || void 0 === e
                ? void 0
                : e.applicationError) || void 0 === r
            ? void 0
            : r.code) === Gt
        );
      }
      ...
      var te = function (t) {
        return function (e) {
          var r = (function (t) {
            ...
            if (Xt(t)) {
              var o =
                null === (r = i.data) || void 0 === r ? void 0 : r.jsErrorValue;
              if (o) return { message: o.message, code: o.code, name: o.name };
              var a = null === (n = i.data) || void 0 === n ? void 0 : n.value;
              return "string" == typeof a ? { message: a } : {};
            }
            return {
      ...
      var ee = function () {
        ...
        ne = (function () {
          ...
          return (
            (t.prototype.insert = function (t, e, r) {
              var n = this;
            ...
            (t.prototype.remove = function (t, e, r) {
              ...
              return this._traceWith("platformized-provider-remove", {
                ...
                return z()
                  ...
                  .catch(function (t) {
                    return t && t.code === x.ItemDoesNotExist
              ...
              return this._traceWith("platformized-provider-aggregate", {
                ...
                return z()
                  ...
                  .then(function () {
                    ...
                    return u
                      ._post(
                        "/v1/wix-data/collections/aggregate",
                        (0, n.pi)(
                          {
                            collectionName: t,
                      ...
                      .then(function (t) {
                        var e = t.items,
                          r = t.pagingMetadata,
                          n = r.cursors;
                        return { items: e, hasNext: r.hasNext, cursors: n };
                      });
                  });
              });
            }),
            ...
            (t.prototype._platformizedSort = function (t) {
              ...
              if (e)
                return e.$sort.map(function (t) {
                  var e = Object.entries(t)[0];
                  return { fieldName: e[0], order: "asc" === e[1] ? 0 : 1 };
                });
            }),
            (t.prototype._getDataQuery = function (t, e, r, i, o, a) {
              return (0, n.pi)(
                (0, n.pi)(
                  { filter: t, sort: e ? this._mapOrderToSort(e) : void 0 },
            ...
            (t.prototype._getPaging = function (t, e, r) {
              ...
              return r
                ? { cursorPaging: { limit: t, cursor: r } }
                : { paging: { offset: e, limit: t } };
            }),
              ...
              return this._traceWith("platformized-provider-distinct", {
                ...
                return z()
                  ...
                  .then(function (t) {
                    var e = t.items,
                      r = t.pagingMetadata;
                    return { items: e, totalCount: r.total, pagingMetadata: r };
                  });
              });
            }),
            ...
            (t.prototype.bulkSave = function (t, e, r) {
              ...
              return this._traceWith("platformized-provider-bulk-save", {
                ...
                return z()
                  ...
                  .then(function () {
                    return 0 === e.length
                      ? { insertedItemIds: [], updatedItemIds: [], errors: [] }
            ...
            (t.prototype.queryReferenced = function (t, e, r, i) {
              ...
              return this._traceWith("platformized-provider-query-referenced", {
                ...
                return z()
                  ...
                  .then(function () {
                    return o._post(
                      "/v1/wix-data/collections/query-referenced",
                      (0, n.pi)(
                        (0, n.pi)(
                          {
                            collectionName: t,
                        ...
                        { omitTotalCount: l, options: o._optionsWithPlugins(i) }
                      )
                    );
                  })
                  .then(function (t) {
            ...
            (t.prototype.insertReference = function (t, e, r, n, i) {
              ...
              return this._traceWith("platformized-provider-insert-reference", {
                ...
                return o.insertReferences(
                  t,
                  [{ relationshipName: e, left: r, right: n }],
                  i
                );
              });
            }),
            (t.prototype.insertReferences = function (t, e, r) {
              var n = this;
              return this._traceWith(
                "platformized-provider-insert-references",
                { collectionName: t }
              )(function () {
                return z()
                  .collectionName(t)
                  ...
                  .then(function () {
                    return n._post(
                      "/v1/wix-data/collections/bulk-insert-references",
                      {
                        collectionName: t,
            ...
            (t.prototype.replaceReferences = function (t, e, r, n) {
              var i = this;
              return this._traceWith(
                "platformized-provider-replace-references",
                { collectionName: t }
              )(function () {
                return z()
                  .collectionName(t)
                  ...
                  .then(function () {
                    return i._post(
                      "/v1/wix-data/collections/bulk-replace-references",
                      {
                        collectionName: t,
            ...
            (t.prototype.removeReferences = function (t, e, r) {
              var n = this;
              return this._traceWith(
                "platformized-provider-remove-references",
                { collectionName: t }
              )(function () {
                return z()
                  .collectionName(t)
                  ...
                  .then(function () {
                    return n._post(
                      "/v1/wix-data/collections/bulk-remove-references",
                      {
                        collectionName: t,
                        references: e.map(function (t) {
                          return {
            ...
            (t.prototype._mapOrderToSort = function (t) {
              return t.flatMap(function (t) {
                return Object.entries(t).map(function (t) {
                  return { fieldName: t[0], order: t[1].toUpperCase() };
                });
              });
            }),
            (t.prototype._validateOrderBy = function (t, e) {
              ...
              if (((r = e), !(0, i.kJ)(r)))
                return Promise.reject(
                  this._validationError(t, [
                    (function (t) {
                      return P.sortModelType(t);
                    })(e),
                  ])
                );
              var n = e.flatMap(function (t) {
                return (function (t) {
                  ...
                  ? (function (t) {
                      return P.sortModelItem(t);
                    })(t)
                  : [];
              });
              return n.length
                ? Promise.reject(this._validationError(t, n))
                : Promise.resolve();
            }),
              ...
              var r = S.objectType,
                ...
                A = function (t) {
                  ...
                  var e,
                    ...
                    P = []
                      .concat(g("$and", r))
                      .concat(v("Filter Model", r))
                      .concat(g("$or", o))
                      .concat(v("Filter Model", o))
                      .concat(g("$not", a))
                      .concat(v("Filter Model", a))
                      .concat(g("$hasSome", O))
                      .concat(g("$hasAll", E))
                      .concat(g("$in", w))
                      .concat(b("$hasSome", O))
                  ...
                  return P.length ||
                    (P = []
                      .concat(r ? r.flatMap(A) : [])
                      .concat(o ? o.flatMap(A) : [])
                      .concat(a ? a.flatMap(A) : [])).length
                    ? P
                    : Object.values(D).flatMap(A);
                };
              if ([null, void 0].includes(e)) return Promise.resolve();
              if (!(0, i.Kn)(e))
                return Promise.reject(
                  this._validationError(t, [r("Filter Model", e)])
                );
              var j = A(e);
              return j.length
                ? Promise.reject(this._validationError(t, j))
                : Promise.resolve();
            }),
            ...
            (t.prototype._getAuthHeader = function () {
              return Promise.resolve(
                re(this.authHeader) ? this.authHeader.get() : this.authHeader
              );
            }),
              ...
              return Promise.all([
                ...
                return r.traceWith("wix-data-api-call", {
                  ...
                  var n,
                    ...
                    c = a ? { authorization: a } : {};
                  return r
                    .httpClientProvider(e.options)
                    .post("".concat(r.cloudDataUrl).concat(t), u, {
                      headers: c,
                    })
                    .catch(Kt(r.traceWith))
                    .then(
                      ((n = r.traceWith),
                      function (t) {
                        var e;
            ...
            (t.prototype._getGridAppId = function () {
              return Promise.resolve(
                re(this.gridAppId) ? this.gridAppId.get() : this.gridAppId
              );
            }),
            (t.prototype._traceWith = function (t, e) {
              ...
              return function (i) {
                return r._getGridAppId().then(function (o) {
                  return r.traceWith(
                    t,
                    (0, n.pi)({ gridAppId: o, segment: r.segment }, e)
                  )(i);
                });
              };
            }),
      ...
      const ae = "data";
      function ue({ featureConfig: t, platformUtils: e, appEssentials: r }) {
        const n = {
            get() {
              return e.sessionService.getWixCodeInstance();
            },
          },
          { gridAppId: i, segment: o, cloudDataUrl: a } = t,
          { httpClient: u } = r;
        return {
          [ae]: oe({
            cloudDataUrl: a,
...
//# sourceMappingURL=feature-data-wix-code-sdk.d3aa6a39.chunk.min.js.map
