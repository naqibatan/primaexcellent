!(function () {
    ...
    b(a),
      ...
      r.forEach((e) => {
        const t = e.tag,
          n = D(t.content),
          o =
            t.position && t.position !== R.HEAD ? document.body : document.head,
          i = (function (e, t, n, o) {
            const i = [];
            let r = 0;
            const a = () => {
              ...
              c = () => {
                (r -= 1), r >= 0 && v(t.onerror, { error: !0 });
              },
              d = n.firstChild;
            e.forEach((e) => {
              "SCRIPT" === e.tag && (r += 1);
              const t = L(e, { onload: a, onerror: c });
    ...
    a.open(c, d, !0),
      (a.onreadystatechange = () => {
        if (4 === a.readyState) {
          const e = a.status;
          e < 200 || e >= 300
            ? v(n, { status: e, responseText: a.responseText })
            : v(t, a.responseText);
        }
      }),
  ...
  function H(e, t) {
    ...
    var d, s, l, g;
    if (
      (r.errors && r.errors.length > 0 && n(JSON.stringify(r.errors)),
      r.config &&
        ((s = r.config.consentPolicy) &&
          "object" == typeof s &&
          (p = [...p, ...y(s)]),
        c &&
        ...
        "object" != typeof (d = r.config) ||
          Array.isArray(d) ||
          (w = { ...w, ...d })),
      r.tags)
    ) {
      (l = r.tags),
        i(null == (g = w) ? void 0 : g.experiments, u)
          ? l.forEach((e) => {
              var t;
              const n =
                e.loadOnce ||
              ...
              m.push({ tag: { ...e, loadOnce: n }, embeddedNodes: null });
            })
          : l.forEach((e) => {
              m.push({ tag: e, embeddedNodes: null });
            });
      const e = { id: a };
  ...
  function J(e) {
    ...
    f && (u.authorization = v(f, d)),
      U(
        s,
        (e) => {
          H(e, { initConsentPolicyManager: !c && !!r, currentPageID: l.id });
        },
        (e) => {
