...
var Layouter = /** @class */ (function () {
  ...
  Layouter.prototype.calcNumberOfColumns = function (
    galleryWidth,
    targetItemSize
  ) {
    var numOfCols = 1;
  ...
  Layouter.prototype.prepareLayoutParams = function () {
    ...
    if (this.useExistingLayout && this.pointer > 0) {
        ...
        if (this.styleParams.isVertical) {
          ...
          if (this.scrollDirection === 1) {
            ...
            if (lastStrips) {
              ...
              this.galleryHeight = this.strips.reduce(function (
                totalHeight,
                strip
              ) {
      ...
      if (columnWidths && columnWidths.length > 0) {
        ...
        var columnMultiplier_1 =
          this.galleryWidth /
          columnWidthsArr_1.reduce(function (a, b) {
            return a + b;
          }, 0);
      ...
      this.columns = Array(this.numOfCols)
        ...
        .map(function (column, idx) {
          ...
          var infoWidth =
            Math.round(
              externalInfoWidth_1 > 1 // integer represent size in pixels, floats size in percentage
                ? externalInfoWidth_1
                : externalInfoWidth_1 * colWidth
            ) || 0;
          colWidth -= infoWidth;
          fixedCubeHeight_1 =
            fixedCubeHeight_1 ||
  ...
  Layouter.prototype.createLayout = function (layoutParams) {
    ...
    while (this.srcItems[this.pointer]) {
      ...
      if (!this.styleParams.isVertical) {
        ...
        var minCol = this.findShortestColumn(
          this.columns,
    ...
    if (this.styleParams.forceFullHeight) {
      ...
      this.items.map(function (item) {
        ...
        item.cropRatio = item.ratio =
          item.width / (item.height * stretchRatio_1);
