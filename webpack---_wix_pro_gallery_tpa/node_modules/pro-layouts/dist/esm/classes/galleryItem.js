...
var GalleryItem = /** @class */ (function () {
  ...
  GalleryItem.prototype.createSecondMediaItemIfNeeded = function (config) {
    var _a;
    if (
      (_a = config.dto) === null || _a === void 0 ? void 0 : _a.secondaryMedia
    ) {
  ...
  GalleryItem.prototype.renderProps = function (config) {
    ...
    if (this.hasSecondaryMedia) {
      itemProps.secondaryMediaItem = __assign(
        __assign({}, this.secondaryMediaItem.renderProps()),
        {
  ...
  GalleryItem.prototype.processedMediaUrl = function (
    resizeMethod,
    requiredWidth,
    requiredHeight,
    sharpParams,
    ...
    if (this.isText) {
      return Object.assign.apply(
        ...
        __spreadArrays(
          [{}],
          Object.values(GALLERY_CONSTS.urlTypes).map(function (value) {
            var _a;
            return (
              (_a = {}),
              (_a[value] = function () {
    ...
    urls[GALLERY_CONSTS.urlTypes.LOW_RES] = function () {
      return mediaUrl(
        _this,
        imgUrl,
        _this.cubeImages && resizeMethod !== GALLERY_CONSTS.resizeMethods.FIT
          ? GALLERY_CONSTS.resizeMethods.FILL
          : GALLERY_CONSTS.resizeMethods.FIT,
        thumbSize,
        thumbSize,
        __assign(__assign({}, sharpParams), { quality: 30, blur: 30 }),
        focalPoint
      );
    };
    return urls;
  ...
  Object.defineProperty(GalleryItem.prototype, "htmlContent", {
    get: function () {
      var _a;
      return (_a = this.html) === null || _a === void 0
        ? void 0
        : _a.replace(/<[^<>]*>/g, "").trim();
    },
    enumerable: false,
  ...
  Object.defineProperty(GalleryItem.prototype, "isTransparent", {
    get: function () {
      return (
        this.url &&
        (this.url.indexOf(".png") > 0 || this.url.indexOf(".gif") > 0)
      );
    },
    enumerable: false,
    configurable: true,
  ...
  Object.defineProperty(GalleryItem.prototype, "webLink", {
    get: function () {
      var _a;
      if (
        ((_a = this.linkUrl) === null || _a === void 0 ? void 0 : _a.length) >
          0 &&
        this.linkType === "web"
      ) {
