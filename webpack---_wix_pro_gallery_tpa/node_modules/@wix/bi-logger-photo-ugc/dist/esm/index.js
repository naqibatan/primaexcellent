 ...
 */
var dummy;
var defaultConfig = { endpoint: "photo-ugc" };
var init = function (webOrMobileLogger) {
  return function (userConfig) {
    ...
    var factoryInstance =
      typeof webOrMobileLogger.factory === "function"
        ? webOrMobileLogger.factory(config)
        : webOrMobileLogger;
...
var Logger = /** @class */ (function () {
  function Logger(biLoggerClientFactoryInstance) {
    ...
    biLoggerClientFactoryInstance.updateDefaults({ src: 65 });
    this.bi = biLoggerClientFactoryInstance.logger({ endpoint: "photo-ugc" });
  }
  /**
  ...
  /**
   * @typedef {Object} albumNameTooltipParams
   * @property {string} albumID - album_id
   * @property {GUID} instance_id - instance_id
   * @property {GUID} biToken - []
   * @property {string} origin - Builder/Wizard
   * @property {string} tooltipName - album name/url characters
   * @property {GUID} visitor_id - null
   **/
  /**
     * Name: Album Name Tooltip. Evid: 295.
     * Event description: when an tooltip is presented with more info regarding album name.
     ...
     *
     * origin - Type: string. Desc: Builder/Wizard
     *
     * tooltipName - Type: string. Desc: album name/url characters
     *
     * visitor_id - Type: guid.
     * @param {albumNameTooltipParams} params The parameters for this event.
     * @return {Promise} Promise
    **/
  Logger.prototype.albumNameTooltip = function (params) {
   ...
   **/
  /**
     * Name: Click Create Collection. Evid: 198.
     * Event description: when user click to create collection.
     ...
     *
     * visitor_id - Type: guid.
     * @param {createCollectionParams} params The parameters for this event.
     * @return {Promise} Promise
    **/
  Logger.prototype.createCollection = function (params) {
    return this.bi.log(__assign({ evid: 198 }, params));
  };
  /**
  ...
  Logger.prototype.providerCartCheckout = function (params) {
    return this.bi.log(__assign({ evid: 803 }, params));
  };
  /**
  ...
  Logger.prototype.downloadImage = function (params) {
    return this.bi.log(__assign({ evid: 805 }, params));
  };
  /**
  ...
  Logger.prototype.buyBuyNowClick = function (params) {
    return this.bi.log(__assign({ evid: 800 }, params));
  };
  /**
  ...
  Logger.prototype.providerBuyAddToCart = function (params) {
    return this.bi.log(__assign({ evid: 802 }, params));
  };
  /**
   * @typedef {Object} albumNameErrorParams
   * @property {string} albumID - album_id
   * @property {GUID} instance_id - instance_id
   * @property {GUID} biToken - []
   * @property {string} origin - Builder/Wizard
   ...
   **/
  /**
     * Name: Album Name Error. Evid: 294.
     * Event description: when an error is presented indicating that an album name must be filled.
     ...
     *
     * visitor_id - Type: guid.
     * @param {albumNameErrorParams} params The parameters for this event.
     * @return {Promise} Promise
    **/
  Logger.prototype.albumNameError = function (params) {
  ...
  Logger.prototype.collectionCreated = function (params) {
    return this.bi.log(__assign({ evid: 199 }, params));
  };
  /**
  ...
  Logger.prototype.shareGroup = function (params) {
    return this.bi.log(__assign({ evid: 601 }, params));
  };
  /**
  ...
  Logger.prototype.thankYouPageLoaded = function (params) {
    return this.bi.log(__assign({ evid: 804 }, params));
  };
  /**
  ...
  Logger.prototype.buySelectLicense = function (params) {
    return this.bi.log(__assign({ evid: 801 }, params));
  };
  /**
   ...
   * @property {string} albumID - album_id
   * @property {string} collection_id - list id
   * @property {GUID} instance_id - instance_id
   * @property {GUID} biToken - []
  ...
  /**
     ...
     * albumID - Type: string. Desc: album_id
     *
     * collection_id - Type: string. Desc: list id
     *
     * instance_id - Type: guid. Desc: instance_id
     *
     * biToken - Type: guid. Desc: []
  ...
  Logger.prototype.buyGalleryAddToCart = function (params) {
    return this.bi.log(__assign({ evid: 806 }, params));
  };
  /**
  ...
  /**
   * @typedef {Object} clickButtonInPopupParams
   * @property {string} albumID - album_id
   * @property {string} buttonName - button clicked
   * @property {string} collection_id - list id
   * @property {GUID} instance_id - instance_id
   * @property {GUID} biToken - []
   * @property {string} popupName - popup title/description
   ...
   **/
  /**
     * Name: Click button in Popup. Evid: 297.
     * Event description: when a user clicks a button in the popup.
    
     * albumID - Type: string. Desc: album_id
     *
     * buttonName - Type: string. Desc: button clicked
     *
     * collection_id - Type: string. Desc: list id
     *
     * instance_id - Type: guid. Desc: instance_id
     ...
     *
     * visitor_id - Type: guid. Desc: -
     * @param {clickButtonInPopupParams} params The parameters for this event.
     * @return {Promise} Promise
    **/
  Logger.prototype.clickButtonInPopup = function (params) {
  ...
  Logger.prototype.proGalleryClickOnCustomButton = function (params) {
    return this.bi.log(__assign({ evid: 807 }, params));
  };
  /**
