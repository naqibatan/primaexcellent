...
import { Translations, disabledTranslationsFunction } from "./i18next";
import { WithProviders } from "./react/utils";
import { ErrorProvider, useWidgetErrorContext } from "./react/ErrorProvider";
import { WidgetEnvironment } from "./environment/Widget";
import {
  WidgetEnvironmentConsumer,
  WidgetEnvironmentProvider,
} from "./react/EnvironmentProvider";
import { SentryProvider } from "./react/Sentry";
import { ErrorMonitorProvider } from "./react/ErrorMonitor";
import { TpaSettingsProviderWithExperiments } from "./react/WidgetTpaSettingsProviderWithExperiments";
import { FlowPropsConsumer } from "./controller/FlowProps/FlowPropsConsumer";
import { useEnsureFlowProps } from "./controller/FlowProps/useEnsureFlowProps";
import { ModalProvider } from "./react/Modal/ModalContext";
...
var useFlowProps = function (props) {
  return useMemo(
    function () {
      return new FlowPropsConsumer({ props: props });
    },
    [props]
  );
};
...
export var getWidgetWrapper = function (_a, UserComponent, _b) {
  ...
  var Widget = function (props) {
    ...
    if (
      flowPropsConsumer.getProp("error") &&
    ...
    var environment = new WidgetEnvironment({
      ...
      controllerOptions: {
        ...
        multilingual: !multilingualDisabled
          ? (_a = flowPropsConsumer.getProp("multilingual")) !== null &&
            _a !== void 0
            ? _a
            : null
          : null,
    ...
    var experimentsInstance = useMemo(
      function () {
        if (!flowPropsConsumer.isHOCEnabled("experiments")) {
          return undefined;
        }
        return createWidgetExperiments({ experiments: experiments });
      },
      [experiments]
    );
    var createCurrencyFormatter = useMemo(
      function () {
    ...
    var widgetError = useWidgetErrorContext(
      _widgetError,
      _widgetErrorId,
      flowPropsConsumer.getControllerError()
    );
    ...
    var i18NextInstance = useMemo(
      function () {
        ...
        var translations = new Translations({
          ...
          language: language,
          availableLanguages:
            translationsConfig === null || translationsConfig === void 0
              ? void 0
              : translationsConfig.availableLanguages,
          prefix:
            translationsConfig === null || translationsConfig === void 0
              ? void 0
    ...
    availableProviders.push(function (children) {
      return React.createElement(
        ...
        function (environment) {
          ...
          var _g =
              environment.isEditor || environment.isEditorX || environment.isADI
                ? [
                    cloneDeep(
                      (_a =
                        host === null || host === void 0
                          ? void 0
                          : host.style) === null || _a === void 0
                        ? void 0
                        : _a.styleParams
                    ),
                    cloneDeep(
                ...
                : [
                    (_d =
                      host === null || host === void 0
                        ? void 0
                        : host.style) === null || _d === void 0
                      ? void 0
                      : _d.styleParams,
                    (_e =
                      host === null || host === void 0
                        ? void 0
                        : host.style) === null || _e === void 0
                      ? void 0
                      : _e.siteColors,
                    (_f =
                      host === null || host === void 0
                        ? void 0
                        : host.style) === null || _f === void 0
                      ? void 0
                      : _f.siteTextPresets,
                  ],
            styleParams = _g[0],
          ...
          return React.createElement(
            TpaSettingsProviderWithExperiments,
            {
              ...
              currentStylesGetter: !environment.isSSR
                ? host.getCurrentStyle
                : undefined,
              allStylesGetter: host.getAllStyles,
              styleParamsPerBreakpointMode: environment.isCssPerBreakpoint,
              stylesParams:
                stylesParams !== null && stylesParams !== void 0
                  ? stylesParams
                  : {},
              hostStyle: {
              ...
              language:
                (environment.multilingual.isEnabled &&
                  environment.multilingual.currentLanguage) ||
                undefined,
              t: t,
              isEditorX: environment.isEditorX,
              experimentsDisabled:
                !flowPropsConsumer.isHOCEnabled("experiments"),
            },
            children
          );
        }
    ...
    return React.createElement(
      ...
      React.createElement(UserComponent, __assign({ host: host }, widgetProps))
    );
  };
  var shouldWrapWithStyleHoc =
    styleHocConfig === null || styleHocConfig === void 0
      ? void 0
      : styleHocConfig.enabled;
  if (!withStylesHoc) {
    throw new Error(
  ...
  var WidgetWithStylesComponent = withStylesHoc(Widget, {
    ...
    enableMemoization:
      typeof WeakMap === "undefined" || memoize.Cache !== WeakMap,
  });
