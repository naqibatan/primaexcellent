...
var FlowPropsProvider = /** @class */ (function (_super) {
  ...
  function FlowPropsProvider(_a) {
    ...
    _this.onAppLoadedProp = function () {
      ...
      if (!_this.isCSRLoaded) {
        (_a = _this.flowAPI.fedops) === null || _a === void 0
          ? void 0
          : _a.appLoaded();
        (_b = _this.panoramaClient) === null || _b === void 0
          ? void 0
          : _b.reportLoadFinish();
  ...
  FlowPropsProvider.prototype.initControllerProps = function (_a) {
    ...
    this.setProp(
      "translations",
      (_c =
        (_b = flowAPI.translations) === null || _b === void 0
          ? void 0
          : _b.all) !== null && _c !== void 0
        ? _c
        : {}
    );
    ...
    this.setProp(
      "multilingual",
      multilingualProp(flowAPI.environment.multilingual)
    );
    // Experiments
    this.setProp(
      "experiments",
      (_e =
        (_d = flowAPI.experiments) === null || _d === void 0
          ? void 0
          : _d.all()) !== null && _e !== void 0
        ? _e
        : {}
    );
    // BI
    ...
    this.setProp(
      "fedopsLogger",
      flowAPI.fedops != null ? fedopsLoggerProp(flowAPI.fedops) : null
    );
    // Panorama
    ...
    this.setProp(
      "sentry",
      flowAPI.sentry != null ? createSentryProp(flowAPI.sentry) : null
    );
    // Error Monitor
    this.setProp(
      "errorMonitor",
      flowAPI.errorMonitor != null
  ...
  FlowPropsProvider.prototype.passWidgetErrorProp = function (
    controllerError,
    controllerErrorId
  ) {
