        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                controller.pageReady.apply(controller, args),
              ];
            case 1:
              userPageReadyResult = _b.sent();
              _b.label = 2;
            case 2:
              (_a = flowAPI.fedops) === null || _a === void 0
                ? void 0
                : _a.appLoaded();
      ...
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              (_b =
                (_a = flowAPI.sentry) === null || _a === void 0
                  ? void 0
                  : _a.setTagsContext) === null || _b === void 0
                ? void 0
                : _b.call(_a, {
              ...
              if (controllerError) {
                flowPropsProvider.passWidgetErrorProp(
                  controllerError,
                  controllerErrorId
                );
            ...
            case 1:
              ...
              if (isControllerError(userPageReadyResult)) {
                flowPropsProvider.passWidgetErrorProp(
                  userPageReadyResult._error,
                  userPageReadyResult._errorId
                );
            ...
            case 2:
              if (flowAPI.environment.isSSR) {
                (_c = flowAPI.fedops) === null || _c === void 0
                  ? void 0
                  : _c.appLoaded();
                panoramaClient === null || panoramaClient === void 0
                  ? void 0
...
export var handleControllerError = function (
  error,
  flowAPI,
  appName,
  componentName,
  ...
  if (!flowAPI.environment.isEditor) {
    ...
    console.error(
      '\u2757\uFE0FError \uD83D\uDC49 "'
        .concat(appName, '" app \uD83D\uDC49 ')
        .concat(componentName, " controller \uD83D\uDC49 ")
        .concat(method ? "".concat(method, " method") : "", " \u2757\n"),
      error
    );
    if (flowAPI.sentry) {
      (_a = flowAPI.sentry) === null || _a === void 0
        ? void 0
        : _a.captureException(error);
      return (_c =
        (_b = flowAPI.sentry) === null || _b === void 0
          ? void 0
          : _b.lastEventId) === null || _c === void 0
        ? void 0
        : _c.call(_b);
    }
...
export var controllerWithErrorBoundary = function (
  userControllerCallback,
  flowAPI,
  appName,
  componentName
) {
...
export var pageReadyWithErrorBoundary = function (
  pageReadyCallback,
  flowAPI,
  appName,
  componentName
