...
import { wrapSimpleUserController } from "../helpers/wrapUserController";
import { createPanoramaClient } from "../panorama";
export var blocksControllerWrapper = function (
  optionalDeps,
  ...
  return Promise.all([viewerScriptFlowAPIInitPromise, flowAPI.init()]).then(
    function () {
