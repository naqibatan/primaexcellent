...
var ReactionServiceManager = /** @class */ (function () {
  ...
  // APIs
  ReactionServiceManager.prototype.getItemsLoveData = function (
    items,
    instance,
    baseUrl,
    galleryId,
    appDefinitionId,
    sentryReportCallback
  ) {
    return __awaiter(this, void 0, void 0, function () {
      var encodedContextToken,
        itemsById,
        resourceIds,
        reactionsUrl,
        res,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            encodedContextToken = this.getEncodedContextToken(
              galleryId,
              appDefinitionId
            );
            ...
            reactionsUrl = ""
              .concat(
                baseUrl,
                "/_api/reactions-server/v1/reactions?contextToken="
              )
              .concat(encodedContextToken, "&resourceIds=")
              .concat(resourceIds);
            _a.label = 1;
          case 1:
            _a.trys.push([1, 6, , 7]);
          ...
          case 4:
            error =
              "Reaction-Service error - Worker - GET call response status: ".concat(
                res.status
              );
          ...
          case 6:
            e_1 = _a.sent();
            error =
              "Reaction-Service error - Worker - some error when requesting data from reaction-service: ".concat(
                e_1.message
              );
            sentryReportCallback(error);
            utils.isVerbose() && console.error(error);
  ...
  ReactionServiceManager.prototype.getEncodedContextToken = function (
    galleryId,
    appDefinitionId
  ) {
