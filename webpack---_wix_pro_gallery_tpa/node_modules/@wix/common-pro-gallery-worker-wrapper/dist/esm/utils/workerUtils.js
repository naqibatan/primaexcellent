...
var Utils = /** @class */ (function () {
  ...
  Utils.getBaseUrl = function (api, viewMode) {
    ...
    if (
      parsedViewMode === GALLERY_v4_CONSTS.viewMode.PREVIEW ||
  ...
  Utils.getUrlOverrideExperimentsParam = function (baseApi) {
    var _a;
    return (_a = baseApi.location.query) === null || _a === void 0
      ? void 0
      : _a.petri_ovr;
  };
  Utils.getExperiments = function (baseApi, instance) {
    ...
    var url = ""
      .concat(baseUrl, "/_api/pro-gallery-webapp/v1/viewer/experiments")
      .concat(petri_ovr ? "?petri_ovr=" + petri_ovr : "");
    return fetch(url, {
      credentials: "include",
      headers: {
              ...
              switch (_a.label) {
                case 0:
                  ...
                  if (baseApi.window.rendering.env !== "backend") {
                    experimentsRaw =
                      baseApi.window.warmupData.get("pg_experiments");
                  }
                ...
                case 2:
                  ...
                  if (
                    baseApi.window.rendering.env === "backend" &&
                    !experimentsWrapper.getExperimentBoolean(
                      "specs.pro-gallery.excludeFromWarmupData"
                    )
                  ) {
                    baseApi.window.warmupData.set(
                      "pg_experiments",
                      experimentsRaw
                    );
                  }
