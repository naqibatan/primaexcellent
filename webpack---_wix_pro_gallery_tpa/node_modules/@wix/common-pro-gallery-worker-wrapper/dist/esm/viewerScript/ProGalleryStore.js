...
var ProGalleryStore = /** @class */ (function () {
  function ProGalleryStore(_a) {
    var context = _a.context,
      ...
      setDirectFullscreenMockPropCallback =
        _a.setDirectFullscreenMockPropCallback;
    var _this = this;
    this.debouncedHandleNewUserConfig = utils.debounce(
      this.handleNewUserConfig.bind(this),
      100
    );
    this.debouncedHandleMeasuredDimensions = utils.debounce(
      this.handleMeasuredDimensions.bind(this),
      100
    );
    ...
    this.debouncedRecalculateStylesAndBluprints = utils.debounce(
      this.recalculateStylesAndTriggerBlueprints.bind(this),
      2500
    );
    ...
    this.loadDirectFullscreenItemFromWixCode =
      this.loadDirectFullscreenItemFromWixCode.bind(this);
    ...
    this.setDirectFullscreenMockBlueprint =
      this.setDirectFullscreenMockBlueprint.bind(this);
    this.createDirectFullscreenBlueprintMockIfNeeded =
      this.createDirectFullscreenBlueprintMockIfNeeded.bind(this);
    this.createDirectFullscreenMockBlueprint =
      this.createDirectFullscreenMockBlueprint.bind(this);
    this.itemDimensionsCache = {};
    this.viewMode = Utils.parseViewMode(this.wixCodeApi.window.viewMode);
    this.deviceType = Utils.formFactorToDeviceType(
      this.wixCodeApi.window.formFactor
    );
    ...
    this.SSRWorkerLog.push(
      "finnished the pgStore constructor. this isSSR?: " +
  ...
  ProGalleryStore.prototype.handleNewUserConfigDimensions = function (
    newDimensions
  ) {
  ...
  ProGalleryStore.prototype.initDefaultDimensions = function () {
    ...
    this.dimensions = __assign(
      {},
      UNKNOWN_CONTAINER[this.isMobile ? "mobile" : "desktop"]
    );
  };
  ...
  ProGalleryStore.prototype.setHeightByLayoutchanges = function (height) {
    this.setUserDimensions(
      __assign(__assign({}, this.userDimensions), { height: height })
    );
    this.applyStylesFinalFixes();
    this.triggerBlueprintCreation({ settingNewItems: false });
  };
  ProGalleryStore.prototype.setClientMeasuredDimensions = function (
    dimensions
  ) {
  ...
  ProGalleryStore.prototype.recalculateDimensions = function () {
    var _dimensions = __assign(
      __assign(__assign({}, this.dimensions), this.clientMeasuredDimensions),
      this.userDimensions
    );
  ...
  ProGalleryStore.prototype.setKnownDimensions = function () {
    var inputedDimensions = __assign(
      __assign({}, this.clientMeasuredDimensions),
      this.userDimensions
    );
    if (
      (inputedDimensions === null || inputedDimensions === void 0
        ? void 0
        : inputedDimensions.height) !== this.requestedHeight ||
      (inputedDimensions === null || inputedDimensions === void 0
        ? void 0
        : inputedDimensions.width) !== this.requestedWidth
    ) {
  ...
  ProGalleryStore.prototype.setIsInfinite = function () {
    ...
    this.isFixedRatioHorizontalGallery =
      ...
      ((_c =
        (_b =
          (_a = this.calculatedGalleryStyles.layoutParams) === null ||
          _a === void 0
            ? void 0
  ...
  ProGalleryStore.prototype.getConnectedProvidersFromServer = function (
    wixInstance
  ) {
    ...
    var url = ""
      .concat(
        this.baseUrl,
        "/_api/pro-gallery-webapp/v1/store/providers?instance="
      )
      .concat(instance);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.fetcher.getGalleryDataFromServer({ from: from }),
            ];
          case 1:
            res = _a.sent();
      ...
      .then(function (qualities) {
        ...
        if (
          !experimentsWrapper.getExperimentBoolean(
            "specs.pro-gallery.excludeFromHlsVideos"
          )
        ) {
  ...
  ProGalleryStore.prototype.addItemProperties = function (item) {
    ...
    try {
      ...
      console.log(
        "ProGalleryStore, addItemProperties, try to add a pageName to an item if needed, error:",
        error
      );
    }
    var directLink = {
    ...
    if (item.metaData && item.metaData.link) {
      ...
      if (link.type === "web" && typeof link.url === "string") {
        ...
        if (linkData_1) {
          try {
            var externalUrl =
              this.wixCodeApi.location.getExternalUrl(linkData_1);
            if (externalUrl) {
              directLink = {
                url: externalUrl,
    ...
    item.directShareLink = experimentsWrapper.getExperimentBoolean(
      "specs.pro-gallery.itemDeeplinks"
    )
  ...
  ProGalleryStore.prototype.prepareItems = function (items) {
    ...
    var shouldUseReactionService =
      reactionServiceManager.shouldUseReactionService();
    var itemsToSet;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              directFullscreenHelper.getDirectFullscreenItemFromItemsList(
                this.wixCodeApi.location.query,
                this.allWixCodeItems,
                this.context.compId,
                this.fetcher
              ),
            ];
  ...
  ProGalleryStore.prototype.getItemsLoveDataIfNeeded = function (
    itemsListToGetLoveData
  ) {
    var _this = this;
    ...
    if (
      ...
      reactionServiceManager
        ...
        .then(function (loveCountsReactionService) {
          ...
          _this.fullListOfItemsLoveData = __assign(
            __assign({}, _this.fullListOfItemsLoveData),
            loveCountsReactionService
          );
  ...
  ProGalleryStore.prototype.buildVideoUrlsAndSet = function (_a) {
    ...
    this.getItemsWithWixVideosUrls(newItems).then(function (
      itemsWithVideoUrls
    ) {
  ...
  ProGalleryStore.prototype.setItems = function (items) {
    ...
    this.SSRWorkerLog.push(
      "setting items, first item id is: " +
        ((_a = _items[0]) === null || _a === void 0 ? void 0 : _a.itemId)
    );
  ...
  ProGalleryStore.prototype.setBlueprint = function (blueprint) {
    ...
    if (this.itemsSrc === "Velo") {
      this.SSRWorkerLog.push(
        "setting a blueprint while currentItems are wixCode"
      );
  ...
  ProGalleryStore.prototype.itemToGalleryItem = function (
    item,
    staticMediaUrls
  ) {
  ...
  ProGalleryStore.prototype.setMetaTagsInSSR = function (
    item,
    page_url,
    fullscreen_url,
    api,
    ...
    var itemData = constructMetaTagsItemData(
      galleryItem,
      page_url,
      fullscreen_url
    );
  ...
  ProGalleryStore.prototype.prepareAndSetDirectFullscreenItem = function (
    item
  ) {
    var _this = this;
    var _a = this.prepareItems([item]),
  ...
  ProGalleryStore.prototype.createDirectFullscreenBlueprintMockIfNeeded =
    function () {
      var _this = this;
      if (this.isSSR() && this.isSEO()) {
        this.directFullscreenItemReadyDeferred.promise
          .then(function () {
            var directFullscreenMockBlueprint =
              _this.createDirectFullscreenMockBlueprint();
            _this.setDirectFullscreenMockBlueprint(
  ...
  ProGalleryStore.prototype.setDirectFullscreenMockBlueprint = function (
    blueprint
  ) {
  ...
  ProGalleryStore.prototype.setDirectFullscreenItem = function (
  ...
  ProGalleryStore.prototype.getSSRWorkerLog = function () {
    this.SSRWorkerLog.push(
      " ######## requesting the worker log ######### (and setting props to the component"
    );
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            (items = galleryData.items),
              (totalItemsCount = galleryData.totalItemsCount);
          ...
          case 5:
            ...
            try {
              (items = itemsData.items),
                (totalItemsCount = itemsData.totalItemsCount);
              if (this.itemsSrc !== "Velo") {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            this.SSRWorkerLog.push(
              "getting blueprint from server first itemId:",
              (_b =
                (_a =
                  args === null || args === void 0 ? void 0 : args.params) ===
                  null || _a === void 0
                  ? void 0
                  : _a.items[0]) === null || _b === void 0
                ? void 0
                : _b.itemId
            );
          ...
          case 1:
            ...
            url = "".concat(
              this.baseUrl,
              "/_serverless/pro-gallery-blueprints-server/createBlueprint"
            );
            return [
              4 /*yield*/,
              fetch(url, {
        ...
        switch (_a.label) {
          case 0:
            ...
            previewUseServerBlueprints =
              this.viewMode === GALLERY_v4_CONSTS.viewMode.PREVIEW &&
              experimentsWrapper.getExperimentBoolean(
                "specs.pro-gallery.useServerBlueprints-preview"
              );
            siteUseServerBlueprints =
              this.viewMode !== GALLERY_v4_CONSTS.viewMode.PREVIEW &&
              experimentsWrapper.getExperimentBoolean(
                "specs.pro-gallery.useServerBlueprints-viewer"
              );
  ...
  ProGalleryStore.prototype.handleNewItemDimensions = function (
    itemDimensions
  ) {
    var _this = this;
  ...
  ProGalleryStore.prototype.getMoreItemsFromItemsSource = function (from) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          getMoreItems(from).then(function (items) {
  ...
  ProGalleryStore.prototype.isBlueprintOfCurrentItems = function (blueprint) {
    ...
    return (
      ((_a =
        blueprint === null || blueprint === void 0
          ? void 0
          : blueprint.items[0]) === null || _a === void 0
        ? void 0
        : _a.itemId) ===
      ((_b = this.items[0]) === null || _b === void 0 ? void 0 : _b.itemId)
    );
  };
  ProGalleryStore.prototype.setBlueprintIfNeeded = function (
    blueprint,
    blueprintChanged
  ) {
    ...
    this.SSRWorkerLog.push(
      "LOGIC got a blueprint, are there changes from the last one?" +
        "".concat(blueprintChanged ? " TRUE" : " FALSE")
    );
    this.SSRWorkerLog.push(
      this.isBlueprintOfCurrentItems(blueprint)
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              Utils.verifyExperiments(this.scopedGlobalSdkApis),
            ];
          case 1:
            _a.sent(); // make sure experiments were requestd and are ready before proceeding
            this.SSRWorkerLog.push(
              "Experiments are here, can create a blueprint"
            );
            if (utils.isVerbose()) {
  ...
  ProGalleryStore.prototype.loadDirectFullscreenItem = function (
    requestedItemId,
    requestedgGalleryId
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            ...
            if (utils.isVerbose()) {
              console.warn(
                "Could not get direct fullscreen from server (could be velo item)",
                e_3
              );
            }
            item = null;
  ...
  ProGalleryStore.prototype.handleManualStyleParams = function (
    manualStyleParams
  ) {
  ...
  ProGalleryStore.prototype.setManualStyleParams = function (
    manualStyleParams
  ) {
  ...
  ProGalleryStore.prototype.isStoreGallery = function () {
    var _a;
    var freeArtStore =
      (_a = this.fetcher.settings) === null || _a === void 0
        ? void 0
        : _a.freeArtStore;
  ...
  ProGalleryStore.prototype.fixGalleryStyleRatiosInMobile = function () {
    ...
    if (
      this.isMobile &&
      !this.isSSR() &&
      typeof ((_a = this.calculatedGalleryStyles) === null || _a === void 0
        ? void 0
        : _a.gallerySize) === "number" &&
      !((_b = this.calculatedGalleryStyles) === null || _b === void 0
        ? void 0
        : _b.responsive)
    ) {
  ...
  ProGalleryStore.prototype.fixThinLinesInSliderGalleries = function () {
    var excludeFromThinLinesFix = experimentsWrapper.getExperimentBoolean(
      "specs.pro-gallery.excludeFromThinLinesFix"
    );
    if (!excludeFromThinLinesFix) {
      if (
        this.calculatedGalleryStyles.galleryLayout ===
  ...
  ProGalleryStore.prototype.delayedStylesRecalculation = function (
    previewHover
  ) {
  ...
  ProGalleryStore.prototype.recalculateStylesAndTriggerBlueprints =
    function () {
      this.recalculateStylesExpensively();
      this.triggerBlueprintCreation({ settingNewItems: false });
    };
  ProGalleryStore.prototype.recalculateStylesExpensively = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        galleryStyles = mergeNestedObjects(
          pgStyles,
          this.getManualStyleParams()
        );
        (gallerySize = galleryStyles.gallerySize),
          (imageMargin = galleryStyles.imageMargin),
          (previewHover = galleryStyles.previewHover);
        ...
        this.calculatedFullscreenStyles = mergeNestedObjects(
          fullscreenStyles,
          this.getManualStyleParams()
        );
        infoElementsStyles = this.getInfoElementsStyles(styleParams);
        this.calculatedInfoElementStyles = mergeNestedObjects(
          infoElementsStyles,
          this.getManualStyleParams()
        );
        this.applyStylesFinalFixes();
