...
var CommonViewerScript = /** @class */ (function () {
  function CommonViewerScript(_a) {
    ...
    this.debouncedSetHeightControlMode = utils.debounce(
      this.setHeightControlMode.bind(this),
      400
    );
  ...
  CommonViewerScript.prototype.setDirectFullscreenMockPropCallback =
    function () {
      var setProps = this.getControllerConfig().setProps;
      var directFullscreenMockBlueprint =
        this.getDirectFullscreenMockBlueprint();
      setProps({
  ...
  CommonViewerScript.prototype.setMetaTagsInSSRIfNeeded = function () {
    ...
    if (this.isSSR() && directFullscreenItem && directFullscreenItem.itemId) {
      ...
      var currentDirectFullscreenUrl =
        ProGalleryStore.getCurrentDirectFullscreenUrl(wixCodeApi);
  ...
  CommonViewerScript.prototype.getLocaleFromContext = function () {
    ...
    return CommonViewerScript.getLocaleFromScopedGlobalSdkApis(
      scopedGlobalSdkApis
    );
  };
  CommonViewerScript.prototype.getCommonGalleryProps = function (isStore) {
    ...
    return {
      ...
      BOLT_SUPPORTING_FUNCTION_onNewHostDimensions: function (dimensions) {
        return _this.BOLT_SUPPORTING_FUNCTION_handleNewHostDimensions(
          dimensions
        );
      },
  ...
  CommonViewerScript.prototype.loadDirectFullscreen = function () {
    ...
    var pgStore = this.getPgStore();
    directFullscreenHelper.loadDirectFullscreen(
      compId,
      pgStore.galleryId,
      this.getQueryParams(),
      pgStore
  ...
  CommonViewerScript.prototype.initPgStore = function (
    APP_DEFINITION_ID,
    GALLERY_WIDGET_ID
  ) {
    ...
    var _a = controllerData.appParams,
      ...
      avoidGettingItemsFromPGServer =
        controllerData.avoidGettingItemsFromPGServer;
    ...
    this.pgStore = new ProGalleryStore({
      ...
      setDirectFullscreenPropCallback:
        this.setDirectFullscreenPropCallback.bind(this),
      setDirectFullscreenMockPropCallback:
        this.setDirectFullscreenMockPropCallback.bind(this),
    });
  };
  ...
  CommonViewerScript.prototype.setHeightControlMode = function () {
    ...
    var setProps = this.getControllerConfig().setProps;
    var fitToContentHeight =
      pgStore.isInfiniteScroll || pgStore.isFixedRatioHorizontalGallery;
  ...
  CommonViewerScript.prototype.getOnItemClickedFunc = function (
    galleryWixCodeApi
  ) {
  ...
  CommonViewerScript.prototype.handleMeasuredDimensions = function (
    dimensions
  ) {
    var proGalleryStore = this.getPgStore();
    proGalleryStore.debouncedHandleMeasuredDimensions(dimensions);
  };
  CommonViewerScript.prototype.BOLT_SUPPORTING_FUNCTION_handleNewHostDimensions =
    function (hostDimensions) {
      var proGalleryStore = this.getPgStore();
  ...
  CommonViewerScript.prototype.handleNewItemDimensions = function (
    itemDimensions
  ) {
    var proGalleryStore = this.getPgStore();
  ...
  CommonViewerScript.prototype.setItemsLoveData = function (
  ...
  CommonViewerScript.prototype.handleNewStyleParams = function (
    manualStyleParams
  ) {
  ...
  CommonViewerScript.getLocaleFromScopedGlobalSdkApis = function (
    scopedGlobalSdkApis
  ) {
    if (
      scopedGlobalSdkApis &&
  ...
  CommonViewerScript.setTranslationsAndExperiments = function (
    scopedGlobalSdkApis,
    sentryReporter,
    instance,
    initAppParam
    ...
    try {
      var locale =
        CommonViewerScript.getLocaleFromScopedGlobalSdkApis(
          scopedGlobalSdkApis
        );
      var santaWrapperTranslationsUrl = ""
        .concat(
          initAppParam.baseUrls.santaWrapperBaseUrl,
          "assets/locale/pro-gallery/messages_"
        )
        .concat(locale, ".json");
      var translationsPromise = ProGalleryStore.getTranslations(
        santaWrapperTranslationsUrl
      );
  ...
  CommonViewerScript.getInitAppForPageFunc = function (context) {
    return function (
      ...
      var _a;
      context.setContext(
        __assign(__assign({}, initAppParam), {
          platformServices: platformServices,
          scopedGlobalSdkApis: scopedGlobalSdkApis,
      ...
      CommonViewerScript.setTranslationsAndExperiments(
        scopedGlobalSdkApis,
        context.getSentry(),
        (_a = context.context) === null || _a === void 0 ? void 0 : _a.instance,
        initAppParam
      );
    };
  };
  ...
  CommonViewerScript.getCreateControllers = function (
    controllerFunc,
    sentryReporter
  ) {
      ...
      try {
        ...
        return controllerConfig.map(function (config) {
          var res = Promise.resolve(
            controllerFunc(
              __assign(__assign({}, config), { widgets: widgets_1 })
            )
          );
          return res;
        });
