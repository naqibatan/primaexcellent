...
var directFullscreenHelper = /** @class */ (function () {
  ...
  // constructor() {}
  directFullscreenHelper.prototype.getDirectFullscreenFromParams = function (
    queryParams
  ) {
  ...
  directFullscreenHelper.prototype.getDirectFullscreenItemFromItemsList =
    function (queryParams, items, compId, fetcher) {
          ...
          switch (_a.label) {
            case 0:
              directfullscreenParams =
                this.getDirectFullscreenFromParams(queryParams);
              if (!directfullscreenParams || !items) {
                return [2 /*return*/, undefined];
              }
              if (
                !(
                  compId !== "comp-".concat(directfullscreenParams.galleryIdent)
                )
              )
                return [3 /*break*/, 3];
              ...
              return [
                ...
                items[
                  items.findIndex(function (item) {
                    return (
                      item.itemId === directfullscreenParams.itemId &&
  ...
  directFullscreenHelper.prototype.loadDirectFullscreen = function (
    compId,
    galleryId,
    queryParams,
    proGalleryStore
    ...
    if (directfullscreenParams) {
      if (compId === "comp-".concat(directfullscreenParams.galleryIdent)) {
        ...
        proGalleryStore.isValidUUID(directfullscreenParams.galleryIdent) // if a galleryId was used to identify the gallery
      ) {
        proGalleryStore.loadDirectFullscreenItem(
          directfullscreenParams.itemId,
          directfullscreenParams.galleryIdent
        );
        proGalleryStore.createDirectFullscreenBlueprintMockIfNeeded();
      } else {
  ...
  directFullscreenHelper.prototype.setMetaTagsForItemIfNeeded = function (
    props,
    item
  ) {
