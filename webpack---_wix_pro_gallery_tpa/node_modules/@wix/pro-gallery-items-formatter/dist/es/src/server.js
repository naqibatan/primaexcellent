...
var mapResolutionsToWixVideoQualities =
  function mapResolutionsToWixVideoQualities(resolutions) {
...
var extractMediaUrl = function extractMediaUrl(
  serverMediaUrl,
  serverUrlFormat
) {
...
var mapProGalleryVideoPosters = function mapProGalleryVideoPosters(
  serverPosters,
  isCustomPoster
) {
...
export var generateProGalleryLink = function generateProGalleryLink(
  serverLink
) {
  ...
  var proGalleryserverLink = serverLinkFieldOptions.find(function (_ref) {
    ...
    return (
      serverLink.wixLinkData && serverLink.wixLinkData["" + serverLinkField]
    );
  });
  if (!serverLink.wixLinkData) {
    return _objectSpread(
      _objectSpread({}, serverLink),
      {},
      {
        type: "web",
      }
  ...
  return _objectSpread(
    {
      target:
        (proGalleryserverLink &&
          (serverLink == null
            ? void 0
            : serverLink.wixLinkData["" + proGalleryserverLink.serverLinkField]
                .target)) ||
        serverLink.target,
      type: "wix",
      data: _objectSpread(
        _objectSpread(
          ...
          (proGalleryserverLink &&
            (serverLink == null
              ? void 0
              : serverLink.wixLinkData[
                  "" + proGalleryserverLink.serverLinkField
                ])) ||
            _objectSpread({}, serverLink)
        ),
        {},
        {
          type:
            (proGalleryserverLink == null
              ? void 0
              : proGalleryserverLink.type) || serverLink.type,
...
var buildProGalleryVideo = function buildProGalleryVideo(
  proGalleryItem,
  serverItem
) {
  ...
  var isExternalVideo =
    "source" in videoData && videoData.source !== "Undefined";
  console.log(serverItem);
  proGalleryItem = _objectSpread(
    _objectSpread(
      _objectSpread({}, proGalleryItem),
      isExternalVideo &&
        "posters" in videoData &&
        videoData.posters.length > 0 && {
          mediaUrl: getLastUrlPath(videoData.posters[0].url),
        }
    ),
    !isExternalVideo &&
      "mediaUrl" in serverItem && {
        mediaUrl: getWixMediaUrlVideo(serverItem.mediaUrl),
      }
  );
  proGalleryItem.metaData = _objectSpread(
    _objectSpread(
      _objectSpread(
        _objectSpread(
          _objectSpread(
              ...
              _objectSpread(
                _objectSpread(
                  _objectSpread(
                    _objectSpread(
                      _objectSpread(
                        _objectSpread(
                          _objectSpread(
                            _objectSpread(
                              _objectSpread({}, proGalleryItem.metaData),
                              {},
                              {
                                type: "video",
                              },
                    ...
                    "posters" in videoData && {
                      posters: mapProGalleryVideoPosters(
                        videoData.posters,
                        false
                      ),
                    }
                ...
                !isExternalVideo &&
                  "resolutions" in videoData && {
                    qualities: mapResolutionsToWixVideoQualities(
    ...
    "posters" in videoData &&
      videoData.posters[0] &&
      "focalPoint" in videoData.posters[0] && {
        focalPoint: [
          videoData.posters[0].focalPoint.x,
          videoData.posters[0].focalPoint.y,
        ],
      }
  );
  proGalleryItem.metaData.height =
    ((_proGalleryItem$metaD = proGalleryItem.metaData) == null
      ? void 0
      : _proGalleryItem$metaD.height) || 1080;
  proGalleryItem.metaData.width =
    ((_proGalleryItem$metaD2 = proGalleryItem.metaData) == null
      ? void 0
      : _proGalleryItem$metaD2.width) || 1920;
...
var photoGalleryQuality = function photoGalleryQuality(photoData) {
  var shouldAddPhotoQuality =
    "quality" in photoData || "unsharpMasking" in photoData;
  return _objectSpread(
    {},
    shouldAddPhotoQuality && {
      sharpParams: {
        L: _objectSpread(
          _objectSpread(
            {},
            "quality" in photoData && {
          ...
          "unsharpMasking" in photoData && {
            ...
            usm: _objectSpread(
              _objectSpread(
                _objectSpread(
                  {},
                  "amount" in photoData.unsharpMasking && {
...
var buildProGalleryPhoto = function buildProGalleryPhoto(
  proGalleryItem,
  serverItem
) {
  var haveMediaUrl =
    "mediaUrl" in serverItem && createPhotoUrl(serverItem.mediaUrl);
  proGalleryItem = _objectSpread(
    _objectSpread(
      _objectSpread(
        _objectSpread({}, proGalleryItem),
    ...
    _objectSpread(
      _objectSpread(
        _objectSpread(
          ...
          "focalPoint" in photoData &&
            photoData.focalPoint && {
...
var buildProGalleryText = function buildProGalleryText(
  proGalleryItem,
  serverItem
) {
    ...
    _objectSpread(
      _objectSpread(
        _objectSpread(
          ...
          textDataHaveStyle &&
            "height" in textData.style && {
              height: textData.style.height,
            }
        ),
        textDataHaveStyle &&
          "width" in textData.style && {
...
export var serverItemsToProGallery = function serverItemsToProGallery(
  serverItems
) {
  try {
    var proGalleryItems = serverItems.map(function (serverItem) {
      var proGalleryItem = _objectSpread(
        _objectSpread(
          _objectSpread(
            _objectSpread(
              _objectSpread(
...
var generateServerLink = function generateServerLink(proGalleryLink) {
  ...
  var serverPGLink = proGalleryLinkFieldOptions.find(function (_ref2) {
    ...
    return (
      proGalleryLink.data && proGalleryLink.data.type === proGalleryLinkField
    );
  });
  ...
  return serverPGLink
    ? {
        link: _objectSpread(
            ...
            _objectSpread(
              ...
              serverLinkData &&
                serverPGLink && {
                  wixLinkData:
                    ((_wixLinkData = {}),
                    (_wixLinkData[serverPGLink.type] = _objectSpread(
                      {},
                      serverLinkData
                    )),
                    _wixLinkData),
          ...
          {
            type:
              serverPGLink && serverPGLink.isInternal ? "Internal" : "External",
...
var buildServerPhoto = function buildServerPhoto(_ref4) {
  ...
  var haveMediaUrl =
    "mediaUrl" in proGalleryItem && createServerUrl(proGalleryItem.mediaUrl);
  serverItem = _objectSpread(
    _objectSpread(
      _objectSpread(
        _objectSpread({}, serverItem),
        haveMediaUrl && {
    ...
    _objectSpread(
      _objectSpread(
        _objectSpread(
          ...
          {
            dataType: "Photo",
            photoMetadata: _objectSpread(
              _objectSpread(
                _objectSpread(
                  _objectSpread(
                    _objectSpread(
                      _objectSpread({}, serverItem.photoMetadata),
                      "height" in metaData && {
  ...
  serverItem = _objectSpread(
    _objectSpread(
      _objectSpread(
        ...
        {
          dataType: "Text",
          textMetadata: _objectSpread(
            _objectSpread(
              _objectSpread(
                _objectSpread(
                  _objectSpread({}, serverItem.textMetadata),
                  "editorHtml" in metaData && {
    ...
    _objectSpread(
      _objectSpread(
        _objectSpread(
              ...
              videoMetadata: _objectSpread(
                _objectSpread(
                  _objectSpread(
                        ...
                        _objectSpread(
                          _objectSpread(
                            _objectSpread(
                              _objectSpread(
                                _objectSpread(
                                  _objectSpread({}, serverItem.videoMetadata),
                                  "height" in metaData && {
                                    height: metaData.height,
                                  }
                                ),
                    ...
                    !isExternalVideo &&
                      "qualities" in metaData &&
                      metaData.qualities.length > 0
                      ? {
                          resolutions: mapQualitiesToServerResolutions(
                            metaData.qualities,
                            proGalleryItem.mediaUrl
                          ),
                        }
                      : {
                          resolutions: [],
                    ...
                    resolutions: [
                      {
                        urls:
                          ((_urls = {}),
                          (_urls[capitalizeFirstLetter(metaData.source)] =
                            metaData.videoUrl),
                          _urls),
                      },
                    ],
          ...
          !isExternalVideo &&
            "mediaUrl" in proGalleryItem && {
              mediaUrl: Object.values(
                mapQualitiesToServerResolutions(
                  metaData.qualities,
                  proGalleryItem.mediaUrl
                ).pop().urls
              )[0],
...
var serverQuality = function serverQuality(metaData) {
  var shouldAddPhotoQuality =
    "sharpParams" in metaData &&
    "L" in metaData.sharpParams &&
    ("unsharpMasking" in metaData.sharpParams.L ||
      "quality" in metaData.sharpParams.L);
...
var createServerUrl = function createServerUrl(proGalleryUrl) {
  return proGalleryUrl.includes("https://") || proGalleryUrl.includes("http://")
    ? proGalleryUrl
    : "https://static.wixstatic.com/media/" + proGalleryUrl;
};
...
var createServerPosters = function createServerPosters(metaData) {
  var posters = [];
  var focalPointObject =
    metaData && metaData.focalPoint
      ? {
          focalPoint: {
            x: metaData.focalPoint[0],
            y: metaData.focalPoint[1],
      ...
      : {};
  metaData &&
    metaData.posters.map(function (poster) {
      posters.push(
        _objectSpread(
          _objectSpread(
            _objectSpread(
...
var mapQualitiesToServerResolutions = function mapQualitiesToServerResolutions(
  qualities,
  mediaUrl
) {
...
export var proGalleryItemsToServer = function proGalleryItemsToServer(
  proGalleryItems
) {
  try {
