...
var parseColor = function (value, forcedOpacity) {
  ...
  if (!value) {
    ...
    opacity =
      (_a = result.value[COLOR_CHANNELS]) !== null && _a !== void 0 ? _a : 1;
  }
  return {
    rgb: function () {
      var _a;
      return (_a = colorString.to).rgb.apply(
        _a,
        __spreadArray(
          __spreadArray([], color, false),
          [
            forcedOpacity !== null && forcedOpacity !== void 0
              ? forcedOpacity
              : opacity,
          ],
          false
    ...
    opacity: function () {
      return forcedOpacity !== null && forcedOpacity !== void 0
        ? forcedOpacity
        : opacity;
    },
  };
