...
import { StyleParamType } from "./StylesContext.types";
import { StylesStore } from "./styles/StylesStore";
import { WixStyles } from "./styles/WixStyles";
import { createStyleParamGetter } from "./styles/createStyleParamGetter";
import { StylesProviderIsNotReadyError } from "./StylesProviderIsNotReadyError";
import {
  CantModifyParamError,
  ParamType,
  ModifyModes,
} from "../Error/CantModifyParamError";
var TPASettingStyleParamToStyleMap =
  ((_a = {}),
...
var StylesProvider = /** @class */ (function (_super) {
    ...
    _this.getStyleParamsWithDefaults = function (styleParams) {
      ...
      Object.values(userStylesParams).forEach(function (userStyleParam) {
        ...
        if (typeof styleParamValue !== "undefined") {
          styleParams[TPASettingStyleParamToStyleMap[userStyleParam.type]][
            userStyleParam.key
          ] = styleParamValue;
        }
      });
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            ...
            this.wixStyles = new WixStyles(
              this.props.SDKAdapter,
              this.props.editorSDK
            );
            _c = (_b = Promise).all;
  ...
  StylesProvider.prototype.initStylesStore = function (_a) {
    ...
    var decodedStyleParams = this.wixStyles.decode(
      styleParams,
      colors,
      textPresets
    );
  ...
  StylesProvider.prototype.componentDidUpdate = function (prevProps) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!(this.props.revisionID !== prevProps.revisionID))
              return [3 /*break*/, 2];
  ...
  StylesProvider.prototype.widgetPropsChanged = function (props, prevProps) {
    return (
      !isEqual(props.styleParams, prevProps.styleParams) ||
