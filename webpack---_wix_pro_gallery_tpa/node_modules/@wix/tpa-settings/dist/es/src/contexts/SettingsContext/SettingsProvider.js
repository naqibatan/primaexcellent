...
import { SettingsProviderIsNotReadyError } from "./SettingsProviderIsNotReadyError";
import {
...
import { NoSDKOrDataProvidedError } from "./NoSDKOrDataProvidedError";
import { generateKey, isParamTranslatable } from "../../generateKey";
import { getSettingsDefaultValue, getSettingsValue } from "./getSettingsValue";
...
var createPublicData = function (newPublicData) {
  ...
  return {
    APP:
      (_a =
        newPublicData === null || newPublicData === void 0
          ? void 0
          : newPublicData.APP) !== null && _a !== void 0
        ? _a
        : {},
    COMPONENT:
      (_b =
        newPublicData === null || newPublicData === void 0
          ? void 0
          : newPublicData.COMPONENT) !== null && _b !== void 0
        ? _b
        : {},
  };
};
var SettingsProvider = /** @class */ (function (_super) {
  ...
  function SettingsProvider(props) {
    ...
    _this.handleSetParam = function (param, value) {
      ...
      _this.setState(function (state) {
        ...
        return __assign(__assign({}, state), {
          publicData: __assign(
            __assign({}, state.publicData),
            ((_a = {}),
            (_a[scope] = __assign(
              __assign({}, state.publicData[scope]),
              ((_b = {}), (_b[key] = serializedValue), _b)
            )),
            _a)
          ),
        });
      ...
      (_a = _this.props.history) === null || _a === void 0
        ? void 0
        : _a.addDebounced(param.key);
      (_b = _this.props.bi) === null || _b === void 0
        ? void 0
        : _b.settingsChanged({
            parameter: param.key,
    ...
    _this.handleResetAll = function (settings) {
      ...
      (_b = _this.props.history) === null || _b === void 0
        ? void 0
        : _b.endBatch("All settings");
    };
    _this.handlePublishEvent = function (event, value) {
      if (_this.isWidgetMode()) {
        throw new CantModifyParamError(
          ModifyModes.PublishEvent,
          ParamType.Setting
        );
      }
