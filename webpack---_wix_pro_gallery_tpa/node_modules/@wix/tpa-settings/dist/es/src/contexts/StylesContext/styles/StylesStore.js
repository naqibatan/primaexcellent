...
import { StyleParamType } from "../../../types";
import { generateKey } from "../../../generateKey";
import { NoGetDefaultValueSpecified } from "./NoGetDefaultValueSpecified";
...
var StylesStore = /** @class */ (function () {
  function StylesStore(_a) {
    ...
    this.set = function (param, value, options) {
      ...
      var paramKey = generateKey(__assign(__assign({}, param), { key: key }), {
      ...
      (_a = _this.history) === null || _a === void 0
        ? void 0
        : _a.addDebounced(key);
      (_b = _this.bi) === null || _b === void 0
        ? void 0
        : _b.settingsChanged({
            parameter: key,
            value: value,
    ...
    this.getCurrentStyles = function () {
      if (_this.currentStylesGetter) {
        return _this.wixStyles.decode(
          _this.currentStylesGetter(),
          _this.colors,
          _this.textPresets
        );
      }
    ...
    this.resetAll = function (styles) {
      ...
      (_b = _this.history) === null || _b === void 0
        ? void 0
        : _b.endBatch("All styles");
    };
  ...
  StylesStore.prototype.setStylesParam = function (param, key, value) {
    var _a, _b;
    this.styles = __assign(
      __assign({}, this.styles),
      ((_a = {}),
      (_a[param] = __assign(
        __assign({}, this.styles[param]),
        ((_b = {}), (_b[key] = value), _b)
      )),
      _a)
    );
  ...
  StylesStore.prototype.getAllForAllBreakpoints = function () {
    ...
    if (this.allStylesGetter) {
      return JSON.parse(
        JSON.stringify(
          this.allStylesGetter().map(function (styleParamsForBreakpoint) {
            return _this.wixStyles.decode(
              styleParamsForBreakpoint,
              _this.colors,
              _this.textPresets
            );
          })
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.wixStyles.decode(styleParams, this.colors, this.textPresets),
            ];
          case 1:
            _a.styles = _b.sent();
            return [2 /*return*/];
  ...
  StylesStore.prototype.handleSiteColorChange = function (palette) {
    ...
    this.styles = __assign(__assign({}, this.styles), { colors: newColors });
  };
  return StylesStore;
})();
export { StylesStore };
