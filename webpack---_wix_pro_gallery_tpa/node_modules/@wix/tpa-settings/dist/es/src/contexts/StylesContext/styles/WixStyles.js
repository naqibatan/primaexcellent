...
import { encode } from "./WixStyleColors";
import { decodeWixStyles } from "./decodeWixStyles";
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.editorSDK.components.getById("token", {
                  id: getComponentId(),
                }),
              ];
            case 1:
              ...
              return [
                4 /*yield*/,
                this.editorSDK.document.tpa.getStyleParams("token", {
                  compRef: compRef,
                }),
              ];
            case 2:
              ...
              return [
                2 /*return*/,
                this.normalizeStylesReceivedFromEditorSDK(styles),
              ];
            case 3:
              return [2 /*return*/];
          }
              ...
              return __generator(this, function (_e) {
                switch (_e.label) {
                  case 0:
                    if (
                      !(
                        styles.colors.hasOwnProperty(color) &&
                        styles.colors[color].hasOwnProperty("themeName")
                      )
                    )
                      return [3 /*break*/, 2];
