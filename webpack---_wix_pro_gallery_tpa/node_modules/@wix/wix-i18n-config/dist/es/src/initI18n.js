...
import ICU from "./icu";
import { loadBrowserPolyfillsIfNeeded } from "./polyfills/browser";
export function initI18n(_ref) {
  var _ref$icuOptions = _ref.icuOptions,
    ...
    parseErrorHandler =
      _ref$parseErrorHandle === void 0 ? undefined : _ref$parseErrorHandle,
    _ref$polyfillRelative = _ref.polyfillRelativeTime,
    polyfillRelativeTime =
      _ref$polyfillRelative === void 0 ? false : _ref$polyfillRelative,
    options = _objectWithoutPropertiesLoose(_ref, _excluded);

  var icu = new ICU(
    _objectSpread(
      _objectSpread({}, icuOptions),
      {},
      {
