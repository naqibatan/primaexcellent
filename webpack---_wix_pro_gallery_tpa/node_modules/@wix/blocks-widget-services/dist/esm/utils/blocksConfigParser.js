...
export default function parseBlocksConfig(appParams) {
  ...
  return {
    ...
    code: {
      ...
      experimentsQueryString:
        ((_b =
          ...
          ? void 0
          : _b.codeExperimentsQueryString) || "", // Should be replaced with a type guard once WBL-2343 is done
    },
    siteId,
    metaSiteId,
    revision,
    codePackagesData:
      (_d =
        (_c = appParams.appData) === null || _c === void 0
          ? void 0
          : _c.blocksConsumerData) === null || _d === void 0
        ? void 0
        : _d.codePackagesData,
  };
}
export const isPanelControllerConfig = (controllerConfig) => {
  ...
  if (
    !((_b =
      (_a =
        controllerConfig === null || controllerConfig === void 0
          ? void 0
          : controllerConfig.wixCodeApi) === null || _a === void 0
        ? void 0
  ...
  const url = new URL(
    (_d =
      (_c =
        controllerConfig === null || controllerConfig === void 0
          ? void 0
          : controllerConfig.wixCodeApi) === null || _c === void 0
        ? void 0
        : _c.location) === null || _d === void 0
      ? void 0
      : _d.url
  );
