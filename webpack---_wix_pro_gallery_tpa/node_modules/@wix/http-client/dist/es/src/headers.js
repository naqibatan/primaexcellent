...
import { extractHost, isAbsoluteUrl } from "./utils";
...
export const composeHeaders = ({ url, disableWixHeaders, wixHeadersOpts }) => {
...
export function isWixDomain(url) {
  ...
  const isWhitelisted = whitelistedHosts.find((wixHost) =>
    host.endsWith(`.${wixHost}`)
  );
