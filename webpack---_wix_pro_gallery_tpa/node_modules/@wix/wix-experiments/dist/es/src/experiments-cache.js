...
import { isUrlOfExperiment, isValidScopeUrl } from "./urlMap";
var ExperimentsRequestsCache = /** @class */ (function () {
  ...
  ExperimentsRequestsCache.prototype.getExperimentValue = function (
    specName,
    useNewApi
  ) {
    var e_1, _a;
    try {
      for (
        var _b = __values(this.urlMap.keys()), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var url = _c.value;
...
export { ExperimentsRequestsCache };
