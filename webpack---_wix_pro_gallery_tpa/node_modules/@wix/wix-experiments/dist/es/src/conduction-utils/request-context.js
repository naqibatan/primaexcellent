...
var buildOverrideCriteriaQuery = function (overrideCriteria) {
  if (isNonEmptyString(overrideCriteria.entityId)) {
    return "&requestContext.overrideCriteria.entityId=".concat(
      overrideCriteria.entityId
    );
  }
  return "";
};
export function getRequestContextQuery(requestContext) {
  ...
  var query = "";
  var fieldsPassed = ["forSiteOwner", "forSiteVisitors"].reduce(function (
    acc,
    cur
  ) {
