  ...
  return function serialize(json, converterType) {
    ...
    function transformSchema(schema, payload) {
      ...
      Object.entries(payload).forEach(function (_a) {
        ...
        var isRepeatable =
          (_d =
            (_c =
              (_b = getConverter(schemaName)) === null || _b === void 0
                ? void 0
                : _b.checkRepetable) === null || _c === void 0
              ? void 0
              : _c.call(_b, val)) !== null && _d !== void 0
            ? _d
            : Array.isArray(val);
        var parsedValue;
        if (isRepeatable) {
    ...
    function applyField(val, schemaOrSerializer) {
      ...
      throw new Error(
        "".concat(
          schemaOrSerializer,
          " is neither schema nor serializable type"
        )
      );
    }
    function getConverter(name) {
      var _a;
      return (_a = converterSets[name]) === null || _a === void 0
        ? void 0
        : _a[converterType];
    }
