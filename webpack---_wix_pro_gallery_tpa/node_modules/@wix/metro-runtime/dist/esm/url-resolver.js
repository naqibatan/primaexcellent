...
var REGEX_CAPTURE_API_DOMAINS = new RegExp(
  "\\.(".concat(WIX_API_DOMAINS.join("|"), ")$")
);
var REGEX_CAPTURE_DEV_WIX_CODE_DOMAIN = new RegExp(
  ".*\\.".concat(DEV_WIX_CODE_DOMAIN, "$")
);
