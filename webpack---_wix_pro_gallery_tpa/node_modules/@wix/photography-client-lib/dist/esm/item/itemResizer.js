  ...
  return function (args) {
    return resize(
      __assign(__assign({}, args), {
        ...
        shouldUseOptimizedImageFormat:
          useOptimizedImageFormat !== null && useOptimizedImageFormat !== void 0
...
var removeResizeParams = function (originalUrl, WIX_MEDIA_PREFIX) {
  ...
  var resizingParamerterRegex =
    /(\/v\d\/(fill|fit|crop)\/(((w|h|x|y|scl|al|q)_[cf\d]*)\,?)*){1,}/;
...
var shouldProccessPrerenderImageForPerformance = function (isPrerenderMode) {
  return (
    ...
    !experimentsWrapper.getExperimentBoolean(
      "specs.pro-gallery.excludeFromPrerenderPerformance"
    )
  );
};
var resizeWidthInStepsUp = function (
  requieredWidth,
  requiredHeight,
  item,
  resizedMethod
  ...
  if (requieredWidth > 1 || requiredHeight > 1) {
    ...
    var nextWidth = Math.min(
      item.maxWidth,
      Math.ceil(requieredWidth / 480) * 480
    );
...
var createResizedImageUrl = function (_a) {
  ...
  var addSharpParams = function () {
    ...
    sharpParams.quality = Math.min(
      shouldProccessPrerenderImageForPerformance(isPrerenderMode) &&
        !experimentsWrapper.getExperimentBoolean(
    ...
    if (sharpParams.allowUsm === true) {
      sharpParams.usm.usm_a = Math.min(
        ...
        Math.max(
          0,
          ((_a = sharpParams.usm) === null || _a === void 0
            ? void 0
            : _a.usm_a) ||
            ((_c =
              (_b = sharpParams.usm) === null || _b === void 0
                ? void 0
                : _b.usm) === null || _c === void 0
              ? void 0
              : _c.a) ||
            0
        )
      ...
      sharpParams.usm.usm_r = Math.min(
        ...
        Math.max(
          0,
          ((_d = sharpParams.usm) === null || _d === void 0
            ? void 0
            : _d.usm_r) ||
            ((_f =
              (_e = sharpParams.usm) === null || _e === void 0
                ? void 0
                : _e.usm) === null || _f === void 0
              ? void 0
              : _f.r) ||
            0
        )
      ...
      sharpParams.usm.usm_t = Math.min(
        ...
        Math.max(
          0,
          ((_g = sharpParams.usm) === null || _g === void 0
            ? void 0
            : _g.usm_t) ||
            ((_j =
              (_h = sharpParams.usm) === null || _h === void 0
                ? void 0
                : _h.usm) === null || _j === void 0
              ? void 0
              : _j.t) ||
            0
        )
  ...
  var addResizeParams = function () {
    if (
      ...
      return "/v1/"
        .concat(resizeMethod, "/w_")
        .concat(requiredWidth, ",h_")
        .concat(requiredHeight);
    } else {
  ...
  var mobileScaleFix = Math.max(
    baseUtils.isMobile() && !baseUtils.isSSR() ? window.screen.width / 320 : 1,
    1
  );
  requiredWidth = Math.ceil(requiredWidth * devicePixelRatio * mobileScaleFix);
  requiredHeight = Math.ceil(
    requiredHeight * devicePixelRatio * mobileScaleFix
  );
  var originalMaxPixels = originalWidth * originalHeight;
  var _e = limtImageResToMaxRes(
      requiredWidth,
      requiredHeight,
      originalMaxPixels < MAX_WIX_PIXELS ? originalMaxPixels : MAX_WIX_PIXELS
    ),
  ...
  if (
    experimentsWrapper.getExperimentBoolean(
      "specs.pro-gallery.useRoundedImageSizes"
    )
  ) {
    ...
    requiredHeight = Math.ceil(
      (requiredHeight * requiredWidth) / oldRequiredWidth
    );
  }
...
var resize = function (_a) {
  ...
  var WIX_MEDIA_PREFIX = (
    staticMediaUrls === null || staticMediaUrls === void 0
      ? void 0
      : staticMediaUrls.staticMediaUrl
  )
    ? staticMediaUrls.staticMediaUrl
    : "https://static.wixstatic.com/media/";
  var WIX_VIDEO_PREFIX = (
    staticMediaUrls === null || staticMediaUrls === void 0
      ? void 0
  ...
  if (resizeMethod === "video") {
    ...
    // resized image
    if (shoulduseWowImage({ createComplexImageElement: createMultiple })) {
...
var createWowImageData = function (_a) {
  ...
  var imageData = {
    ...
    name:
      (_c =
        (_b = item.dto) === null || _b === void 0 ? void 0 : _b.metaData) ===
        null || _c === void 0
        ? void 0
        : _c.fileName,
...
var resizeImageUrl = function (_a) {
  ...
  if (createMultiple) {
    ...
    return createResizedImageUrl(
      __assign(__assign({}, params), { WIX_MEDIA_PREFIX: WIX_MEDIA_PREFIX })
    );
  }
};
...
var getResizeMethod = function (_a) {
  var resizeMethod = _a.resizeMethod,
    ...
    requiredWidth = _a.requiredWidth;
  var _resizeMethod =
    resizeMethod === "fit" || shouldUseFitOnly(isPrerenderMode)
      ? "fit"
      : "fill";
  if (requiredHeight <= 1 && requiredWidth <= 1) _resizeMethod = "fill";
