  ...
  AppSettings.prototype.processAppSettingsResponse = function (response) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!response.settings.originGallerySettings)
              return [3 /*break*/, 2];
            response.settings = __assign(
              __assign({}, response.settings.originGallerySettings),
              response.settings
            );
            response.settings.originGallerySettings = null;
            if (!(!this.isLiveSite() && !this.isPreview()))
              return [3 /*break*/, 2];
            return [
              4 /*yield*/,
              this.setMultiple(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (
              !(
                response.status === 503 && // could be blocked by ddos protection in case of alots of galleries
                this.fetchRetries < this.numberOfAllowedRetries
              )
            )
              return [3 /*break*/, 4];
            this.fetchRetries++;
  ...
  AppSettings.prototype.setMultiple = function (settingObject, state) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            (galleryId = settingObject.galleryId),
              (neededSettings = __rest(settingObject, ["galleryId"]));
            host = "VIEWER";
