...
var VersionManager = /** @class */ (function () {
  ...
  VersionManager.prototype.getFeaturesWithNewerVersions = function (
    manualUpdates
  ) {
    var _this = this;
    if (manualUpdates === void 0) {
    ...
    Object.keys(this.features).forEach(function (featureName) {
      ...
      var featureManualUpdateDate = featureManualUpdate
        ? baseUtils.getDateCreatedTicksFromStr(
            _.get(featureManualUpdate, "date") || featureManualUpdate
          )
        : null;
      var isAFutureFeature = featureLatest.dateFrom > Date.parse(new Date());
      var shouldAffectProGallry =
        typeof featureLatest.affectsProGallery === "undefined" ||
        (featureLatest.affectsProGallery && !isStore);
      var shouldAffectArtStore =
        typeof featureLatest.affectsArtStore === "undefined" ||
        (featureLatest.affectsArtStore && isStore);
      var shouldAffect = isStore ? shouldAffectArtStore : shouldAffectProGallry;
      var featureHasNewerVersion =
        featureLatest.dateFrom > (featureManualUpdateDate || _this.dateCreated);
      var featureNeedsToUpgrade =
        !isAFutureFeature && featureHasNewerVersion && shouldAffect;
