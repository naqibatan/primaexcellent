...
export var parseStyleParams = function (styles, isStoreGallery, isMobile) {
  ...
  var flatStyles =
    ...
    (styles.numbers || styles.colors || styles.booleans || styles.fonts)
      ? __assign(
          __assign(
            __assign(__assign({}, styles.numbers), styles.colors),
            styles.booleans
          ),
          styles.fonts
        )
  ...
  var parseBackgroundCss = function (_a) {
    var allowBackgroundGradient = _a.allowBackgroundGradient,
      ...
      backgroundGradientDegrees =
        _b === void 0 ? styleParams.backgroundGradientDegrees : _b;
    if (
      allowBackgroundGradient &&
      ...
      var backgroundCss = "linear-gradient("
        .concat(backgroundGradientDegrees, "deg,")
        .concat(backgroundGradientColor1.value, ",")
        .concat(backgroundGradientColor2.value, ")");
  ...
  var fullResFeatureStyleParamSet = !_.isUndefined(
    flatStyles.galleryItemResolution
  );
  var shouldUseFullResFeature =
    fullResFeatureExperimentEnabled && fullResFeatureStyleParamSet;
