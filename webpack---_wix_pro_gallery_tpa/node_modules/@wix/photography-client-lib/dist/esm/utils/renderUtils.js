...
var RenderUtils = /** @class */ (function (_super) {
  ...
  RenderUtils.prototype.getWindow = function (
    windowName,
    verifyParam,
    compId,
    instanceId
  ...
  RenderUtils.prototype.getGalleryByCompId = function (compId) {
    ...
    for (var d = 0; d < window.parent.frames.length; d++) {
      try {
        var frame = window.parent.frames[d];
        if (
          frame.isGallery === true ||
          frame.document.location.href.indexOf(
            this.getUrlPrefix() + "gallery"
          ) >= 0
        ) {
  ...
  RenderUtils.prototype.getGalleryDataFromWorker = function () {
    ...
    var galleryData =
      this.getWorkerWindow()["pro-gallery-data-" + compId] || {};
    return galleryData;
  };
  RenderUtils.prototype.getGallerySettingsFromWindow = function (
    galleryWindow
  ) {
  ...
  RenderUtils.prototype.getFullscreenUrlState = function (
    compId,
    itemId,
    itemIdx,
    pageId,
