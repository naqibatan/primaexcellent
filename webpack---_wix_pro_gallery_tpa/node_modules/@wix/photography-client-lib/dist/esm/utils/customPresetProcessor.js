...
import { assignByString, optionsMap } from "pro-gallery-lib";
...
export var addCustomPresetStyles = function (_a) {
  ...
  if (isMobile) {
    return (
      ((_b = presets[presetId]) === null || _b === void 0
        ? void 0
        : _b.mobile(styles)) || styles
    );
  } else {
    return (
      ((_c = presets[presetId]) === null || _c === void 0
        ? void 0
        : _c.desktop(styles)) || styles
    );
  }
};
