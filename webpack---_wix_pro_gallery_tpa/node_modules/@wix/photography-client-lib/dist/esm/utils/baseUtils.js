...
var BaseUtils = /** @class */ (function () {
  ...
  BaseUtils.prototype.isTouch = function () {
    ...
    return this.getOrPutFromCache("isTouch", function () {
      try {
        return (
          _this.isMobile() || "ontouchstart" in window.document.documentElement
        );
      } catch (e) {
        return false;
      }
  ...
  BaseUtils.prototype.setStateAndLog = function (
    that,
    caller,
    state,
    callback
