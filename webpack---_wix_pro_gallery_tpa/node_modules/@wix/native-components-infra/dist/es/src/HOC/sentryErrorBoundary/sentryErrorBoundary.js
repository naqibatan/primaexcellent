  ...
  return /** @class */ (function (_super) {
    ...
    SentryErrorBoundary.prototype.getLazySentry = function () {
      return new this.props.host.LazySentry(
        __assign(__assign({ dsn: options.dsn }, options.config), {
    ...
    SentryErrorBoundary.prototype.componentDidCatch = function (error) {
      ...
      if (options.userContext || userContextOverrides) {
        sentryInstance.configureScope(function (scope) {
          scope.setUser(
            __assign(__assign({}, options.userContext), userContextOverrides)
          );
        });
      }
    ...
    SentryErrorBoundary.prototype.render = function () {
      return this.state.error && ErrorStateComponent
        ? React.createElement(
            ErrorStateComponent,
            __assign({ error: this.state.error }, this.props)
          )
        : React.createElement(ComponentToWrap, __assign({}, this.props));
    };
