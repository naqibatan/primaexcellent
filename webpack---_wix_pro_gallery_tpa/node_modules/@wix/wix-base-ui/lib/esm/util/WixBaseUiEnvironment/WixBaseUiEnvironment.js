...
import { st, classes } from "./WixBaseUiEnvironment.st.css";
import {
 ...
 */
var WixBaseUiEnvironmentProvider = /*#__PURE__*/ (function (
  _BaseUiNextProvider
) {
  ...
  _createClass(WixBaseUiEnvironmentProvider, [
    {
      ...
      value: function getClassName() {
        ...
        return st(
          ...
          this.themeRootSelectors[theme],
          darkMode && "dark-mode",
          inputBorders && theme === "facelift"
            ? "input-borders-experiment"
            : "",
          _get(
            _getPrototypeOf(WixBaseUiEnvironmentProvider.prototype),
            "getClassName",
            this
          ).call(this)
        );
      ...
      value: function getValue() {
        var _this$props2 = this.props,
          ...
          forceCloseTooltipAutomaticallyAfter =
            _this$props2.forceCloseTooltipAutomaticallyAfter;
        return {
          theme: theme,
          darkMode: darkMode,
          madefor: madefor,
