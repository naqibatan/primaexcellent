...
export var PG_TEST_TYPE =
  ...
  (_a["USER_CLIENT".concat(featureSledTesting)] = "2".concat(
    featureSledTesting
  )),
  (_a["PRODUCTION_USER_SSR".concat(featureSledTesting)] = "3".concat(
    featureSledTesting
  )),
  (_a["PRODUCTION_USER_CLIENT".concat(featureSledTesting)] = "4".concat(
    featureSledTesting
  )),
  _a);
