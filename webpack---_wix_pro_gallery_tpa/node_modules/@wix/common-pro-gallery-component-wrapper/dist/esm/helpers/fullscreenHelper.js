...
var FullscreenHelper = /** @class */ (function () {
  function FullscreenHelper(galleryWrapper, props, isStore) {
    ...
    this.directFullscreenItemProps = function () {
      ...
      if (
        _this.galleryWrapper.state.fullscreen.directFullscreenItem &&
    ...
    this.updateFullscreenCurrentItem =
      this.updateFullscreenCurrentItem.bind(this);
    ...
    this.unSubscribeToFullscreenChangeEvent =
      this.unSubscribeToFullscreenChangeEvent.bind(this);
  }
  ...
  FullscreenHelper.prototype.updateFullscreenCurrentItem = function (
    galleryItem
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.galleryWrapper.itemActionsHelper.useItemActions("pageUrl"),
            ];
          case 2:
            page_url = _a.sent();
            itemData = constructMetaTagsItemData(
              galleryItem,
              page_url,
              fullscreen_url
            );
  ...
  FullscreenHelper.prototype.canUpdateUrl = function () {
    if (
      ...
      ) !== GALLERY_v4_CONSTS.viewMode.SITE
    ) {
      return false;
    }
    return true;
  ...
  FullscreenHelper.prototype.getFullscreenIndex = function (itemProps) {
    var totalItemsCount =
      this.galleryWrapper.itemsHelper.pgItemsProps().totalItemsCount;
    if (itemProps.idx > 0 && totalItemsCount > 0) {
      return itemProps.idx % totalItemsCount;
    }
    return itemProps.idx;
  };
  FullscreenHelper.prototype.setGalleryWrapperFullscreenState = function (
    fullscreen,
    callback
  ) {
    this.galleryWrapper.setState({ fullscreen: fullscreen }, callback);
  };
  FullscreenHelper.prototype.animatedOpenFullscreen = function (itemProps) {
    var _this = this;
    this.galleryWrapperProps.blockScroll();
    var fullscreen = __assign(
      __assign({}, this.galleryWrapper.state.fullscreen),
      {
    ...
    this.setGalleryWrapperFullscreenState(fullscreen, function () {
      ...
      _this.setGalleryWrapperFullscreenState(
        __assign(__assign({}, _this.galleryWrapper.state.fullscreen), {
          fullscreenAnimating: false,
        })
      );
    });
  };
  FullscreenHelper.prototype.animatedCloseFullscreen = function (
    itemIdx,
    animationDuration
  ) {
    var _this = this;
    ...
    try {
      if (itemIdx >= 0) {
        var itemDto =
          this.galleryWrapper.itemsHelper.pgItemsProps().items[itemIdx];
        var item = { id: itemDto.itemId, idx: itemIdx };
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              setTimeout(function () {
                var _fullscreen = Object.assign(
                  {},
                  _this.galleryWrapper.state.fullscreen,
                  {
  ...
  FullscreenHelper.prototype.subscribeToFullscreenChangeEvent = function (
    callback
  ) {
    window.document.addEventListener(
      "proGalleryFullscreenChange",
