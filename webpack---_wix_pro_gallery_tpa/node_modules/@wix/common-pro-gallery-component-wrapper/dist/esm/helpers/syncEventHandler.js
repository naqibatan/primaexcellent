...
var SyncEventHandler = /** @class */ (function () {
    ...
    if (isEventHandled) {
      if (!this.asyncEventHandler) {
        import(
          ...
          _this.asyncEventHandler = new module.default(
            _this.galleryWrapper,
            _this.galleryWrapperProps
          );
  ...
  SyncEventHandler.prototype.fullscreenEventHandler = function (
    eventName,
    eventData
  ) {
    var _this = this;
