...
import { INFO_EVENTS } from "@wix/pro-gallery-info-element";
var AsyncEventHandler = /** @class */ (function () {
  function AsyncEventHandler(galleryWrapper, props) {
    ...
    this.debounceHandleGalleryScrolled = utils.debounce(
  ...
  AsyncEventHandler.prototype.handleGalleryScrolled = function (eventData) {
    var top = eventData.top,
      left = eventData.left;
    this.galleryWrapper.setState({ galleryScroll: { x: top, y: left } });
  };
  AsyncEventHandler.prototype.handleEvent = function (
    eventName,
    eventData,
    event
  ) {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            _b = eventName;
            switch (_b) {
              case GALLERY_v4_CONSTS.events.GALLERY_SCROLLED:
                return [3 /*break*/, 1];
              case GALLERY_v4_CONSTS.events.LOAD_MORE_CLICKED:
                return [3 /*break*/, 2];
              case GALLERY_v4_CONSTS.events.ITEM_ACTION_TRIGGERED:
                return [3 /*break*/, 3];
              case GALLERY_v4_CONSTS.events.CURRENT_ITEM_CHANGED:
                return [3 /*break*/, 4];
              case GALLERY_v4_CONSTS.events.ITEM_FOCUSED:
                return [3 /*break*/, 5];
              case GALLERY_v4_CONSTS.events.ITEM_LOST_FOCUS:
                return [3 /*break*/, 6];
              case GALLERY_v4_CONSTS.events.NEED_MORE_ITEMS:
                return [3 /*break*/, 7];
              ...
              case INFO_EVENTS.LOVE_BUTTON_CLICKED:
                return [3 /*break*/, 13];
              case GALLERY_v4_CONSTS.events.ITEM_CLICKED:
                return [3 /*break*/, 14];
              case INFO_EVENTS.DOWNLOAD_BUTTON_CLICKED:
                return [3 /*break*/, 15];
              case INFO_EVENTS.CUSTOM_BUTTON_CLICKED:
                return [3 /*break*/, 16];
              case GALLERY_v4_CONSTS.events.THUMBNAIL_CLICKED:
                return [3 /*break*/, 17];
            }
            return [3 /*break*/, 18];
          case 1:
          ...
          case 2:
            ...
            ((_a = this.galleryWrapperProps) === null || _a === void 0
              ? void 0
              : _a.handleLoadMoreClicked) &&
          ...
          case 10:
            this.galleryWrapper.toggleSocialShareScreen(
              eventData.showSocialSharePopup,
              eventData
            );
            this.galleryWrapper.logHelper.reportBiEvent(
              "info", // Share icon (that opens the social-share popup) clicked
              eventData,
              "gallery"
            );
            return [3 /*break*/, 19];
          ...
          case 13:
            ...
            return [3 /*break*/, 19];
          case 14:
            this.galleryWrapper.itemActionsHelper.onItemClicked(
              eventData,
              event
            );
            this.galleryWrapper.logHelper.reportBiEvent(
  ...
  AsyncEventHandler.prototype.handleFullscreenEvent = function (
    eventName,
    eventData
  ) {
    return __awaiter(this, void 0, void 0, function () {
