...
var SiteHelper = /** @class */ (function () {
  ...
  SiteHelper.prototype.update = function (props) {
    ...
    experimentsWrapper.setExperiments(
      __assign({}, this.galleryWrapperProps.experiments)
    );
  ...
  SiteHelper.prototype.handleNewGalleryStructure = function (
    ...
    var numOfItems = newGalleryStructureData.numOfItems,
      ...
      isFixedHorizontlaGalleryRatio =
        newGalleryStructureData.isFixedHorizontlaGalleryRatio,
  ...
  SiteHelper.prototype.getPreviewMobileEmulatorBoundingClientRect =
    function () {
      try {
