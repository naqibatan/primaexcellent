...
var DimensionsHelper = /** @class */ (function () {
  function DimensionsHelper(parent) {
    this.debouncedMeasureContainer = utils.debounce(
      this.measureContainer.bind(this),
      500
    );
    this.container = {};
  ...
  DimensionsHelper.prototype.update = function (props) {
    var dimensions = props.dimensions,
      id = props.id;
    var propsJson = JSON.stringify({ dimensions: dimensions, id: id });
  ...
  DimensionsHelper.prototype.BOLT_SUPPORTING_FUNCTION_updateWorkerWithHostDimensions =
    function (props) {
      var _this = this;
      var _a;
      if (props.viewerName !== "thunderbolt") {
        var hostDimensions_1 =
          (_a = props.host) === null || _a === void 0 ? void 0 : _a.dimensions;
        this.parent.clientSideFunctionsConnectedPromise.promise.then(
          function () {
            ...
            _this.parent.props.BOLT_SUPPORTING_FUNCTION_onNewHostDimensions(
              hostDimensions_1
            );
          }
        );
  ...
  DimensionsHelper.prototype.observeResize = function () {
    ...
    var galleryWrapperElement = window.document.getElementById(
      "gallery-wrapper-".concat(this.id)
    );
  ...
  DimensionsHelper.prototype.measureContainer = function () {
    ...
    var dimensions = __assign(
      __assign(
        __assign(
          __assign({}, this.getGalleryDimensions()),
          this.getScrollBase()
        ),
        this.getScreenDimensions()
      ),
      this.isPreview() ? this.getMobilePreviewFrameDimensions() : {}
    );
  ...
  DimensionsHelper.prototype.measureScrollBase = function (
    ...
    if (
      JSON.stringify(scrollBase) !== JSON.stringify(this.dimensions.scrollBase)
    ) {
  ...
  DimensionsHelper.prototype.calcScrollBase = function (
    newWrapperBoundingRectY
  ) {
    var _this = this;
  ...
  DimensionsHelper.prototype.getMobilePreviewFrameDimensions = function () {
    ...
    return { mobilePreviewFrame: mobilePreviewFrame };
  };
  DimensionsHelper.prototype.getPreviewMobileEmulatorBoundingClientRect =
    function () {
      try {
