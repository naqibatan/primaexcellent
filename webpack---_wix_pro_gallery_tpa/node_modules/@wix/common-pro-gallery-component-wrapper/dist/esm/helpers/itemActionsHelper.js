...
var ItemActionsHelper = /** @class */ (function () {
  function ItemActionsHelper(
    ...
    this.getAndInitItemActionsIfNeeded =
      this.getAndInitItemActionsIfNeeded.bind(this);
    ...
    this.reportMigratedLoveDataBiEvent =
      this.reportMigratedLoveDataBiEvent.bind(this);
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.useItemActions("initWidgetData", {
                ...
                shouldUseGalleryIdForShareUrl:
                  this.shouldUseGalleryIdForShareUrl,
              }),
            ];
          case 1:
            _a = _b.sent();
  ...
  ItemActionsHelper.prototype.newItemLoveDataArrived = function (
    itemsLoveData
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.useItemActions("setItemsLoveData", {
  ...
  ItemActionsHelper.prototype.getItemActions = function () {
    ...
    if (!!this.itemActions && typeof this.itemActions === "object") {
      ...
      return new Promise(function (resolve) {
        // todo: fix
        import(
          /* webpackChunkName: "ItemActions" */ "@wix/photography-client-lib/dist/esm/item/itemActions"
  ...
  ItemActionsHelper.prototype.readFromItemActions = function (
    itemActions,
    method,
    args
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (
              !(!this.initWasRequested && !this.itemActions && !utils.isSSR())
            )
              return [3 /*break*/, 3];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              this.readFromItemActions(itemActions, method, args),
            ];
        }
      });
    });
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          ...
          case 1:
            ...
            (_a = Object.entries(photoId2Love)[index]),
              (id = _a[0]),
              (loveCount = _a[1]);
            _b = itemsLoveData;
            _c = id;
          ...
          case 2:
            _b[_c] = ((_d.isLoved = _e.sent()), _d);
            _e.label = 3;
          case 3:
            index++;
            return [3 /*break*/, 1];
          case 4:
            this.galleryWrapper.setState({ itemsLoveData: itemsLoveData });
            return [2 /*return*/];
        }
      });
    });
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 1:
                  ...
                  return [
                    4 /*yield*/,
                    this.galleryWrapper.itemActionsHelper.useItemActions(
                      "isLoved",
                      eventData.id
                    ),
                  ];
  ...
  ItemActionsHelper.prototype.onItemFocused = function (eventData) {
    if (
      !this.galleryWrapper.state.accessibilityTooltipShowedOnce &&
  ...
  ItemActionsHelper.prototype.onItemLostFocus = function () {
    if (this.galleryWrapper.state.showAccessibilityTooltip) {
      this.galleryWrapper.setState({ showAccessibilityTooltip: false });
    }
  };
  ItemActionsHelper.prototype.onItemActionTriggered = function (
    itemProps,
    options
  ) {
  ...
  ItemActionsHelper.prototype.onLinkNavigation = function (item) {
    ...
    if (shouldUseDirectLink) {
      ...
      var linkData =
        ((_b =
          (_a = item === null || item === void 0 ? void 0 : item.dto) ===
            null || _a === void 0
            ? void 0
            : _a.metaData) === null || _b === void 0
          ? void 0
          : _b.link) || item.linkData;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 7:
            return [
              4 /*yield*/,
              this.useItemActions("toggleLove", actionData.id),
            ];
          case 8:
            _b.sent();
            return [3 /*break*/, 10];
  ...
  ItemActionsHelper.prototype.reportMigratedLoveDataBiEvent = function (
    eventData
  ) {
