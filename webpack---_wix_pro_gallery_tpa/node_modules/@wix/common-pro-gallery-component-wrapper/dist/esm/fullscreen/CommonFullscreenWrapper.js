...
var CommonFullscreenWrapper = /** @class */ (function (_super) {
  ...
  function CommonFullscreenWrapper(props) {
    ...
    _this.onFullscreenChange = function () {
      var container = {
        width: Utils.isMobilePreview(
          _this.props.viewMode,
          _this.props.deviceType
        )
  ...
  CommonFullscreenWrapper.prototype.shouldUseReactPortal = function () {
    return (
      this.props.viewMode !== GALLERY_v4_CONSTS.viewMode.SEO && !utils.isSSR()
    );
  };
  ...
  CommonFullscreenWrapper.prototype.loadFullscreenModuleIfNeeded = function () {
    ...
    import(
      ...
      _this.setState({ proFullscreenLoaded: true });
    });
  };
  ...
  CommonFullscreenWrapper.prototype.getRenderElement = function () {
    ...
    if (ProFullscreenElement) {
      return React.createElement(
        ...
        __assign({}, this.additionalProFullscreenProps(), {
          id: props.id,
          items: props.items,
      ...
      return React.createElement(ProGalleryFullscreenMock, {
        items:
          props.viewMode === GALLERY_v4_CONSTS.viewMode.SEO
            ? props.items
      ...
      props.viewMode === GALLERY_v4_CONSTS.viewMode.SITE &&
      !utils.isSSR() &&
      !this.isStoreGallery()
  ...
  CommonFullscreenWrapper.prototype.addMobilePreviewStylesIfNeeded =
    function () {
  ...
  CommonFullscreenWrapper.prototype.render = function () {
    ...
    var fullscreen = React.createElement(
      "div",
      {
        className: "fullscreen-comp-wrapper ".concat(
          this.isStoreGallery() ? this.props.id : ""
        ),
      },
      React.createElement(
        "div",
        {
          ...
          style: __assign(
            __assign({}, this.getStyleForWrapper()),
