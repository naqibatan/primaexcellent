  ...
  function RenderStatusIndicator() {
    ...
    _this.getItemsData = function () {
      return React.createElement(
        ...
        React.createElement("td", null, " ", _this.props.items.length)
      );
    };
    _this.getNumberOfRenders = function () {
      return React.createElement(
        ...
        React.createElement("td", null, " ", _this.props.renderCount)
      );
    };
    ...
    _this.getWorkerLog = function () {
      var _a;
      var log =
        ((_a = _this.props.workerLog) === null || _a === void 0
          ? void 0
          : _a.log) ||
                      ...
                      return React.createElement(
                        ...
                        React.createElement(
                          "div",
                          {
                            ...
                            style: {
                              backgroundColor: _this.generateRandomColor2(
                                _this.getTimingFromEntry(entry),
                                _this.getTimingFromEntry(log[log.length - 1])
                              ),
                            },
                          },
                          entry
