...
import { PG_TEST_TYPE } from "../constants/constants";
var ProGalleryTestIdentifier = /** @class */ (function (_super) {
  ...
  ProGalleryTestIdentifier.prototype.createTestDescriptionElement =
    function () {
      var testColor = "blue";
      ...
      return React.createElement(
        "div",
        {
          ...
          style: {
            ...
            boxShadow: "inset -15px 0 0 "
              .concat(testColor, ", inset 0 -15px 0 ")
              .concat(testColor, ", inset 15px 0 0 ")
              .concat(testColor, ", inset 0 15px 0 ")
              .concat(testColor),
            height: "100%",
            width: "100%",
