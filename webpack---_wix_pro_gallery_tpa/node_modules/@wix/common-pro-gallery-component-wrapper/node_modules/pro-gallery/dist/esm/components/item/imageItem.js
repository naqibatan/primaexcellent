...
var ImageItem = /** @class */ (function (_super) {
  ...
  ImageItem.prototype.getImageContainer = function (
    imageRenderer,
    classNames,
    extraNodes
  ) {
  ...
  ImageItem.prototype.getImageElement = function () {
    ...
    var image = function () {
      ...
      var blockDownloadStyles =
        utils.isMobile() && !_this.props.options.allowContextMenu
          ? {
      ...
      if (!isHighResImageLoaded && !isTransparent) {
        ...
        var preloadProps = __assign(
          {
            className:
              "gallery-item-visible gallery-item gallery-item-preloaded",
              ...
              __assign(
                {
                  ...
                  style: __assign(
                    __assign(__assign({}, imageSizing), preloadStyles),
                    blockDownloadStyles
                  ),
                },
                preloadProps,
                {
                  customImageRenderer:
                    (_a = _this.props.customComponents) === null ||
                    _a === void 0
                      ? void 0
                      : _a.customImageRenderer,
                }
              )
            );
            break;
          case GALLERY_CONSTS.loadingMode.MAIN_COLOR:
            preload = React.createElement(
              ...
              __assign(
                ...
                {
                  customImageRenderer:
                    (_b = _this.props.customComponents) === null ||
                    _b === void 0
                      ? void 0
                      : _b.customImageRenderer,
                }
              )
            );
            break;
      ...
      var imageType =
        ((_c = options.stylingParams) === null || _c === void 0
          ? void 0
          : _c.itemResolutionMode) === GALLERY_CONSTS.itemResolutionMode.FULL
          ? GALLERY_CONSTS.urlSizes.FULL
          : GALLERY_CONSTS.urlSizes.MULTI;
      var src = createUrl(imageType, GALLERY_CONSTS.urlTypes.HIGH_RES);
      var highres = React.createElement(
        ImageRenderer,
        __assign(
          {
            ...
            style: __assign(
              __assign(__assign({}, imageSizing), blockDownloadStyles),
          ...
          {
            customImageRenderer:
              (_d = _this.props.customComponents) === null || _d === void 0
                ? void 0
                : _d.customImageRenderer,
          }
        )
      );
  ...
  ImageItem.prototype.render = function () {
    ...
    var renderedItem = this.getImageContainer(
      imageRenderer,
