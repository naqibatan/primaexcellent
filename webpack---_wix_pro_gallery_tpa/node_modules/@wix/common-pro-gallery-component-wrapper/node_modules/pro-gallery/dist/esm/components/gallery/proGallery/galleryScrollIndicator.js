...
var ScrollIndicator = /** @class */ (function (_super) {
  ...
  ScrollIndicator.prototype.UNSAFE_componentWillReceiveProps = function (
    nextProps
  ) {
    var didChange = false;
    for (
      var _i = 0,
        _a = ["id", "scrollDirection", "isRTL", "totalWidth", "scrollBase"];
      _i < _a.length;
      _i++
    ) {
      var prop = _a[_i];
