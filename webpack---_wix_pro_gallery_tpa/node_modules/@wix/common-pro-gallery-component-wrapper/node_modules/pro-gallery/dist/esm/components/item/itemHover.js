...
var ItemHover = /** @class */ (function (_super) {
  ...
  ItemHover.prototype.calcHeightAndWidth = function (_a) {
    ...
    var overlaySizeCalc = this.calcOverlaySize(
    ...
    return (
      ...
      (_b[calculatedOppositeField] =
        imageDimensions[calculatedOppositeField] - 2 * overlayPadding),
      _b
    );
  };
  ItemHover.prototype.calcOverlaySize = function (
    widthOrHeight,
    requiredOverlaySize,
    overlaySizeType,
    overlayPadding
  ...
  ItemHover.prototype.render = function () {
    ...
    return React.createElement(
      "div",
      { className: "item-hover-flex-container", style: overlayPositionCalc },
      React.createElement(
        "div",
        {
          key: "item-hover-" + idx,
