    ...
    return (
      ...
      this.pgScrollSteps
        .map(function (step, idx) {
          return _this.buildScrollClassName(
            id,
            idx,
  ...
  CssScrollHelper.prototype.createScrollSelectorsFunction = function (_a) {
    ...
    return function (padding, suffix) {
      ...
      while (from < to) {
        ...
        scrollClasses.push(
          "." +
            _this.buildScrollClassName(id, largestDividerIdx, from) +
            " ~ div #" +
            sellectorDomId +
            " " +
            suffix
  ...
  CssScrollHelper.prototype.createScrollAnimationsIfNeeded = function (_a) {
    ...
    if (
      ...
      scrollAnimationCss +=
        ...
        ("{filter: opacity(1); transition: filter 1." +
          _randomDuration +
          "s ease-in " +
          _randomDelay +
          "ms !important;}");
    ...
    if (scrollAnimation === GALLERY_CONSTS.scrollAnimations.FADE_IN) {
      scrollAnimationCss +=
        ...
        ("{filter: opacity(0); transition: filter 1." +
          _randomDuration +
          "s ease-in !important;}");
      scrollAnimationCss +=
    ...
    if (scrollAnimation === GALLERY_CONSTS.scrollAnimations.SLIDE_UP) {
      ...
      scrollAnimationCss +=
        ...
        ("{transform: translate" +
          ...
          "(" +
          direction +
          "100px); transition: transform 0.8s cubic-bezier(.13,.78,.53,.92) !important;}");
      scrollAnimationCss +=
        createScrollSelectors(animationActivePadding, "") +
    ...
    if (scrollAnimation === GALLERY_CONSTS.scrollAnimations.EXPAND) {
      scrollAnimationCss +=
        createScrollSelectors(animationPreparationPadding, "") +
        ("{transform: scale(0.95); transition: transform 1s cubic-bezier(.13,.78,.53,.92) " +
          _randomDelay +
          "ms !important;}");
      scrollAnimationCss +=
        createScrollSelectors(animationActivePadding, "") +
    ...
    if (scrollAnimation === GALLERY_CONSTS.scrollAnimations.SHRINK) {
      scrollAnimationCss +=
        createScrollSelectors(animationPreparationPadding, "") +
        ("{transform: scale(1.05); transition: transform 1s cubic-bezier(.13,.78,.53,.92) " +
          _randomDelay +
          "ms !important;}");
      scrollAnimationCss +=
        createScrollSelectors(animationActivePadding, "") +
    ...
    if (scrollAnimation === GALLERY_CONSTS.scrollAnimations.ZOOM_OUT) {
      scrollAnimationCss +=
        ...
        ("{transform: scale(1.1); transition: transform 1.2s cubic-bezier(.13,.78,.53,.92) " +
          _randomDelay +
          "ms !important;}");
      scrollAnimationCss +=
        createScrollSelectors(
