...
var GalleryContainer = /** @class */ (function (_super) {
  ...
  function GalleryContainer(props) {
    ...
    _this.setGotFirstScrollIfNeeded =
      _this.setGotFirstScrollIfNeeded.bind(_this);
    ...
    _this.videoScrollHelper = new VideoScrollHelperWrapper(
      _this.setPlayingIdxState
    );
    var initialState = {
      scrollPosition: {
        top: 0,
  ...
  GalleryContainer.prototype.isScrollingUnavailable = function (
    height,
    viewportHeight
  ) {
  ...
  GalleryContainer.prototype.getMoreItemsIfScrollIsDisabled = function (
    height,
    viewportHeight
  ) {
  ...
  GalleryContainer.prototype.UNSAFE_componentWillReceiveProps = function (
    nextProps
  ) {
    var _this = this;
  ...
  GalleryContainer.prototype.handleNewGalleryStructure = function () {
    ...
    var needToUpdateHeightNotInfinite =
    ...
    var isFixedHorizontlaGalleryRatio =
  ...
  GalleryContainer.prototype.scrollToItem = function (
    itemIdx,
    fixedScroll,
    isManual,
    durationInMS,
  ...
  GalleryContainer.prototype.scrollToGroup = function (
    groupIdx,
    fixedScroll,
    isManual,
    durationInMS,
  ...
  GalleryContainer.prototype.componentDidUpdate = function (
    prevProps,
    prevState
  ) {
  ...
  GalleryContainer.prototype.createDynamicStyles = function (
    _a,
    isPrerenderMode
  ) {
  ...
  GalleryContainer.prototype.createCssLayoutsIfNeeded = function (
    layoutParams
  ) {
  ...
  GalleryContainer.prototype.simulateHorizontalScrollToItem = function (item) {
    (item === null || item === void 0 ? void 0 : item.offset) &&
      this.onGalleryScroll({ left: item.offset.left });
  };
  GalleryContainer.prototype.eventsListener = function (
    eventName,
    eventData,
    event
  ) {
    ...
    if (eventName === GALLERY_CONSTS.events.GALLERY_SCROLLED) {
      ...
      var newScrollPosition = __assign(
        __assign({}, this.state.scrollPosition),
        eventData
      );
  ...
  GalleryContainer.prototype.getMoreItemsIfNeeded = function (scrollPos) {
    ...
    var _a;
    if (
      (_a = this.deferredGettingMoreItems) === null || _a === void 0
        ? void 0
        : _a.isPending
    ) {
  ...
  GalleryContainer.prototype.onMouseEnter = function () {
    var _a;
    if (
      ((_a = this.currentScrollData) === null || _a === void 0
        ? void 0
        : _a.isContinuousScrolling) &&
    ...
    return React.createElement(
            ...
            scrollTop:
              (_b =
                (_a = this.state) === null || _a === void 0
                  ? void 0
                  : _a.scrollPosition) === null || _b === void 0
                ? void 0
                : _b.top,
      ...
      React.createElement(
        ...
        !!this.dynamicStyles &&
          React.createElement("style", {
            dangerouslySetInnerHTML: { __html: this.dynamicStyles },
          })
      ),
      this.props.proGalleryRole === "application" &&
        React.createElement(
          ...
          (_c = this.props.translations) === null || _c === void 0
            ? void 0
            : _c.Accessibility_Left_Gallery
        )
    );
  };
