...
var GalleryView = /** @class */ (function (_super) {
  ...
  GalleryView.prototype.createGallery = function (showMore) {
    ...
    var debugMsg = React.createElement(
      GalleryDebugMessage,
    ...
    var itemsWithVirtualizationData =
      getItemsInViewportOrMarginByScrollLocation({
        ...
        galleryHeight: Math.min(
          ...
          ((_a = container.screen) === null || _a === void 0
            ? void 0
            : _a.height) || galleryStructure.height
        ),
    ...
    var layout = itemsWithVirtualizationData.map(function (_a, index) {
      ...
      var itemProps = item.renderProps(
        __assign(__assign({}, galleryConfig), {
