...
var VideoScrollHelperWrapper = /** @class */ (function () {
  ...
  VideoScrollHelperWrapper.prototype.initVideoScrollHelperIfNeeded = function (
    ...
    if (
      ...
      import(
        ...
        .then(function (VideoScrollHelper) {
          Object.assign(
            _this,
            new VideoScrollHelper.default(videoScrollHelperConfig_1)
          );
  ...
  VideoScrollHelperWrapper.prototype.updateGalleryStructure = function (
