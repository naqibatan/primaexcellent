...
var VideoPlayButton = function (_a) {
  ...
  return React.createElement(
    "div",
    { style: { pointerEvents: pointerEvents ? "initial" : "none" } },
    React.createElement(
      "i",
      {
        key: "play-triangle",
...
var VideoItemWrapper = /** @class */ (function (_super) {
  ...
  VideoItemWrapper.prototype.createVideoPlaceholder = function (
    showVideoPlayButton
  ) {
    ...
    return React.createElement(
      ...
      __assign({}, props, {
        ...
        videoPlayButton:
          showVideoPlayButton &&
          !this.mightPlayVideo() &&
          React.createElement(VideoPlayButton, {
  ...
  VideoItemWrapper.prototype.render = function () {
    ...
    var shouldUseTransparentPlayButtonAndForceLoadVideo =
