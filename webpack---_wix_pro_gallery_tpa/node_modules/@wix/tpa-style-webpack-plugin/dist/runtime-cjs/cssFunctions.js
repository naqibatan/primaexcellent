...
exports.cssFunctions = {
  join: function (color1, strength1, color2, strength2) {
    ...
    return new tinycolor_1.TinyColor({ r: r, g: g, b: b, a: a }).toRgbString();
  },
  ...
  font: function (font, tpaParams) {
    var fontValue = wixStyleFontUtils_1.wixStylesFontUtils.parseFontFromObject(
      font,
      tpaParams
    );
    if (fontValue) {
      var fontCssValue =
        wixStyleFontUtils_1.wixStylesFontUtils.toFontCssValue(fontValue);
  ...
  fontWithSize: function (font, size, tpaParams) {
    var fontValueFromObject =
      wixStyleFontUtils_1.wixStylesFontUtils.parseFontFromObject(
        font,
        tpaParams
      );
    var fontValue = fontValueFromObject
      ...
      ? __assign(
          __assign(
            {},
            wixStyleFontUtils_1.wixStylesFontUtils.parseFontFromString(
  ...
  darken: function (colorVal, darkenValue) {
    return new tinycolor_1.TinyColor(colorVal)
      .brighten(-1 * darkenValue * 100)
      .toRgbString();
  },
  lighten: function (colorVal, lightenVal) {
    return new tinycolor_1.TinyColor(colorVal)
      .lighten(lightenVal * 100)
      .toRgbString();
  },
  ...
  direction: function (value, tpaParams) {
    var direction = tpaParams.booleans[constants_1.IS_RTL_PARAM]
      ? "rtl"
      : "ltr";
  ...
  readableFallback: function (baseColor, suggestedColor, fallbackColor) {
    ...
    return (0, tinycolor_1.isReadable)(baseColorTC, suggestedColorTC)
      ? suggestedColor
      : fallbackColor;
  },
  /**
