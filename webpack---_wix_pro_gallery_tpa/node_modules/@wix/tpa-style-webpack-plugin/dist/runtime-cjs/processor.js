...
function getProcessor(_a) {
  ...
  function executeFunction(value) {
    ...
    if (functionSignature) {
      return (_a = plugins.cssFunctions)[functionSignature.funcName].apply(
        _a,
        functionSignature.args.map(function (arg) {
  ...
  function getDefaultValueOrValueFromSettings(varName, defaultVarValue) {
    return function (tpaParams) {
      ...
      if (
        tpaParams.strings[varNameInSettings] &&
        tpaParams.strings[varNameInSettings].value
      ) {
