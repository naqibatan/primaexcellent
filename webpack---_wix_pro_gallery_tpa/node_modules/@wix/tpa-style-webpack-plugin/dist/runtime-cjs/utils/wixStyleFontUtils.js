...
exports.wixStylesFontUtils = {
  getFullFontStyles: function (_a) {
    ...
    var ret = {};
    var parsedFontStyles = (0, utils_1.reduceObj)(
      fontStyles,
      function (acc, _a) {
        var key = _a.key,
          value = _a.value;
    ...
    var parsedSiteTextPresets = (0, utils_1.reduceObj)(
      siteTextPresets,
      function (acc, _a) {
        var key = _a.key,
          preset = _a.value;
        ...
        acc[key] = __assign(
          __assign(__assign({}, parsedCssFont), {
            preset: key,
    ...
    (0, utils_1.forEach)(ret, function (font, key) {
      ret[key] = __assign(__assign({}, font), {
        supports: { uppercase: true },
      });
      if (
        ["snellroundhandw", "niconne"].some(function (fontName) {
  ...
  toFontCssValue: function (value) {
    var size = (0, utils_1.isNumber)(value.size)
      ? value.size + "px"
      : value.size;
    var lineHeight = (0, utils_1.isNumber)(value.lineHeight)
      ? value.lineHeight + "px"
      : value.lineHeight;
...
function parseWixStylesFont(font) {
  var parsedValue;
  try {
    parsedValue = (0, parse_css_font_1.default)(
      cleanWixFontValue(font.value || "")
    );
  } catch (e) {
    parsedValue = {
      family: [],
  ...
  if (
    parsedValue.family &&
    parsedValue.family.length >= fontObj.family.length
  ) {
