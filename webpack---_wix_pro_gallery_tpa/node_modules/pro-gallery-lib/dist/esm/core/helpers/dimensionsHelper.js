...
var DimensionsHelper = /** @class */ (function () {
  ...
  DimensionsHelper.prototype.getGalleryWidth = function () {
    ...
    return this.getOrPutInCache("galleryWidth", function () {
      var width =
        Math.floor(_this.container.width) + _this.getDimensionFix() * 2; //add margins to width and then remove them in css negative margins
      if (
        _this.options.arrowsPosition ===
  ...
  DimensionsHelper.prototype.getGalleryHeight = function () {
    ...
    return this.getOrPutInCache("galleryHeight", function () {
      ...
      var res = Math.floor(
        (_this.container.height > 0 ? _this.container.height : 0) +
          dimensionFix()
      );
      return res;
    });
  ...
  DimensionsHelper.prototype.getDimensionFix = function () {
    ...
    return this.getOrPutInCache("dimensionFix", function () {
      return (
        Number(_this.options.imageMargin / 2) -
  ...
  DimensionsHelper.prototype.fixHeightForHorizontalGalleryIfNeeded =
    function () {
      if (
