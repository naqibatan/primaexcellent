...
function addOldOptions(flatOptions) {
  ...
  var flat_combinedOptions = __assign(
    __assign({}, trimUndefinedValues_flat(flat_migrated)),
...
function reverseMigrateOptions(flatOptionsObject) {
  ...
  oldOptions = changeNames(
    oldOptions,
    __spreadArrays(nameChangedLayoutParams).map(function (ele) {
      return __spreadArrays(ele).reverse();
    })
  );
  oldOptions = reverseBooleans(
    oldOptions,
    __spreadArrays(reversedLayoutParams).map(function (ele) {
      return __spreadArrays(ele).reverse();
    })
  );
  ...
  oldOptions = changeNames(
    oldOptions,
    __spreadArrays(nameChangedBehaviourParams).map(function (ele) {
      return __spreadArrays(ele).reverse();
    })
  );
  oldOptions = reverseBooleans(
    oldOptions,
    __spreadArrays(reversedBehaviourParams).map(function (ele) {
      return __spreadArrays(ele).reverse();
    })
  );
  ...
  oldOptions = changeNames(
    oldOptions,
    __spreadArrays(nameChangedStylingParams).map(function (ele) {
      return __spreadArrays(ele).reverse();
    })
  );
  return oldOptions;
...
function process_new_to_old_ThumbnailAlignment(obj) {
  ...
  _obj["galleryThumbnailsAlignment"] =
    (_a = _obj["galleryThumbnailsAlignment"]) === null || _a === void 0
      ? void 0
      : _a.toLowerCase();
  return _obj;
}
  ...
  var isSlideshow = isLayout("SLIDESHOW")({
    galleryLayout:
      obj.galleryLayout >= -3
        ? obj.galleryLayout
        : (_b =
            (_a = obj.layoutParams) === null || _a === void 0
              ? void 0
...
function process_new_to_old_cropMethod(obj) {
  ...
  _obj["cubeType"] =
    (_a = _obj["cubeType"]) === null || _a === void 0
      ? void 0
      : _a.toLowerCase();
  return _obj;
}
...
function process_new_to_old_galleryTextAlign(obj) {
  ...
  _obj["galleryTextAlign"] =
    (_a = _obj["galleryTextAlign"]) === null || _a === void 0
      ? void 0
      : _a.toLowerCase();
  return _obj;
}
function process_new_to_old_LoadMoreAmount(obj) {
  ...
  _obj["loadMoreAmount"] =
    (_a = _obj["loadMoreAmount"]) === null || _a === void 0
      ? void 0
      : _a.toLowerCase();
  return _obj;
}
...
function process_new_to_old_ClickAction(obj) {
  ...
  _obj["itemClick"] =
    (_a = _obj["itemClick"]) === null || _a === void 0
      ? void 0
      : _a.toLowerCase();
...
function process_new_to_old_CropRatio(obj) {
  ...
  var val =
    ...
    __spreadArrays(_obj[optionsMap.layoutParams.crop.ratios]);
  var newVal = val || [];
  if (newVal.length > 1) {
