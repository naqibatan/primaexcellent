...
var Utils = /** @class */ (function () {
    ...
    var _isTouch = function () {
      ...
      var isTouchBrowser =
        ((_a = window.navigator) === null || _a === void 0
          ? void 0
          : _a.maxTouchPoints) > 0 || // checking if navigator exists because of SSR
        "ontouchstart" in window.document.documentElement;
      return _this.isUndefined(isTouchByProps)
        ? isTouchBrowser
        : isTouchByProps;
    };
  ...
  Utils.prototype.isSSR = function () {
    return (
      typeof (global === null || global === void 0 ? void 0 : global.window) ===
      "undefined"
    );
  };
