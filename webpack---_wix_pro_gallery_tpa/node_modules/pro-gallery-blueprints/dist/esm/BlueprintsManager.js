...
var BlueprintsManager = /** @class */ (function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            (_b = _c.sent()),
              (blueprintManagerId = _b.blueprintManagerId),
              (blueprint = _b.blueprint),
              (changedParams = _b.changedParams),
              (reasons = _b.reasons);
            if (blueprintManagerId !== this.lastBlueprintId)
              return [2 /*return*/];
            blueprintChanged = Object.values(changedParams).some(function (
              changedParam
            ) {
              return !!changedParam;
            });
            blueprintCreated = Object.keys(blueprint).length > 0;
            this.updateLastParamsIfNeeded(
              params,
              changedParams,
              blueprintCreated
            );
            ...
            ]; // still returning for awaits... event is !blueprintCreated
        }
      });
    });
  };
  ...
  BlueprintsManager.prototype.createInitialBlueprint = function (params) {
    ...
    var _a = blueprints.createBlueprint({
      ...
      reasons = _a.reasons;
    var blueprintChanged = Object.values(changedParams).some(function (
      changedParam
    ) {
      return !!changedParam;
    });
  ...
  BlueprintsManager.prototype.duplicateItemsForSlideshowLoopIfNeeded =
    function (params) {
      ...
      var numOfItemsCondition =
        items.length < loopThreshold && items.length === totalItemsCount;
      // If the gallery is a horizontal scrolling gallery
      var isHorizontalScrolling =
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            return [
              2 /*return*/,
              { container: container, items: items, options: options, id: id },
            ];
        }
      });
    });
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            container = _a || this.currentState.container;
            _b.label = 3;
          case 3:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            _a = !this.loopingItems && this.api.fetchItems;
            if (!_a) return [3 /*break*/, 2];
          ...
          case 2:
            ...
            items = _a || this.currentState.items;
            _b.label = 3;
          case 3:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            options = _a || this.currentState.options;
            _b.label = 3;
          case 3:
  ...
  BlueprintsManager.prototype.updateLastParamsIfNeeded = function (
    _a,
    changedParams,
    blueprintCreated
  ) {
