...
var Blueprints = /** @class */ (function () {
  ...
  Blueprints.prototype.createBlueprint = function (_a) {
    ...
    try {
      ...
      var _c = this.formatOptionsIfNeeded(
          newOptions,
          oldOptions,
      ...
      var _d = this.formatContainerIfNeeded(
          newContainerParams,
          oldContainerParams,
          oldOptions,
  ...
  Blueprints.prototype.formatItemsIfNeeded = function (items, lastItems) {
    ...
    if (itemsWereAdded(items, oldItemsParams)) {
      formattedItems = oldItemsParams.concat(
        items.slice(oldItemsParams.length).map(function (item) {
  ...
  Blueprints.prototype.formatOptionsIfNeeded = function (
    options,
    lastOptions,
    isUsingCustomInfoElements
  ) {
    ...
    var optionsHaveChanged = function (newOptions, oldOptions) {
      ...
      try {
        ...
        var wasChanged =
          JSON.stringify(newOptionsSorted_1) !==
          JSON.stringify(oldOptionsSorted_1);
        if (wasChanged) {
    ...
    if (optionsHaveChanged(options, oldOptions)) {
      var mergedOldAndNewStyles =
        extendNestedOptionsToIncludeOldAndNew(options); //add both old and new options
      var fullOptionsOverDefualts = populateWithDefaultOptions(
  ...
  Blueprints.prototype.formatContainerIfNeeded = function (
    container,
    lastContainer,
    lastOptions,
    formattedOptions,
