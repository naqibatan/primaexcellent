...
var Atom = /*#__PURE__*/ (function () {
  ...
  function Atom(name_) {
    if (name_ === void 0) {
      name_ =
        process.env.NODE_ENV !== "production" ? "Atom@" + getNextId() : "Atom";
    }
    this.name_ = void 0;
...
function _startAction(
  ...
  var notifySpy_ =
    process.env.NODE_ENV !== "production" && isSpyEnabled() && !!actionName;
  var startTime_ = 0;
...
var ComputedValue = /*#__PURE__*/ (function () {
  ...
  _proto.trackAndCompute = function trackAndCompute() {
    ...
    var oldValue = this.value_;
    var wasSuspended =
      /* see #1208 */ this.dependenciesState_ ===
      IDerivationState_.NOT_TRACKING_;
...
function autorun(view, opts) {
  ...
  return reaction.getDisposer_(
    (_opts3 = opts) == null ? void 0 : _opts3.signal
  );
}
...
function whenPromise(predicate, opts) {
  ...
  if (
    opts != null &&
    (_opts$signal = opts.signal) != null &&
    _opts$signal.aborted
  ) {
...
var objectProxyTraps = {
  ...
  set: function set(target, name, value) {
    ...
    if (
      process.env.NODE_ENV !== "production" &&
      !getAdm(target).values_.has(name)
    ) {
      warnAboutProxyRequirement(
...
function hasInterceptors(interceptable) {
  return (
    interceptable.interceptors_ !== undefined &&
...
function hasListeners(listenable) {
  return (
    listenable.changeListeners_ !== undefined &&
...
var ObservableObjectAdministration = /*#__PURE__*/ (function () {
  function ObservableObjectAdministration(
    ...
    this.keysAtom_ = new Atom(
      process.env.NODE_ENV !== "production"
        ? this.name_ + ".keys"
        : "ObservableObject.keys"
    );
    // Optimization: we use this frequently
    this.isPlainObject_ = isPlainObject(this.target_);
    if (
      process.env.NODE_ENV !== "production" &&
      !isAnnotation(this.defaultAnnotation_)
    ) {
