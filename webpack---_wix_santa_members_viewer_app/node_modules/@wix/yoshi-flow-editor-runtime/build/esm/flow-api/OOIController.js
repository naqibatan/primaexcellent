  ...
  function OOIControllerFlowAPI(_a) {
    ...
    _this.appLoadStarted = function () {
      ...
      _this.fedops.appLoadStarted = function () {
        ...
        originalAppLoadStarted.call.apply(
          originalAppLoadStarted,
          __spreadArray([_this.fedops], args, false)
        );
      };
    };
    ...
    _this.panoramaClient =
      panoramaClient === null || panoramaClient === void 0
        ? void 0
        : panoramaClient.createClientForComponent();
    ...
    _this.formatCurrency =
      (_b = _this.getCurrencyFormatter) === null || _b === void 0
        ? void 0
        : _b.call(_this);
    ...
    if (!viewerScriptFlowAPI.bi && biLogger) {
      if (shouldUseEssentials) {
        ...
        (_c = controllerConfig.platformAPIs) === null || _c === void 0
          ? void 0
          : _c.biLoggerFactory
      ) {
        _this.bi = biLogger(
          (_d = controllerConfig.platformAPIs) === null || _d === void 0
            ? void 0
            : _d.biLoggerFactory()
        )({});
      }
    ...
    if (
      ...
      _this.sentry =
        (_e =
          prepopulatedData === null || prepopulatedData === void 0
            ? void 0
            : prepopulatedData.sentryMonitor) !== null && _e !== void 0
          ? _e
          : null;
      _this.errorMonitor =
        (_f =
          prepopulatedData === null || prepopulatedData === void 0
            ? void 0
            : prepopulatedData.errorMonitor) !== null && _f !== void 0
          ? _f
          : null;
      ...
      if (sentryConfig.errorMonitor && _this.essentials.createErrorMonitor) {
        ...
        _this.sentry =
          (_g = platformAPIs.monitoring) === null || _g === void 0
            ? void 0
            : _g.createMonitor(sentryOptions_1.dsn, function (config) {
    ...
    _this.fedops = null;
    if (
      (fedopsConfig === null || fedopsConfig === void 0
        ? void 0
        : fedopsConfig.enabled) !== false
    ) {
      if (
        prepopulatedData === null || prepopulatedData === void 0
          ? void 0
      ...
      var shouldLogCSR =
        ...
        ((_h = _this.controllerConfig.platformAPIs.bi) === null || _h === void 0
          ? void 0
          : _h.pageNumber) === 1;
    ...
    _this.settings = {
      get: function (param) {
        ...
        return getSettingsValue(
          (_b =
            (_a = _this.controllerConfig.config) === null || _a === void 0
              ? void 0
              : _a.publicData) !== null && _b !== void 0
            ? _b
            : {},
          param,
          {
            t:
              (_c = _this.translations) === null || _c === void 0
                ? void 0
                : _c.t,
              ...
              this.translations.init({
                prepopulated:
                  (_b = this.prepopulatedData) === null || _b === void 0
                    ...
                    : _b.translations,
                useSuspense:
                  this.environment.isEditor || this.environment.isADI,
              }),
            ];
          case 1:
            _c.sent();
