...
export var createControllersWithDescriptors = function (
  ...
  return function (controllerConfigs, controllerModulesMap) {
    ...
    controllerConfigs.forEach(function (controllerConfig) {
      ...
      if (
        (controllerDescriptor === null || controllerDescriptor === void 0
          ? void 0
          : controllerDescriptor.widgetType) !== BLOCKS_COMPONENT_TYPE
      ) {
        ...
        if (shouldUseExternalController) {
          ...
          if (!controllerDescriptor) {
            var descriptor =
              getDescriptorFromControllerModule(controllerModule);
            if (!descriptor) {
              throw new Error(
      ...
      if (!controllerDescriptor) {
        if (process.env.NODE_ENV === "development") {
          console.info(
            "Yoshi Editor Flow doesn't support initializing controllers from non-editor flow artifacts. Please, consider moving \"".concat(
              widgetId,
    ...
    var wrappedControllers = controllersWithDescriptors.map(function (_a) {
      ...
      return controllerDescriptor.wrap(
        optionalDeps,
        controllerDescriptor,
        controllerConfig,
        getViewerScriptFlowAPI(),
