...
export var getPanelUrl = function (componentName, panelName, options) {
  ...
  if (isLocal) {
    return "https://editor.wixapps.net/render/local/panels/"
      .concat(componentName, "/")
      .concat(panelName, "?cdnPort=")
      .concat(
        (_a =
          options === null || options === void 0 ? void 0 : options.cdnPort) !==
          null && _a !== void 0
          ? _a
          : 3200
      );
  ...
  if (process.env.ARTIFACT_VERSION === "0.0.0") {
    return "https://editor.wixapps.net/render/sled/panels/"
      .concat(componentName, "/")
      .concat(panelName, "?cdnBase=")
      .concat(
        encodeURIComponent(
          (_b = getPublicPath()) !== null && _b !== void 0 ? _b : ""
        )
      );
  }
  return "https://editor.wixapps.net/render/prod/panels/"
    .concat(process.env.ARTIFACT_ID, "/")
    .concat(process.env.ARTIFACT_VERSION, "/")
    .concat(componentName, "/")
    .concat(panelName);
};
export var getModalUrl = function (componentName, panelName, instance) {
  ...
  if (isLocal) {
    return "https://editor.wixapps.net/render/local/modals/"
      .concat(urlPostfix, "?cdnPort=")
      .concat(
        (_a = process.env.CDN_PORT) !== null && _a !== void 0 ? _a : 3200,
        "&instance="
      )
      .concat(instance);
  }
  // fix for sled local execution:
  if (process.env.ARTIFACT_VERSION === "0.0.0") {
    return "https://editor.wixapps.net/render/sled/modals/"
      .concat(urlPostfix, "?cdnBase=")
      .concat(
        encodeURIComponent(
          (_b = getPublicPath()) !== null && _b !== void 0 ? _b : ""
        ),
  ...
  return "https://editor.wixapps.net/render/prod/modals/"
    .concat(process.env.ARTIFACT_ID, "/")
    .concat(process.env.ARTIFACT_VERSION, "/")
    .concat(urlPostfix, "?instance=")
    .concat(instance);
};
export var getEditorParams = function () {
  ...
  return {
    editorSDKSrc:
      queryParams.get("sdkVersion") || queryParams.get("wix-sdk-version"),
