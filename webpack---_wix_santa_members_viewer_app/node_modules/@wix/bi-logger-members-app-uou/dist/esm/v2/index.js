...
/**
 * @typedef {Object} memberSharedAProfileInactiveParams
 * @property {GUID} app_id - app_id
 * @property {GUID} instance_id - instance_id
 * @property {boolean} is_social - 0 - no, 1 - yes
 ...
 **/
/**
 * Name: Member shared a profile (inactive). Evid: 807.
 ...
 * @return {Object} LogObject
**/
export var memberSharedAProfileInactive = function (params) {
...
/**
 * @typedef {Object} reportMemberSubmittedParams
 ...
 **/
/**
 * Name: Report member submitted. Evid: 863.
 * Event description: Report member flow: "Submit Report" clicked.

 * details - Type: string. Desc: "Share more details" input
 *
 * instance_id - Type: guid. Desc: instance_id
 *
 * member_chosen - Type: string. Desc: Site member ID of member getting reported
 *
 * biToken - Type: guid.
 *
 * reason - Type: string. Desc: Spam/Impersonation/Harassment or hate Speech/Other
 *
 * siteMemberId - Type: guid. Desc: Site member ID of member reporting
 *
 * visitor_id - Type: guid. Desc: visitor_id
 * @param {reportMemberSubmittedParams} params The parameters for this event.
 * @return {Object} LogObject
**/
export var reportMemberSubmitted = function (params) {
...
/**
 * @typedef {Object} membersAreaMembersListLayoutChangeParams
 * @property {GUID} instance_id - null
 ...
 **/
/**
 * Name: Members area Members list Layout Change. Evid: 867.
 * Event description: layout change in All Members list.

 * instance_id - Type: guid.
 *
 * layoutType - Type: string. Desc: grid (0), list (1)
 *
 * biToken - Type: guid.
 *
 * visitor_id - Type: guid.
 ...
 * @return {Object} LogObject
**/
export var membersAreaMembersListLayoutChange = function (params) {
  return { evid: 867, src: 69, endpoint: "members-app-uou", params: params };
};
/**
 * @typedef {Object} membersAreaNavigationParams
 ...
 **/
/**
 * Name: Members Area Navigation. Evid: 866.
 * Event description: Sent when UoU used any of MA navigation : Login bar/menu, Members Area menu, etc..

 * action - Type: string. Desc: hover/menu_click/item
 *
 * component - Type: string. Desc: login-bar, ma-navigation, etc
 *
 * instance_id - Type: guid. Desc: instance_id
 *
 * biToken - Type: guid. Desc: msid
 *
 * originAppId - Type: guid. Desc: app id of the menu item
 *
 * pageName - Type: string. Desc: Standardized name of the page that links p
 *
 * visitor_id - Type: guid.
 * @param {membersAreaNavigationParams} params The parameters for this event.
 * @return {Object} LogObject
**/
export var membersAreaNavigation = function (params) {
 ...
 **/
/**
 * Name: Members Area Tab loaded. Evid: 818.
 ...
 * biToken - Type: guid.
 *
 * originAppId - Type: guid. Desc: app id of the menu item (verticall
 *
 * pageName - Type: string. Desc: Standardized name of the page that links p
 *
 * visitor_id - Type: guid.
...
/**
 * @typedef {Object} memberUpdatedPersonalDetailsInactiveParams
 * @property {GUID} app_id - app_id
 * @property {GUID} instance_id - instance_id
 * @property {boolean} is_social - 0 - no, 1 - yes
 * @property {string} member_id - member_id
 ...
 **/
/**
 * Name: Member updated personal details (inactive). Evid: 808.
 ...
 * @return {Object} LogObject
**/
export var memberUpdatedPersonalDetailsInactive = function (params) {
