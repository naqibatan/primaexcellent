...
const { reportRunCodeBi } = require("./runCodeBi");
...
const createUserExports = ({ appLogger, userConsole, modules }) => {
...
function runUserCode({
  ...
  try {
    ...
    const userExports = createUserExports({ appLogger, userConsole, modules });
    return userExports;
  } catch (e) {
    appLogger.error(e);
    throw e;
...
const loadUserCodeAndRun = async ({
  ...
  try {
    ...
    return createUserExports({ appLogger, userConsole, modules });
  } catch (e) {
    appLogger.error(e);
    throw e;
  }
