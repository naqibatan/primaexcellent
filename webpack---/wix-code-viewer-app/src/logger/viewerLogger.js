...
const { ravenHandlerCreator } = require("./ravenHandler");
const { biHandlerCreator } = require("./biHandler");
const { systemTracingHandlerCreator } = require("./systemTracingHandler");

const viewerLogger = ({ consoleHandler }) => {
