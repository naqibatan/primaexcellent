...
const { runUserCode, loadUserCodeAndRun } = require("./runUserCode");
...
const { Experiments } = require("./constants/Experiments");
const { createGlobals } = require("./services/userCodeEnv");
const {
  resolveWixCodeAPIs,
...
const create = ({ appLogger, userConsole }) => {
  ...
  const initAppForPage = async (
    ...
    try {
      ...
      const {
        platformApiProvider: { getPlatformApi },
      } = platformUtils;
