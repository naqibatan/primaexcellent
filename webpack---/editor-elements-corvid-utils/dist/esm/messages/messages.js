...
export const missingFieldMessage = ({ functionName, propertyName, index }) => {
...
export const invalidFileTypeForFileLimit = ({ propertyName }) => {
  return templates.error_invalid_type_for_file_limit({
    propertyName,
  });
};
export const unsupportedLinkType = ({ functionName, wrongValue, index }) => {
...
export const invalidTargetWithIndex = ({ functionName, wrongValue, index }) => {
...
export const unsupportedFunctionForType = ({ functionName, type }) => {
...
export const invalidMenuItemMessage = ({ propertyName, value, index }) => {
  return assert.isNumber(index)
...
export const invalidOption = ({ propertyName, wrongValue, index }) =>
  templates.warning_invalid_option({
    propertyName,
    wrongValue,
    index,
  });
export const onlyGetter = ({ propertyName, compType }) =>
...
export const invalidItemLink = ({ functionName, propertyName, index }) =>
  templates.error_item_external_link({
    propertyName,
    functionName,
    index,
  });
export const unsupportedPropertyMessageWithHint = ({ propertyName, hint }) =>
  templates.error_unsupported_property_with_hint({
    propertyName,
    hint,
  });
export const nonExistingItem = ({ functionName, propertyName, value }) =>
