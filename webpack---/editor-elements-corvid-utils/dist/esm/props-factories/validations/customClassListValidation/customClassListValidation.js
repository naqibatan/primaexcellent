...
export const handleMandatoryVals = (propertyNames, functionName) => {
  reportError(
    messageTemplates.error_mandatory_multiple_vals({
      propertyNames,
      functionName,
    })
  );
...
export const handleMandatorySingleVal = (propertyName, functionName) => {
  reportError(
    messageTemplates.error_mandatory_val({
      propertyName,
      functionName,
    })
  );
...
export const handleUnsupportedChars = (propertyName, functionName) => {
  reportError(
    messageTemplates.error_unsupported_chars({
      propertyName,
      functionName,
    })
  );
