...
import { createSchemaValidator } from "../../../validations/createSchemaValidator";
import { reportWarning } from "../../../reporters";
import { effectInfoLink } from "../../animations";
...
export const createEffectOptionsValidation = ({ propertyName, compName }) => {
