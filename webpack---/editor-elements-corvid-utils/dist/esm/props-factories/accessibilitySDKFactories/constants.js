...
(function (ErrorMessages) {
  ...
  ErrorMessages["ARIA_LABEL_EMPTY_STRING"] =
    "aria-label can't be an empty string";
  ErrorMessages["REMOVING_MISSING_ATTRIBUTE"] =
    "Cannot remove a non existing attribute";
})(ErrorMessages || (ErrorMessages = {}));
export const getNotTextSelectorError = (property) =>
  `The parameter that is passed to the ‘${property}’ property must be a selector function of a text element.`;
export const getNotSelectorError = (property) =>
  `The parameter that is passed to the ‘${property}’ property must be a selector function of an element.`;
export const getInvalidScreenReaderValueError = (property) =>
