...
import { withValidation, createCompSchemaValidator } from "../validations";
import { changePropsSDKFactory } from "./changePropsSDKFactory";
const _createValuePropsSDKFactory =
  (valueSanitizer, valueSchema, inputValidator) => (api) => {
...
export const createValuePropsSdkFactory = (
  ...
  composeSDKFactories([
    ...
    withValidation(
      _createValuePropsSDKFactory(valueSanitizer, valueSchema, inputValidator),
      {
        type: ["object"],
        properties: {},
      }
