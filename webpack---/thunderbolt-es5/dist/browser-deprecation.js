...
var userAgent =
  ((_c =
    (_b =
      (_a = _window.navigator) === null || _a === void 0
        ? void 0
...
var isIEbyDocumentMode = !!((_d = _window.document) === null || _d === void 0
  ? void 0
  : _d.documentMode);
...
var isSafari14InStudio = function () {
  ...
  var isWixStudio =
    ((_b =
      (_a = _window.viewerModel) === null || _a === void 0
        ? void 0
        : _a.site) === null || _b === void 0
      ? void 0
      : _b.editorName) === "Studio";
...
function reportBI() {
  ...
  (0, reportPhaseStarted_1.reportPhaseStarted)(
...
function supportsCssVars() {
  ...
  var isSupported = !!(
    ...
    _window.CSS.supports("font-weight", "var(--tmp-var)")
  );
  (_b =
    (_a = styleElement.parentNode) === null || _a === void 0
      ? void 0
      : _a.removeChild) === null || _b === void 0
    ? void 0
    : _b.call(_a, styleElement);
  return isSupported;
}
