...
function setTransformOptions(transformsObj, options) {
  ...
  transformsObj.autoEncode =
    (_a = options.autoEncode) !== null && _a !== void 0 ? _a : true;
...
function getUnsharpMask(transformsObj, options) {
  ...
  if (isUSMValid(options.unsharpMask)) {
    ...
    return {
      radius: roundToFixed(
        (_a = options.unsharpMask) === null || _a === void 0
          ? void 0
          : _a.radius,
        2
      ),
      amount: roundToFixed(
        (_b = options.unsharpMask) === null || _b === void 0
          ? void 0
          : _b.amount,
        2
      ),
      threshold: roundToFixed(
        (_c = options.unsharpMask) === null || _c === void 0
          ? void 0
          : _c.threshold,
        2
      ),
