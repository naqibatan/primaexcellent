...
const hasOverflow = (child) =>
  window.getComputedStyle(child).getPropertyValue("overflow") === "visible";
const getChildren = (element, tagNames) =>
  Array.from(element.children || []).filter((child) =>
    tagNames ? tagNames.includes(child.tagName.toLowerCase()) : true
  );
/**
 ...
 */
function getBoundingContentRect(
  element,
  offsetParent,
  tagNames,
