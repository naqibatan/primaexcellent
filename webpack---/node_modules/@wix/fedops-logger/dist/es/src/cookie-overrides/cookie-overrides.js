...
export var CookieOverrides = /*#__PURE__*/ (function () {
  ...
  function CookieOverrides() {
    ...
    this._overridesCookie =
      (_this$_getOverridesFr = this._getOverridesFromWindow()) != null
        ? _this$_getOverridesFr
        : this._getOverridesFromDocumentCookieIfExists();
  }

  CookieOverrides.persistGlobalOverrides = function persistGlobalOverrides(
    overridesObject
  ) {
  ...
  _proto._getOverridesFromDocumentCookieIfExists =
    function _getOverridesFromDocumentCookieIfExists() {
      try {
        var overridesCookieContent = getCookie(FEDOPS_OVERRIDES_COOKIE);
        var overridesObject = overridesCookieContent
...
function toOverridesWithoutDots(overridesMap, _ref) {
  ...
  return _objectSpread(
    _objectSpread({}, overridesMap),
    {},
    ((_objectSpread2 = {}),
    (_objectSpread2[appName.replace(/\./g, "-")] = overrides),
    _objectSpread2)
  );
}
