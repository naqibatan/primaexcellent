...
var getInteractionLogName = function getInteractionLogName(
  interactionName,
  eventGuid
) {
  return eventGuid
    ? "[guid: " + eventGuid + "] " + interactionName
    : interactionName;
};

var getInteractionNameFromLog = function getInteractionNameFromLog(
  interactionLogName
) {
...
var isArray = function isArray(possiblyArray) {
...
var BaseLogger = /*#__PURE__*/ (function () {
  ...
  _proto._reportIfNotSSR = function _reportIfNotSSR(
    dataSource,
    reporterEndpoint,
    params
  ) {
  ...
  _proto._getAppLoadingPhaseMarksForApp =
    function _getAppLoadingPhaseMarksForApp(_ref) {
  ...
  _proto._getTimesOfPhase = function _getTimesOfPhase(_ref2) {
    ...
    var phaseName = _ref2.phaseName,
      appPhasesMarks = _ref2.appPhasesMarks,
      appId = _ref2.appId;
    var startMarkTime =
      (_appPhasesMarks$find = appPhasesMarks.find(function (mark) {
        return (
          mark.name === "[fedops] phase:" + phaseName + " " + appId + " started"
        );
      })) == null
        ? void 0
        : _appPhasesMarks$find.startTime;
    var finishMarkTime =
      (_appPhasesMarks$find2 = appPhasesMarks.find(function (mark) {
        return (
          mark.name ===
          "[fedops] phase:" + phaseName + " " + appId + " finished"
        );
      })) == null
        ? void 0
        : _appPhasesMarks$find2.startTime;
    return {
  ...
  _proto.reportAppPhasesNetworkAnalysis =
    function reportAppPhasesNetworkAnalysis() {};
  /**
  ...
  _proto.httpRequest = function httpRequest(_ref4) {
    var artifactId = _ref4.artifactId,
      method = _ref4.method,
      url = _ref4.url;
  ...
  _proto.httpResponse = function httpResponse(_ref5) {
    var artifactId = _ref5.artifactId,
      method = _ref5.method,
  ...
  _proto._httpResponseTime = function _httpResponseTime(_ref6) {
    var artifactId = _ref6.artifactId,
      method = _ref6.method,
      responseTime = _ref6.responseTime,
      url = _ref6.url;
    var dataSource = this.dataSource
  ...
  _proto._getUrlTemplate = function _getUrlTemplate(url) {
    ...
    var convertedPathname = pathname
      .split("/")
      .filter(function (p) {
        return !!p;
      })
  ...
  _proto._shouldAddCustomParams = function _shouldAddCustomParams(
    customParams
  ) {
  ...
  _proto._addCustomParamsToEvent = function _addCustomParamsToEvent(
    dataSource,
    customParams
  ) {
    var customParamsObj =
  ...
  _proto.appLoaded = function appLoaded(_temp2) {
    var _ref7 = _temp2 === void 0 ? {} : _temp2,
      appId = _ref7.appId,
      customParams = _ref7.customParams,
  ...
  _proto.appLoadingPhaseStart = function appLoadingPhaseStart(name, _temp3) {
    ...
    var dataSource = this.dataSource
      ...
      .addItem(
        this.dataItems.loadingPhaseStart({
          name: name,
        })
      )
      .addItem(
  ...
  _proto._changeAppNameForEvent = function _changeAppNameForEvent(
    dataSource,
    appName
  ) {
    dataSource.addItem(
  ...
  _proto._sendPreviousPhaseIfNeeded = function _sendPreviousPhaseIfNeeded(
    name,
    _temp4
  ) {
  ...
  _proto.appLoadingPhaseFinish = function appLoadingPhaseFinish(
    name,
    _temp5,
    _temp6
  ) {
    var _ref10 = _temp5 === void 0 ? {} : _temp5,
      ...
      widgetArray = _ref10.widgetArray,
    ...
    var defaultParamsOverridesDataItem =
      this._getDataItemWithDefaultParamsOverrides({
        appName: appId,
      });
  ...
  _proto._getDataItemWithDefaultParamsOverrides =
    function _getDataItemWithDefaultParamsOverrides(_temp7) {
      var _ref12 = _temp7 === void 0 ? {} : _temp7,
        _ref12$appName = _ref12.appName,
        appName = _ref12$appName === void 0 ? null : _ref12$appName;
  ...
  _proto._sendLastAppLoadPhaseIfNeeded =
    function _sendLastAppLoadPhaseIfNeeded() {
      var appLoadingPhase = this.loadingPhases.getNextPhaseToReport();
      var shouldReportLastPhase =
        appLoadingPhase &&
        this.phasesConfig === phasesConfigValues.SEND_ON_START;
  ...
  _proto._markInteractionStarted = function _markInteractionStarted(
    interactionName
  ) {
    performance.mark(
      "[fedops] " +
  ...
  _proto._markAndMeasureInteractionEnded =
    function _markAndMeasureInteractionEnded(
      interactionName,
      outgoingInteraction
    ) {
  ...
  _proto.interactionStarted = function interactionStarted(
    interactionName,
    _temp8
  ) {
    var _this = this;
    ...
    var _ref13 = _temp8 === void 0 ? {} : _temp8,
      eventGuid = _ref13.eventGuid,
      stack = _ref13.stack,
      timeOverride = _ref13.timeOverride,
      interactionTimeout = _ref13.interactionTimeout,
      startHook = _ref13.startHook,
      timeoutHook = _ref13.timeoutHook,
      customParams = _ref13.customParams,
      paramsOverrides = _ref13.paramsOverrides;
  ...
  _proto.interactionEnded = function interactionEnded(interactionName, _temp9) {
    var _ref14 = _temp9 === void 0 ? {} : _temp9,
      eventGuid = _ref14.eventGuid,
      timeOverride = _ref14.timeOverride,
      timeoutId = _ref14.timeoutId,
      endHook = _ref14.endHook,
      customParams = _ref14.customParams,
      paramsOverrides = _ref14.paramsOverrides;

    var interactionLogName = getInteractionLogName(interactionName, eventGuid);
    var outgoingInteraction = isArray(
      this._outgoingInteractions[interactionLogName]
    )
  ...
  _proto._getInteractionsObjectFromWindow =
    function _getInteractionsObjectFromWindow() {
      var _env, _env$fedops, _env$fedops$apps, _env$fedops$apps$this;

      return (
        ((_env = env()) == null
          ? void 0
          : (_env$fedops = _env.fedops) == null
          ? void 0
          : (_env$fedops$apps = _env$fedops.apps) == null
          ? void 0
          : (_env$fedops$apps$this = _env$fedops$apps[this.appName]) == null
          ? void 0
          : _env$fedops$apps$this.interactions) || {}
      );
    };

  _proto._getInteractionFromWindowIfPresent =
    function _getInteractionFromWindowIfPresent(interactionName) {
  ...
  _proto._handleBlackboxPerformanceEntries =
    function _handleBlackboxPerformanceEntries(actualEnv, measurements) {
      var _this3 = this;
  ...
  _proto._sendBlackboxMeasurement = function _sendBlackboxMeasurement(
    measurement
  ) {
  ...
  _proto.getLoggerForWidget = function getLoggerForWidget(_ref18) {
    var appName = _ref18.appName,
      appId = _ref18.appId,
      widgetId = _ref18.widgetId,
      version = _ref18.version,
      timeoutHook = _ref18.timeoutHook,
      startHook = _ref18.startHook,
      endHook = _ref18.endHook,
      useGlobalLogger = _ref18.useGlobalLogger,
      paramsOverrides = _ref18.paramsOverrides,
      phasesConfig = _ref18.phasesConfig;
    var widgetAppName = appName || appId + "_" + widgetId;
    var widgetVersion = version || this.getAppVersion();
    var reporter = useGlobalLogger
      ? this.reporter
      : createReporter({
    ...
    var config = {
      ...
      paramsOverrides: _objectSpread(
        _objectSpread({}, this._constructorParamsOverrides),
        paramsOverrides
      ),
  ...
  _proto.reportErrorThrownOncePerFlow =
    function reportErrorThrownOncePerFlow() {
      var _this5 = this;
      ...
      if (unReportedErrorFlows.length) {
        unReportedErrorFlows.forEach(function (flow) {
          ...
          var dataSource = _this5.dataSource
            .addItem({
  ...
  _proto._errorHappenedInOneOfAppLoadFlows =
    function _errorHappenedInOneOfAppLoadFlows() {
      return (
  ...
  _proto._getAppLoadStartedIndication =
    function _getAppLoadStartedIndication() {
      var _performance$getEntri;

      var appLoadStartedMarkName =
        "[fedops] " + this.appName + " app-load-started";
      var appLoadStartedMark =
        (_performance$getEntri = performance.getEntriesByName(
          appLoadStartedMarkName
        )) == null
          ? void 0
          : _performance$getEntri[0];
  ...
  _proto._getAppLoadedIndication = function _getAppLoadedIndication() {
    ...
    var appLoadedMark =
      (_performance$getEntri2 =
        performance.getEntriesByName(appLoadedMarkName)) == null
        ? void 0
        : _performance$getEntri2[0];
    return appLoadedMark || this._appLoadedCalled[this.appName];
  };

  _proto._errorHappenedInAppLoadingPhasesFlow =
    function _errorHappenedInAppLoadingPhasesFlow(_temp10) {
      var _ref19 =
          _temp10 === void 0
            ? {
                appId: this.appName,
      ...
      for (
        var _iterator = _createForOfIteratorHelperLoose(phaseNames), _step;
  ...
  _proto._getFlowsOfError = function _getFlowsOfError() {
    var flowsWithErrors = this._errorHappenedInOneOfAppLoadFlows()
      ? [APP_LOAD_ERROR_FLOW]
      : [];
    return [].concat(
      flowsWithErrors,
  ...
  _proto._getInteractionNamesWhereErrorHappened =
    function _getInteractionNamesWhereErrorHappened() {
      var interactionsFromInstance =
      ...
      var interactionsFromWindow = Object.keys(
  ...
  _proto._getInteractionNamesWhereErrorHappenedFromInstance =
    function _getInteractionNamesWhereErrorHappenedFromInstance() {
      return Object.keys(this._outgoingInteractions).map(function (logName) {
        return getInteractionNameFromLog(logName);
      });
    };

  _proto._getInteractionNamesWhereErrorHappenedFromPerformanceMarks =
    function _getInteractionNamesWhereErrorHappenedFromPerformanceMarks() {
  ...
  _proto._getInteractionMarksOfCurrentApp =
    function _getInteractionMarksOfCurrentApp() {
      var _this6 = this;
  ...
  BaseLogger._getInteractionsThatDidntEndFromMarks =
    function _getInteractionsThatDidntEndFromMarks(interactionsMarks) {
      ...
      for (var interactionName in interactionsMarks) {
        if (interactionsMarks.hasOwnProperty(interactionName)) {
          ...
          var moreStartedOrEndedInteractions =
  ...
  BaseLogger._countStartedEndedInteractionMarks =
    function _countStartedEndedInteractionMarks(interactionsMarks) {
  ...
  _proto._reportWebVitalsWhenAvailable =
    function _reportWebVitalsWhenAvailable() {
      var _this7 = this;
      ...
      Promise.all([
        ...
        var webVitalsLoaded = _ref20[0],
          platformTenantAppNames = _ref20[1];
        var cls = webVitalsLoaded.cls,
          lcp = webVitalsLoaded.lcp;
        platformTenantAppNames.forEach(function (appName) {
          var dataSource = _this7.dataSource
            .addItem(_this7.dataItems.webVitalsLoaded())
            .addItem(
              _this7.dataItems.appName({
                appName: appName,
              })
            )
            .addItem({
      ...
      Promise.all([
        ...
        var webVitalsFirstInput = _ref21[0],
          platformTenantAppNames = _ref21[1];
        var delay = webVitalsFirstInput.delay;
        platformTenantAppNames.forEach(function (appName) {
          var dataSource = _this7.dataSource
            .addItem(_this7.dataItems.webVitalsFirstInput())
            .addItem(
              _this7.dataItems.appName({
                appName: appName,
              })
