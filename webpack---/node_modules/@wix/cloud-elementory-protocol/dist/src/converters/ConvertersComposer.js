...
var ConvertersComposer = /** @class */ (function () {
  ...
  ConvertersComposer.prototype.convertToCustomFormat = function (
    obj,
    parents,
    inArray
  ) {
    ...
    var serialized =
      (_a = this._findConverterToCustomFormat(obj)) === null || _a === void 0
        ? void 0
        : _a.convertToCustomFormat(obj, inArray);
    return isObjectButNotNull(obj)
      ? this._convertObject(serialized, obj, parents)
      : serialized;
  };
  ConvertersComposer.prototype.convertFromCustomFormat = function (obj) {
    ...
    if (Array.isArray(obj)) {
      ...
      preprocessedObj = (0, mapValues_1.mapValues)(
        obj,
        this.convertFromCustomFormat.bind(this)
      );
    }
    return (_a = this._findConverterFromCustomFormat(preprocessedObj)) ===
      null || _a === void 0
      ? void 0
      : _a.convertFromCustomFormat(preprocessedObj);
  };
  ConvertersComposer.prototype._convertObject = function (
    serialized,
    obj,
    parents
  ) {
    ...
    if (typeof serialized.toJSON === "function") {
      ...
      result = (0, mapValues_1.mapValues)(
        serialized.toJSON(),
        function (value) {
