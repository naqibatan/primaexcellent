!(function (e, n) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? define("promote-analytics-adapter", [], n)
    : "object" == typeof exports
    ? (exports["promote-analytics-adapter"] = n())
    : (e["promote-analytics-adapter"] = n());
    ...
    return (
      (function () {
        ...
        for (
          ...
          p.push((f + 256).toString(16).substr(1));
        var l = function (e) {
          var n =
        ...
        var E = ["type"],
          ...
          x = {
            ViewContent: function (e) {
              ...
              return [
                [
                  "track",
                  "ViewContent",
                  a()({}, O(t), { content_ids: [n], content_type: "product" }),
            ...
            Lead: function (e) {
              return [
                ["track", "Lead", I(e, T), { eventID: e._internalEventId }],
              ];
            },
            Schedule: function (e) {
              return [
                ["track", "Schedule", {}, { eventID: e._internalEventId }],
              ];
            },
          ...
          N = {
            ...
            ClickProduct: function (e) {
              ...
              return [["require", "ec"]]
                ...
                .concat([["send", "event", G(e.origin), "Product Click", n]]);
            },
            ViewContent: function (e) {
              var n = e.name ? e.name : "(not set)";
              return [["require", "ec"]]
            ...
            AddToCart: function (e) {
              ...
              return [["require", "ec"]]
                ...
                .concat([["send", "event", G(e.origin), "Add to Cart", n]]);
            },
            ...
            InitiateCheckout: function (e) {
              ...
              return [["require", "ec"]]
                ...
                .concat([["send", "event", G(e.origin), "Initiate Checkout"]]);
            },
            StartPayment: function (e) {
              var n = I({ step: 1, option: e.option }, S);
              return [["require", "ec"]]
                .concat([["ec:setAction", "checkout_option", n]])
                .concat([["send", "event", G(e.origin), "Start Payment"]]);
            },
            AddPaymentInfo: function (e) {
              var n = I({ step: 2, option: e.option }, S);
              return [["require", "ec"]]
                .concat([["ec:setAction", "checkout_option", n]])
                .concat([["send", "event", G(e.origin), "Add Payment Info"]]);
            },
            ...
            Purchase: function (e) {
              ...
              return (
                ...
                [["require", "ec"]]
                  ...
                  .concat([["send", "event", G(e.origin), "Purchase"]])
              );
            },
            Lead: function (e) {
              var n = e.category,
          ...
          X = {
            ...
            AddProductImpression: function (e) {
              ...
              return [
                [
                  [
                    a()({ event: "productImpression" }, t && { origin: t }, {
                      event_category: K(t),
                ...
                [
                  [
                    a()({ event: "removeFromCart" }, n && { origin: n }, {
                      event_label: Y(t.name),
                      event_category: K(n),
                      ecommerce: { remove: { products: [I(t, j)] } },
                    }),
                  ],
                ],
              ];
                ...
                [
                  [
                    a()({ event: "checkout" }, r && { origin: r }, {
                      event_category: K(r),
                      ecommerce: { checkout: { actionField: c, products: i } },
                    }),
                  ],
                ],
              ];
            ...
            CustomEvent: function (e) {
              var n = e.event,
                ...
                i = g()(e, F);
              return [
                [[a()({ event: t, event_label: r, event_category: o }, i)]],
              ];
            },
          };
        function B(e) {
        ...
        var Q = Object.keys(z).reduce(
          ...
          ee = {
            ...
            InitiateCheckout: { params: { evid: 1105 }, fields: Z.productList },
              ...
              (e[n] = function (e, t) {
                ...
                return (
                  ...
                  t.preventDefaultChannels
                    ? []
                    : ("Purchase" === n &&
                        (r.features = B({ reportedToFBonClient: !A(e) })),
                      [[r]])
                );
              }),
              e
        ...
        var ie,
            ...
            Purchase: function (e) {
              ...
              return [
                [
                  ...
                  a()(
                    {},
                    I({ revenue: n, id: t, currency: r, coupon: o }, Ie),
                    {
                      transaction_id: t,
          ...
          Se = function (e) {
            return (
              void 0 === e && (e = []),
              e.map(function (e) {
                return a()({}, I(e, Le), { content_type: "product" });
              })
            );
          },
          Ge = function (e) {
        ...
        var je = {
          ...
          Ke =
            (((ae = {})[je.GOOGLE_ANALYTICS_CONSENT_MODE] = Pe),
            (ae[je.GOOGLE_TAG_MANAGER_CONSENT_MODE] = X),
            ae),
          Ye =
            (((ue = {})[je.FACEBOOK_PIXEL] = x),
            (ue[je.GOOGLE_ANALYTICS] = N),
            (ue[je.GOOGLE_TAG_MANAGER] = X),
            (ue[je.WIX_ANALYTICS] = Q),
            (ue[je.BI_ANALYTICS] = te),
            (ue[je.GTAG] = de),
            (ue[je.GLOBAL_GTAG] = Pe),
            (ue[je.VK_RETARGETING] = {
              PageView: function () {
                return [[]];
              },
            }),
            (ue[je.YANDEX_METRICA] = Oe),
            (ue[je.TIKTOK_PIXEL] = De),
            ue),
          Xe = a()({}, Ke, Ye),
          Be =
            (((se = {})[je.WIX_DEVELOPERS_ANALYTICS] = function (e, n) {
              if (e) {
                if (window) {
