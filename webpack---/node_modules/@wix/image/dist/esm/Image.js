...
const fetchLQIP = ({ fittingType, src, target, options }) => {
  const placeholder = imageKit.getPlaceholder(
    fittingType,
    src,
    target,
    Object.assign(Object.assign({}, options), { autoEncode: true })
  );
  if (
    (placeholder === null || placeholder === void 0
      ? void 0
      : placeholder.uri) &&
    !/^[a-z]+:/.test(placeholder.uri)
  ) {
...
const Image = (props) => {
  ...
  if (!ssrImageData.current) {
    if (getPlaceholder || shouldUseLQIP || isInFirstFold || isSEOBot) {
      const options = Object.assign(
        Object.assign({ upscaleMethod }, quality ? quality : {}),
        { shouldLoadHQImage: isInFirstFold, isSEOBot }
      );
            ...
            imageData: Object.assign(
              Object.assign(
                Object.assign(
                  Object.assign(
                    Object.assign(
                      { width, height, uri, name, displayMode, hasAnimation },
                      quality && { quality }
                    ),
  ...
  const src =
    ssrResult === null || ssrResult === void 0 ? void 0 : ssrResult.uri;
  const srcset =
    ssrResult === null || ssrResult === void 0 ? void 0 : ssrResult.srcset;
  const placeholderStyle =
    (_a = ssrResult.css) === null || _a === void 0 ? void 0 : _a.img;
  ...
  React.useEffect(() => {
    ...
    if (
      onLoad &&
      (imgElment === null || imgElment === void 0
        ? void 0
        : imgElment.currentSrc) &&
      (imgElment === null || imgElment === void 0 ? void 0 : imgElment.complete)
    ) {
      onLoad({
  ...
  const maxWidth =
    ssrResult &&
    !(ssrResult === null || ssrResult === void 0
      ? void 0
      : ssrResult.transformed)
      ? `max(${width}px, 100%)`
      : targetWidth
      ? `${targetWidth}px`
      : null;
