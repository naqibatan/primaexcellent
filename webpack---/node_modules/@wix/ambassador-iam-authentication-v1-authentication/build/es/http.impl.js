...
var _signOnResponse = { identity: "_identity" };
...
export function loginWithIdpConnection(payload) {
  ...
  function __loginWithIdpConnection(_a) {
    ...
    var metadata = {
      ...
      method: "GET",
      methodFqn:
        "wix.iam.authentication.v1.AuthenticationService.LoginWithIdpConnection",
      url: resolveWixIamAuthenticationV1AuthenticationServiceUrl({
...
export function loginWithIdpConnectionCallback(payload) {
  ...
  function __loginWithIdpConnectionCallback(_a) {
    ...
    var metadata = {
      ...
      method: "GET",
      methodFqn:
        "wix.iam.authentication.v1.AuthenticationService.LoginWithIdpConnectionCallback",
      url: resolveWixIamAuthenticationV1AuthenticationServiceUrl({
      ...
      fallback: [
        {
          ...
          url: resolveWixIamAuthenticationV1AuthenticationServiceUrl({
            protoPath:
              "/v1/sso/callback/{tenantType}/{tenantId}/{idpConnectionId}",
            data: serializedData,
            host: host,
          }),
          params: toURLSearchParams(serializedData),
...
export function loginWithIdpConnectionTokenParams(payload) {
  ...
  function __loginWithIdpConnectionTokenParams(_a) {
    ...
    var metadata = {
      ...
      method: "POST",
      methodFqn:
        "wix.iam.authentication.v1.AuthenticationService.LoginWithIdpConnectionTokenParams",
      url: resolveWixIamAuthenticationV1AuthenticationServiceUrl({
...
export function proceedToNextState(payload) {
  ...
  function __proceedToNextState(_a) {
    ...
    var metadata = {
      ...
      method: "POST",
      methodFqn:
        "wix.iam.authentication.v1.AuthenticationService.ProceedToNextState",
      url: resolveWixIamAuthenticationV1AuthenticationServiceUrl({
