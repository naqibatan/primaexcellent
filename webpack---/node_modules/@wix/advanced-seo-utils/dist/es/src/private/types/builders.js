...
import { TWITTER_CARD_SUPPORTED_TYPES } from "./twitterTagSchemas";
  ...
  return __assign(
    {
      ...
      props: __assign(
        __assign(
          ((_b = {}), (_b[REL] = rel), (_b[HREF] = href), _b),
          title ? ((_c = {}), (_c[PROPS.TITLE] = title), _c) : {}
        ),
        type ? ((_d = {}), (_d[PROPS.TYPE] = type), _d) : {}
      ),
    },
    disabled ? { disabled: disabled } : {}
  );
...
var buildOgMetaRefs = function (_a) {
  var _b = _a === void 0 ? {} : _a,
    excludeTitle = _b.excludeTitle,
    excludeDescription = _b.excludeDescription;
  return [
    !excludeTitle &&
    ...
    !excludeDescription &&
      buildOgMeta(
        "og:description",
        "{{@".concat(IDENTIFIERS.DESCRIPTION, "}}")
      ),
  ].filter(Boolean);
};
...
var buildStructuredData = function (_a) {
  ...
  var _c = _a === void 0 ? {} : _a,
    ...
    removeSchemaIfAppsInstalled = _c.removeSchemaIfAppsInstalled,
    parentSchemaType = _c.parentSchemaType;
  var isDisabledProvided =
    [true, false].includes(disabled) || Array.isArray(disabled);
  var meta = __assign(
    __assign(
      __assign(
        __assign(
          __assign(
            __assign(
              __assign(
                __assign(
                  __assign({}, schemaType ? { schemaType: schemaType } : {}),
      ...
      removeSchemaIfAppsInstalled
        ? { removeSchemaIfAppsInstalled: removeSchemaIfAppsInstalled }
        : {}
    ),
    parentSchemaType ? { parentSchemaType: parentSchemaType } : {}
  );
  return __assign(
    __assign(
      {
        type: SCRIPT,
        props: ((_b = {}), (_b[TYPE] = "application/ld+json"), _b),
        children: typeof schema === "object" ? JSON.stringify(schema) : schema,
      },
      Object.keys(meta).length ? { meta: meta } : {}
    ),
    isDisabledProvided ? { disabled: disabled } : {}
  );
};
...
var buildTwitterMetaRefs = function (cardType) {
  return [
    buildTwitterMeta(
      "twitter:card",
      cardType || TWITTER_CARD_SUPPORTED_TYPES.SUMMARY_LARGE_IMAGE
    ),
    buildTwitterMeta("twitter:title", "{{@".concat(IDENTIFIERS.OG_TITLE, "}}")),
    buildTwitterMeta(
      "twitter:description",
      "{{@".concat(IDENTIFIERS.OG_DESCRIPTION, "}}")
    ),
