...
export function getContext(
  ...
  var defaultUrl =
    (_b = context[CONTEXT_PROPS.DEFAULT_URL]) === null || _b === void 0
      ? void 0
      : _b.replace(/\/$/, "");
  ...
  return __assign(
    __assign({}, context),
    ((_a = {}),
    (_a[CONTEXT_PROPS.DEFAULT_URL] = defaultUrl),
    (_a[CONTEXT_PROPS.IS_HOME_PAGE] = isHomePage),
    (_a[CONTEXT_PROPS.PAGE_NAME] = pageName),
    (_a[CONTEXT_PROPS.TITLE] = title),
    (_a[CONTEXT_PROPS.DESCRIPTION] = description),
    (_a[CONTEXT_PROPS.OG_IMAGE] = ogImage),
    (_a[CONTEXT_PROPS.OG_IMAGE_WIDTH] = ogImageWidth),
    (_a[CONTEXT_PROPS.OG_IMAGE_HEIGHT] = ogImageHeight),
    (_a[CONTEXT_PROPS.INDEX_PAGE] = indexPage),
    (_a[CONTEXT_PROPS.CURRENT_PAGE_URL] = currentPageUrl),
    (_a[CONTEXT_PROPS.ROBOTS_FROM_USER_PATTERN] = getValueByIdentifier(
      userPatternSchema.tags,
      IDENTIFIERS.ROBOTS
    )),
    (_a[CONTEXT_PROPS.TPA_PAGE_ID] = tpaPageId),
    _a)
  );
}
