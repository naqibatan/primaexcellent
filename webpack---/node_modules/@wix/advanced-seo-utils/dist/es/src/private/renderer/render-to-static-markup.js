...
var SELF_CLOSING_TAGS =
  ((_a = {}), (_a[TAG_TYPES.LINK] = true), (_a[TAG_TYPES.META] = true), _a);
...
var VALID_ATTRIBUTE_NAME_REGEX = new RegExp(
  "^["
    .concat(ATTRIBUTE_NAME_START_CHAR, "][")
    .concat(ATTRIBUTE_NAME_CHAR, "]*$")
);
/**
...
export function renderToStaticMarkup(_a, _b) {
  ...
  var _d = _b === void 0 ? {} : _b,
    _e = _d.allowDisabled,
    allowDisabled = _e === void 0 ? false : _e,
    _f = _d.logError,
    logError = _f === void 0 ? function () {} : _f;
  var sanitizedTags = sanitizeTags(tags, allowDisabled);
  return render(sanitizedTags, { logError: logError }).map(function (element) {
    ...
    var htmlAttributes = Object.keys(props)
      ...
      .map(function (prop) {
        return "".concat(prop, '="').concat(escapeHtml(props[prop]), '"');
      })
      .join(" ");
    ...
    if (SELF_CLOSING_TAGS[type]) {
      ...
      html = ""
        .concat(html, ">")
        .concat(renderChildren(props, type), "</")
        .concat(type, ">");
    }
    return html;
  });
