...
import { getAdapter } from "../../adapters-async";
import { getDefaultItemPayload } from "../../patterns/get-default-item";
import { logInfo } from "../../utils/log-info";
import { getPatternBlob } from "../../../async";
import { _getTags } from "../get-tags";
export function getTags(_a) {
  var _b = _a === void 0 ? {} : _a,
    ...
    _l = _b.options,
    options = _l === void 0 ? { logError: function () {} } : _l;
    ...
    return __generator(this, function (_m) {
      switch (_m.label) {
        case 0:
          ...
          itemType = veloItemPayload.itemType;
          return [4 /*yield*/, getPatternBlob(STATIC_PAGE_V2)];
        case 1:
          staticPagePatternBlob = _m.sent();
          return [4 /*yield*/, getAdapter(STATIC_PAGE_V2)];
        case 2:
          staticPageAdapter = _m.sent();
          return [4 /*yield*/, getPatternBlob(itemType)];
        case 3:
          itemTypePatternBlob = _m.sent();
          logInfo(
            options,
            { itemTypePatternBlob: itemTypePatternBlob, itemType: itemType },
            "getAdapter itemType"
          );
          return [4 /*yield*/, getAdapter(itemType)];
        case 4:
          adapter = _m.sent();
          return [
            4 /*yield*/,
            Promise.all(
              componentsItemPayload.map(function (componentItemPayload) {
                  ...
                  return __generator(this, function (_b) {
                    switch (_b.label) {
                      case 0:
                        ...
                        return [
                          4 /*yield*/,
                          getPatternBlob(componentItemPayload.itemType),
                        ];
                      case 1:
                        _a.patternBlob = _b.sent();
                        return [
                          4 /*yield*/,
                          getAdapter(componentItemPayload.itemType),
                        ];
                      case 2:
                        return [
                          2 /*return*/,
                          __assign.apply(void 0, [
                            ((_a.adapter = _b.sent()), _a),
