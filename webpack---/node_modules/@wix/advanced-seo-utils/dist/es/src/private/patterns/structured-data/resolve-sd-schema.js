export function resolveSdSchema(structuredData, _a) {
...
function clearEmptyFields(_a) {
  ...
  Object.entries(dataObject).forEach(function (_a) {
    var key = _a[0],
      val = _a[1];
    var isEmptyArray =
      (val === null || val === void 0 ? void 0 : val.length) === 0;
    if (val && typeof val === "object" && !isEmptyArray) {
      ...
      if (!val || isEmptyArray) {
        if (
          isKeyRequired(key, containerObject && containerObject[containerKey])
        ) {
