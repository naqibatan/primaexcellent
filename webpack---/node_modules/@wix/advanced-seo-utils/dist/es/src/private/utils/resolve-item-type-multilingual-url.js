...
var getPrimaryLanguage = function (languages) {
  ...
  return languages === null || languages === void 0
    ? void 0
...
export var resolveItemTypeMultilingualUrl = function (itemType, item, url) {
  ...
  if (!isMultilingualType(itemType)) {
    var primaryLanguage = getPrimaryLanguage(
      getRawValue(context, CONTEXT_PROPS.SITE_LANGUAGES)
    );
    return (
      ((_a = primaryLanguage[0]) === null || _a === void 0 ? void 0 : _a.url) ||
      url
    );
  }
  // Check if current url include param
  if (
    getRawValue(context, CONTEXT_PROPS.CURR_LANG_RESOLUTION_METHOD) ===
    "QueryParam"
  ) {
    try {
