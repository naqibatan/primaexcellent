...
import { resolvePayload } from "../../renderer/resolve-payload";
import { fillPatternValue } from "../../patterns/fill-in-pattern-blob";
import { IDENTIFIERS } from "../../types/Identifiers";
import { PATTERN_PREFIX, PATTERN_SUFFIX } from "../../consts";
import { resolveStructuredData } from "../structured-data/resolve-structured-data";
import { resolveSdSchema } from "../../patterns/structured-data/resolve-sd-schema";
...
export function getValueByIdentifierFromContext(
  payload,
  identifier,
  context,
  referencePath
...
export function getSchemasArray(tags, _a) {
  ...
  return resolveStructuredData(tags, context)
    ...
    .map(function (tag) {
      ...
      try {
        schema = JSON.parse(
          resolveSdSchema(tagSchema.getValue(tag), {
        ...
        logError({ error: error, data: { value: tag } });
        schema =
          getDefaultSchema(
            defaultSchema === null || defaultSchema === void 0
              ? void 0
              : defaultSchema.tags,
            selectedVariant
          ) || "{}";
...
function getDefaultSchema(defaultTags, selectedVariant) {
  ...
  return (
    ((_c =
      (_b =
        (_a =
          defaultTag === null || defaultTag === void 0
            ? void 0
            : defaultTag.meta) === null || _a === void 0
          ? void 0
          : _a.variants) === null || _b === void 0
        ? void 0
        : _b.find(function (variant) {
...
function getValueFromTagUsingContext(
  tag,
  identifier,
  context,
  tags,
