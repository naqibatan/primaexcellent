/******/ (function () {
  ...
  \*******************************/
    ...
    var defineProperty_default =
      /*#__PURE__*/ __webpack_require__.n(defineProperty); // CONCATENATED MODULE: ./js/consts.ts
    ...
    const GLOBAL_POLICY_CONTROL_SPEC =
      "specs.cookieConsent.PolicyByGlobalPrivacyControl"; // CONCATENATED MODULE: ./js/utils.ts
    ...
    function readCookieData(cookeName) {
      ...
      return (
        (cookieData == null
          ? void 0
          : (_cookieData$pop = cookieData.pop()) == null
          ? void 0
          : _cookieData$pop.replace(";", "")) || void 0
      );
    }
    function enabledExperiment(specName) {
      var _window,
        ...
        _window2,
        _window2$wixTagManage,
        _window2$wixTagManage2,
        _window2$wixTagManage3;
      if (
        typeof ((_window = window) == null
          ? void 0
          : (_window$wixTagManager = _window.wixTagManager) == null
          ? void 0
          : _window$wixTagManager.getConfig) !== "function"
      ) {
        return false;
      }
      return (
        ((_window2 = window) == null
          ? void 0
          : (_window2$wixTagManage = _window2.wixTagManager) == null
          ? void 0
          : (_window2$wixTagManage2 = _window2$wixTagManage.getConfig()) == null
          ? void 0
          : (_window2$wixTagManage3 = _window2$wixTagManage2.experiments) ==
            null
          ? void 0
          : _window2$wixTagManage3[specName]) === "true"
      );
    ...
    function getCurrentPolicy(hostname, consentPolicy) {
      ...
      return { defaultPolicy: true, policy };
    }
  ...
  */ if (isInGPCExperiment() && isWix(hostname) && isGPCOn()) {
      ...
      return consentPolicy
        ? clone(consentPolicy)
        : clone(isWix(hostname) ? WIX_US_GPC_POLICY : DEFAULT_POLICY);
    }
    function isGPCOn() {
      return !!navigator.globalPrivacyControl;
    }
    function isInGPCExperiment() {
      // currently open only is the US
    ...
    const dispatchPolicyChangedEvent = (policy) => {
      publishEvent(
        EVENT_NAMES.CONSENT_POLICY_CHANGED,
        [window, document],
        policy
      );
    };
    class ConsentPolicyManager {
      constructor() {
        defineProperty_default()(this, "config", { baseUrl: "" });
        ...
        defineProperty_default()(this, "init", (options) => {
          ...
          let triggerConsentPolicyChanged =
            this.shouldTriggerConsentPolicyChanged(config);
          this.initRan = true;
          ...
          publishEvent(
            EVENT_NAMES.CONSENT_POLICIY_INITIALIZED,
            [window, document],
            currentPolicy
          );
        ...
        defineProperty_default()(
          this,
          "setConsentPolicy",
          (policy, successCallback, errorCallback) => {
            if (policy === void 0) {
        ...
        defineProperty_default()(this, "getCurrentConsentPolicy", () =>
          getCurrentPolicy(this.hostname, this.config.consentPolicy)
        );
        defineProperty_default()(this, "_getConsentPolicyHeader", () =>
