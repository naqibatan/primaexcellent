...
exports.generateGradient =
  exports.isValidColor =
  exports.extractRGBA =
  exports.getColorFromCssStyle =
  exports.isHexValue =
  exports.isRgbValues =
  exports.isThemeColor =
  exports.isGreyscale =
  exports.formatColor =
  exports.getColorClass =
  exports.getColorAlpha =
  exports.getHexColor =
  exports.getSplitRgbValuesStringWithoutAlpha =
  exports.getSplitRgbValuesString =
  exports.getFromColorMap =
  exports.splitColor =
  exports.getRGBAColorString =
  exports.extractThemeColor =
  exports.brighten =
  exports.isColor =
    void 0;
...
const isRgbValues = (val) =>
  val ? /^\d+(,\d+){2,3}(\.\d+)?$/.test(val.replace(/\s/g, "")) : false;
exports.isRgbValues = isRgbValues;
const isHexValue = (val) =>
  val ? /(^#([a-f\d]{3}){1,2}$)/i.test(val.replace(/\s/g, "")) : false;
...
const splitColor = (rgbString) =>
  (0, color_1.default)(rgbString).array().join(",");
...
const isGreyscale = (colorObj) =>
  colorObj.red() === colorObj.green() &&
...
const isValidColor = (color) =>
  (0, exports.isColor)(color) ||
  isRgbValues(color) ||
  isHexValue(color) ||
  isThemeColor(color);
exports.isValidColor = isValidColor;
const generateGradient = (colorLayers, alpha, colorMap) =>
  (0, css_gradient_generator_1.generate)(colorLayers, {
    alpha,
