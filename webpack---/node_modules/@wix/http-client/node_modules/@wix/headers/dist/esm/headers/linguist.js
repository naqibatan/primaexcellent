    ...
    if (instanceId !== undefined) {
      return (
        ...
        (_b[LINGUIST_HEADER_KEY] = [
          lang,
          locale,
          isPrimaryLanguage === null || isPrimaryLanguage === void 0
            ? void 0
...
function getInstanceIdFromSignedInstance(signedInstance) {
  try {
    var encodedInstance = (
      signedInstance === null || signedInstance === void 0
        ? void 0
        : signedInstance.startsWith("wixcode")
    )
      ? signedInstance === null || signedInstance === void 0
        ? void 0
