import { variablePattern, placeholderPattern } from "./constants";
import { getUrlMapping } from "./get-url-mapping";
import { buildCustomUrlValidators } from "./param-validators/build-custom-url-validators";
var interpolate = function (itemData) {
  return function (placeholder) {
    ...
    return itemData === null || itemData === void 0
      ? void 0
      : itemData[itemDataKey];
  };
};
/**
 *
...
export var buildCustomizedUrl = function (urlMappings, key, itemData, options) {
  ...
  var error = buildCustomUrlValidators({ key: key, itemData: itemData });
  if (error) {
    throw error;
  }
