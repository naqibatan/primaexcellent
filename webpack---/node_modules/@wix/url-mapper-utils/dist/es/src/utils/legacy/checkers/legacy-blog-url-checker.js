...
import { legacyBlog, slugRegex } from "../../../constants";
import { resolveMappingVariables } from "../../resolve-mapping-variables";
import { getMatchedMappingIndex } from "../../../get-matched-mapping";
import { getUrlMapping } from "../../..";
import { UrlMappingsKeys } from "../../../constants/verticals/url-mappings-keys";
export var legacyBlogUrlChecker = function (urlMappings, url) {
  if (urlMappings === void 0) {
    urlMappings = { main: [] };
  }
  var mapping = (getUrlMapping(urlMappings, UrlMappingsKeys.BLOG_POST) || {})
    .mapping;
  if (
    !(mapping === null || mapping === void 0
      ? void 0
      : mapping.includes(legacyBlog.basicSlug))
  ) {
    return;
  }
  ...
  return __assign(__assign({}, dateSegments), { slug: slug });
};
