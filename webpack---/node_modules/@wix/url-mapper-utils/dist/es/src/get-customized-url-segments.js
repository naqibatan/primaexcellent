...
import { getMatchedMapping } from ".";
import { getUrlSegmentsValidators } from "./param-validators/get-url-segments-validators";
/**
 *
...
export var getCustomizedUrlSegments = function (urlMappings, url, options) {
  ...
  var error = getUrlSegmentsValidators({ url: url });
  if (error) {
    throw error;
  }
