...
export var getUrlMappingVariablesSchema = function () {
  return (
    Object.values(verticalsMapping).reduce(function (
      urlMappingKeysSchemaes,
      currentPageSchema
    ) {
...
export var getUrlMappingVariablesSchemaByKey = function (key) {
  ...
  if (!schema && isSubMappingsKey(key)) {
    console.warn(
      "You cannot get variables schema for subMappings key (".concat(key, ").")
    );
  }
  return schema;
};
...
export var getAllSubMappings = function () {
  return Object.values(getUrlMappingVariablesSchema()).reduce(function (
    obj,
    schema
  ) {
    return __assign(
...
export var getSubMappingsByUrlMappingKey = function (key) {
  ...
  return (
    ((_b =
      (_a = getUrlMappingVariablesSchema()) === null || _a === void 0
        ? void 0
...
export var getSubMapping = function (key) {
  ...
  return (_c =
    (_b =
      (_a = getMainUrlMappingSchemaBySubMappingKey(key)) === null ||
      _a === void 0
        ? void 0
        : _a[1]) === null || _b === void 0
      ? void 0
      : _b.subMappings) === null || _c === void 0
    ? void 0
    : _c[key];
};
  ...
  if (isSubMapping) {
          ...
          ((_b =
            (_a =
              schema === null || schema === void 0
                ? void 0
                : schema.subMappings) === null || _a === void 0
              ? void 0
              : _a[key]) === null || _b === void 0
            ? void 0
            : _b.required) || []
    ...
    required.push.apply(
      ...
      __spreadArray(
        [],
        __read(
          ((_c = getUrlMappingVariablesSchemaByKey(key)) === null ||
          _c === void 0
            ? void 0
            : _c.required) || []
        ),
