...
module.exports = function () {
  var dataFixerMandatoryParams =
    arguments.length > 0 && arguments[0] !== undefined
      ? arguments[0]
      : dataFixerMandatoryNonEmptyParams;
  ...
  var isInvalidParamValue = function isInvalidParamValue(paramName, params) {
    ...
    return (
      dataFixerMandatoryParam && isEmptyParam(dataFixerMandatoryParam, params)
    );
  };

  var getEmptyParams = function getEmptyParams(params) {
    return Object.keys(params).reduce(function (invalidParams, paramName) {
      return isInvalidParamValue(paramName, params)
        ? invalidParams.concat(paramName)
        : invalidParams;
    }, []);
  };
