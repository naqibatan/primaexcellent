...
import { SiteAssetsLoadModuleExecutorError } from "../index";
import { PagesInfoResolver } from "./pagesInfoResolver";
import { stringifyValues } from "../helper/objectHelper";
import { validateSiteAssetsSiteModels } from "./clientValidation";
import { getClientSpecMapPromise } from "./getClientSpecMapValue";
      ...
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            import(
              /* webpackChunkName: "module-executor" */ "@wix/site-assets-module-executor"
            ),
          ];
        case 1:
...
export var ClientModuleExecutor = function (
  config,
  collaborators,
  siteModels,
  urlBuilder,
  ...
  var execute = function (request) {
    ...
    var moduleExecutorConfig = {
      ...
      moduleTopology: {
        ...
        publicEnvironment: __assign(
          __assign({}, moduleTopology.publicEnvironment),
          { pageJsonUrl: pageJsonUrl }
        ),
      },
    };
    return loadModuleExecutor(collaborators.metricsReporter).then(function (
      makeModuleExecutor
    ) {
      ...
      var clientSpecMapPromise = getClientSpecMapPromise(
      ...
      return moduleExecutor(request.endpoint.controller).execute(
