...
function animate(kit, elements, duration, delay, _a = {}) {
  var { viewPortHeight = 1, browserFlags = {}, componentHeight = 1 } = _a,
    params = __rest(_a, ["viewPortHeight", "browserFlags", "componentHeight"]);
  ...
  if (browserFlags.animateRevealScrubAction) {
    ...
    elements.forEach((element) => {
      childrenToAnimate = REVEAL_SELECTORS.map((selector) =>
