...
function animate(kit, elements, duration, delay, _a = {}) {
  var { to = {}, ease = properties.schema.ease.default } = _a,
    params = __rest(_a, ["to", "ease"]);
  const sequence = kit.sequence(params);
  const animations = getFilteredParams(to).map(
    ([animationName, animationParams]) =>
      kit.animate(animationName, elements, duration, delay, {
        to: animationParams,
        ease,
      })
  );
