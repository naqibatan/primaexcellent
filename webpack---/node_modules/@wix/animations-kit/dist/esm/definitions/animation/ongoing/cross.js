...
import { getOutOfScreenDistance } from "../../../utils/animationsUtils";
const name = "Cross";
const properties = {
  schema: {},
};
...
function animate(kit, elements, duration, delay, _a) {
  ...
  elements.forEach((element) => {
    ...
    sequence
      ...
      .add(
        kit.animate("BasePosition", element, durationIn, 0, {
          to: {
            x: 0,
            y: 0,
          },
