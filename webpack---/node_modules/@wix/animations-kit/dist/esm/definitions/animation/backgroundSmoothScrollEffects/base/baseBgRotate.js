...
function animate(kit, elements, duration, delay, _a = {}) {
  var {
      baseRotation = properties.schema.baseRotation.default,
      in: {
        start: in_start = undefined,
        end: in_end = undefined,
        ease: in_ease = undefined,
        rotation: in_rotation = undefined,
      } = {},
      out: {
        start: out_start = undefined,
        end: out_end = undefined,
        ease: out_ease = undefined,
        rotation: out_rotation = undefined,
      } = {},
    } = _a,
    params = __rest(_a, ["baseRotation", "in", "out"]);
  ...
  if (hasInAnimation) {
    ...
    sequence.add(
      kit.animate("BaseRotate", elements, _duration, _delay, {
