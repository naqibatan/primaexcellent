...
function animate(kit, elements, duration, delay, _a = {}) {
  var { blur = properties.schema.blur.default } = _a,
    params = __rest(_a, ["blur"]);
  ...
  elements.forEach((element) => {
    ...
    kit.animate("BaseNone", element, 0, 0, { force3D: true });
    sequence.add(
      kit.animate("BaseAttribute", element, duration, delay, {
