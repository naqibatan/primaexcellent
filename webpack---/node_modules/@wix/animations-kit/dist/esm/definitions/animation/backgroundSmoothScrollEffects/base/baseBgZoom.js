 ...
 */
const getZ = (scale, perspective) =>
  (perspective * (scale - 1)) / (scale || 0.0001);
...
function animate(kit, elements, duration, delay, _a = {}) {
  ...
  if (!perspectiveParent) {
    console.warn(
      `animations-kit: ${name}: "perspectiveParent: element" is a mandatory parameter for this animation`
    );
  }
  ...
  sequence.add(
    kit.animate("BasePosition", perspectiveParent, duration, delay, {
      from: {
        perspective,
        perspectiveOrigin: `50% ${
          componentHeight / 2 - viewPortHeight * speedFactor
        }px`,
      },
      to: {
        perspective,
        perspectiveOrigin: `50% ${
          componentHeight / 2 + componentHeight * speedFactor
        }px`,
      },
      ease: "none",
  ...
  if (hasInAnimation) {
    ...
    sequence.add(
      kit.animate("BasePosition", elements, _duration, _delay, {
