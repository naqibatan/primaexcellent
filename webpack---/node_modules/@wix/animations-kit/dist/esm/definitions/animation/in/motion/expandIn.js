...
function animate(kit, elements, duration, delay, _a = {}) {
  var {
    ...
    params = __rest(_a, ["power", "initialScale", "direction", "easing"]);
  ...
  elements.forEach((element) => {
    ...
    if (direction !== "center") {
      const { center } = paramsMap,
        transformOriginMap = __rest(paramsMap, ["center"]);
      adjDirection = getAdjustedDirection(
        transformOriginMap,
        direction,
        elementAngleInDeg
      );
