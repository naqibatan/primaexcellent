...
const ease = "linear";
const rangeValues = {
  in: (clipFrom, _clipTo) => [{ fromValue: clipFrom, toValue: "" }],
  out: (clipFrom, _clipTo) => [{ fromValue: "", toValue: clipFrom }],
  continuous: (clipFrom, clipTo) => [
    { fromValue: clipFrom, toValue: "" },
    { fromValue: "", toValue: clipTo },
  ],
};
/**
 * RevealScroll
...
function animate(kit, elements, _duration, _delay, _a = {}) {
  ...
  elements.forEach((element) => {
    ...
    scenes.forEach(({ fromValue, toValue }) =>
      sequence.add(
        kit.animate("BaseClipPath", element, 1000, 0, {
          from: fromValue,
          to: toValue,
          ease,
        })
