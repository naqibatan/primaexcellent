...
function animate(kit, elements, duration, delay, _a = {}) {
  var {
      ...
      in: {
        ...
        skewX: in_skewX = undefined,
        skewY: in_skewY = undefined,
      } = {},
      out: {
        start: out_start = 0,
        end: out_end = 0,
        ease: out_ease = undefined,
        skewX: out_skewX = undefined,
        skewY: out_skewY = undefined,
      } = {},
    } = _a,
    params = __rest(_a, ["baseSkewX", "baseSkewY", "in", "out"]);
  ...
  if (hasInAnimation) {
    ...
    sequence.add(
      kit.animate("BaseSkew", elements, _duration, _delay, {
        from,
        to,
        ease: in_ease,
        force3D: true,
