...
function transition(
  ...
  var { stagger = 0, sourceEase = "Sine.easeInOut" } = _a,
    params = __rest(_a, ["stagger", "sourceEase"]);
  ...
  if (
    ...
    sequence.add(
      kit.animate("BaseScale", sourceElements, duration, delay, {
        to: { scale: 0 },
        ease: sourceEase,
        stagger,
      })
    ...
    sequence.add(
      kit.animate("BaseClipPath", sourceElements, duration, delay, {
