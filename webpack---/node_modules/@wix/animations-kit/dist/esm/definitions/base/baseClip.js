...
function animate(kit, elements, duration = 0, delay = 0, _a = {}) {
  ...
  return kit.engine.tween(
    elements,
    Object.assign({ duration, delay, from, to }, params),
    ["clip"]
  );
}
