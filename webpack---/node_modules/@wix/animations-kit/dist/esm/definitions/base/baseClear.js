    ...
    elements.forEach((element) => {
      ...
      cssToRestore.forEach((item) => {
        ...
        const restoreCondition =
          item.conditionAttr && element.getAttribute(item.conditionAttr);
        const shouldRestore =
          !restoreCondition || restoreCondition === item.conditionValue;
      ...
      if (Object.keys(restoreParams).length) {
        sequence.add(
          engine.tween(
            element,
            Object.assign(Object.assign({}, restoreParams), defaultParams),
...
function animate(kit, elements, duration = 0, delay = 0, _a = {}) {
  var { props = "", parentProps = "", to = {} } = _a,
    params = __rest(_a, ["props", "parentProps", "to"]);
  ...
  const elementParams = Object.assign(
    { duration, delay, to, clearProps: props },
    params
  );
