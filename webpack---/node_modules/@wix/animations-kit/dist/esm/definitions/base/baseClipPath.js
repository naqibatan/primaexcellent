...
function animate(kit, elements, duration = 0, delay = 0, _a = {}) {
  var { to = {}, from = {}, useClipRect = false } = _a,
    params = __rest(_a, ["to", "from", "useClipRect"]);
