...
import { toArray, unionArrays } from "@wix/wow-utils";
...
const convertEaseToGsap3 = (params) => {
  ...
  if (ease === null || ease === void 0 ? void 0 : ease.includes("ease")) {
    ...
    const easeConfig = Array.isArray(easeParams)
      ? `(${easeParams.join(",")})`
      : "";
    params.ease = `${easeClass}.${easeType}${easeConfig}`.replace(
      "linear.",
      ""
    );
    ...
    if (
      ease &&
      !(ease === null || ease === void 0 ? void 0 : ease.includes("."))
    ) {
...
function _callHandlerIfExists(sequenceOrTimeline, eventName) {
  ...
  const eventHandler =
    (_a = data === null || data === void 0 ? void 0 : data.callbacks) ===
      null || _a === void 0
      ? void 0
      : _a[eventName];
...
export class TweenEngineGreenSock {
  ...
  tween(elements, params = {}, allowedAnimationParamsList) {
    ...
    const allowedParamsUnioned = unionArrays(
      allowedAnimationParamsList,
  ...
  timeline(params, allowedAnimationParamsList = []) {
    const allowedParamsUnioned = unionArrays(
      allowedAnimationParamsList,
      _allowedGSAPTimelineParamsList
    );
    params = this._validateAnimationParams(params, allowedParamsUnioned);
    this._assignCallbacks(params);
  ...
  _fromTo(elements, params = {}) {
    ...
    toParams.data =
      (toParams === null || toParams === void 0 ? void 0 : toParams.data) || {};
    delete params.to;
    delete params.from;
  ...
  adjustLagSmoothing(threshold, adjustedLag) {
    ...
    (_b = (_a = this.gsap.ticker).lagSmoothing) === null || _b === void 0
      ? void 0
      : _b.call(_a, threshold, adjustedLag);
  }
  sequence(params) {
