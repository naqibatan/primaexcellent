...
import { getAnimationMode } from "../utils/definitionsUtils";
...
export class AnimationsKit {
  ...
  validateAnimation(name, params) {
    ...
    return validateSchema(properties.schema || {}, params, (errors) =>
      errors.forEach((error) => console.error(error))
    );
  }
  animate(name, elements, duration, delay = 0, params = {}) {
    if (
      this.validateAnimation(name, Object.assign({ duration, delay }, params))
    ) {
      return this.defs[name].animate(
        this,
        toArray(elements),
        duration,
        delay,
  ...
  transition(
    ...
    if (
      ...
      return this.defs[name].transition(
        this,
        toArray(sourceElements),
        toArray(destinationElements),
        duration,
        delay,
        params
      );
    }
    return this.defs.noTransition.transition(
      this,
      sourceElements,
      destinationElements,
      0,
