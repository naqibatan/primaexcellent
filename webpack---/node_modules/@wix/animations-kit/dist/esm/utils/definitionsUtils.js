 ...
 */
function getAllAnimationProperties({ defaults = {}, mobile = {} }) {
  const defaultProperties = Object.values(defaults).reduce(
    (acc, animationDef) => {
...
export { getAllAnimationProperties, getAnimationMode };
