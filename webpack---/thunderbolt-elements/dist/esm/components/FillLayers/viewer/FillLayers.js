...
const FillLayers = (props) => {
  ...
  const BgMedia = backgroundMedia
    ? React.createElement(
        BackgroundMedia,
        { id: `bgMedia_${containerId}`, ...backgroundMedia },
        Media
      )
    : React.createElement(
        "div",
        { id: `bgMedia_${containerId}`, className: styles.bgMedia },
        Media
      );
  const BgOverlay =
    backgroundOverlay &&
    React.createElement(BackgroundOverlay, { ...backgroundOverlay });
  return React.createElement(
    ...
    shouldPadMedia
      ...
      : React.createElement(React.Fragment, null, BgMedia, BgOverlay)
  );
};
