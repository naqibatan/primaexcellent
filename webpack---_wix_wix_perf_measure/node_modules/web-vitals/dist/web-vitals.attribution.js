var e,
  ...
  S = function (e) {
    "hidden" === document.visibilityState &&
      y > -1 &&
      ((y = "visibilitychange" === e.type ? e.timeStamp : 0), b());
  },
  L = function () {
  ...
  _ = function (e) {
    e.forEach(function (e) {
      e.interactionId &&
        ((U = Math.min(U, e.interactionId)),
        (V = Math.max(V, e.interactionId)),
        (j = V ? (V - U) / 7 + 1 : 0));
    });
  },
  z = function () {
    ...
    (t = t || {}),
      w(function () {
        ...
        var r,
          ...
          a = function (e) {
            e.forEach(function (e) {
              (e.interactionId && Y(e), "first-input" === e.entryType) &&
                !W.some(function (t) {
            ...
            var t,
              n = ((t = Math.min(W.length - 1, Math.floor(Q() / 50))), W[t]);
            n &&
              n.latency !== i.value &&
      ...
      (t = t || {}),
        w(function () {
          var n,
            ...
            a = function (e) {
              ...
              t &&
                ...
                ((i.value = Math.max(t.startTime - l(), 0)),
                (i.entries = [t]),
                n());
            },
          ...
          if (o) {
            ...
            var u = T(function () {
              te[i.id] ||
                (a(o.takeRecords()), o.disconnect(), (te[i.id] = !0), n(!0));
            });
