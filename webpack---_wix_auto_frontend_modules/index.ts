...
const wixOnlineProgramsLoader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixBenefitProgramsBackendV1Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
