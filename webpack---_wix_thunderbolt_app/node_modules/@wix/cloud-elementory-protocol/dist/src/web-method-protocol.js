...
exports.getBackendPackageNameFromImportName =
  exports.generateBackendPackageWebMethodUrl =
  exports.generatePackageWebMethodUrl =
  exports.exceptionToWebMethodPayload =
  exports.resultToWebMethodPayload =
    void 0;
var converters_1 = require("./converters");
var resultToWebMethodPayload = function (resultObj, replacer) {
  var result = replacer
    ? JSON.parse(JSON.stringify(resultObj, replacer))
    : (0, converters_1.convertToCustomFormat)(resultObj);
  return result === undefined ? {} : { result: result };
};
exports.resultToWebMethodPayload = resultToWebMethodPayload;
var exceptionToWebMethodPayload = function (
  error,
  messageProcessor,
...
var generatePackageWebMethodUrl = function (packageName, methodName) {
  return "/_webMethods/packages/"
    .concat(encodeURIComponent(packageName), "/")
    .concat(methodName, ".ajax");
};
...
var generateBackendPackageWebMethodUrl = function (packageName, methodName) {
  return generatePackageWebMethodUrl(
    "".concat(packageName, "-backend"),
    methodName
  );
};
