...
export function validateString(value, schema, reportError, messageParams) {
  ...
  if (enumArray && !assert.isIn(value, enumArray)) {
    reportError(
      messages.invalidEnumValueMessage(
        Object.assign({ value, enum: enumArray }, messageParams)
      ),
      Object.assign(Object.assign({}, messageParams), { value })
    );
  ...
  if (
    ...
    reportError(
      messages.invalidStringLengthMessage(
        Object.assign(
          { value, minimum: minLength, maximum: maxLength },
          messageParams
        )
      ),
      Object.assign(Object.assign({}, messageParams), { value })
  ...
  if (pattern && !new RegExp(pattern).test(value)) {
    reportError(
      messages.patternMismatchMessage(Object.assign({ value }, messageParams)),
      Object.assign(Object.assign({}, messageParams), { value })
    );
    return ValidationResult.Invalid;
  }
