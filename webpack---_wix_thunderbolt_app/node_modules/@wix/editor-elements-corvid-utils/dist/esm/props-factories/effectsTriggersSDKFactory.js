...
export const effectsTriggersSDKFactory = (api) => {
  const getEffects = () => {
    var _a;
    return (
      ((_a = api.effectsTriggersApi) === null || _a === void 0
        ? void 0
        : _a.getEffects()) || []
    );
  };
  return {
    effects: {
      ...
      toggleEffects: (effects) => {
        ...
        (_a = api.effectsTriggersApi) === null || _a === void 0
          ? void 0
          : _a.toggleEffects(...effects);
      },
      removeAllEffects: () => {
        var _a;
        return (_a = api.effectsTriggersApi) === null || _a === void 0
          ? void 0
          : _a.removeAllEffects();
      },
    },
