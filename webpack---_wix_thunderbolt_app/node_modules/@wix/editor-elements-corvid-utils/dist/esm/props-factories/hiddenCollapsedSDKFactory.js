  ...
  ({
    ...
    return {
      hide: async (effectName, effectOptions) => {
        ...
        if (
          ...
          const animationOptions = {
            ...
            effectOptions: Object.assign(
              Object.assign(
                {},
                (effectDefaultOptions === null ||
                effectDefaultOptions === void 0
                  ? void 0
        ...
        setState({ hidden: true });
        (_a =
          viewportState === null || viewportState === void 0
            ? void 0
            : viewportState.onViewportLeave) === null || _a === void 0
          ? void 0
          : _a.forEach((cb) => cb());
      },
      show: async (effectName, effectOptions) => {
        ...
        (_a =
          viewportState === null || viewportState === void 0
            ? void 0
            : viewportState.onViewportEnter) === null || _a === void 0
          ? void 0
          : _a.forEach((cb) => cb());
      },
      collapse: async () => {
      ...
      expand: async () => {
        ...
        if (state.collapsed) {
          const style = Object.assign(
            Object.assign({}, styleUtils.getExpandedStyles()),
