...
export const convertToCorvidEventBase = (event) => {
  ...
  return {
    target,
    type:
      (_a = reactToCorvidEventType[type]) !== null && _a !== void 0 ? _a : type,
    context,
  };
};
...
const mapMethodNameToEventName = (methodName) => {
  ...
  return (_a =
    mapEntry === null || mapEntry === void 0 ? void 0 : mapEntry[0]) !== null &&
    _a !== void 0
    ? _a
    : methodName;
};
...
export const registerCorvidEvent = (eventName, api, cb, projection) => {
  ...
  const { create$w, createEvent, registerEvent, getSdkInstance, metaData } =
    api;
  const setterName =
    (_a = eventNameMapToMethodName[eventName]) !== null && _a !== void 0
      ? _a
      : eventName;
  ...
  const unregisterEvent = registerEvent(
    ...
    (event, eventPayload) => {
      ...
      cb(
        Object.assign(
          Object.assign({}, convertToCorvidEventBase(baseEvent)),
          projectionEvent
        ),
        $w
      );
...
const isEventNameMatches = (eventName, userRequestedEventNameOrActionType) => {
  ...
  const targetEventName = mapMethodNameToEventName(
    (_a = EVENT_TYPES_MAP[userRequestedEventNameOrActionType]) !== null &&
      _a !== void 0
      ? _a
...
export const registerCorvidKeyboardEvent = (
  ...
  registerCorvidEvent(eventName, api, cb, ({ componentEvent, eventPayload }) =>
    Object.assign(
      Object.assign({}, convertToCorvidKeyboardEvent(componentEvent)),
      eventPayload &&
        (payloadProjection === null || payloadProjection === void 0
          ? void 0
          : payloadProjection(eventPayload))
    )
  );
/**
...
export const registerCorvidMouseEvent = (
  ...
  registerCorvidEvent(eventName, api, cb, ({ componentEvent, eventPayload }) =>
    Object.assign(
      Object.assign({}, convertToCorvidMouseEvent(componentEvent)),
      eventPayload &&
        (payloadProjection === null || payloadProjection === void 0
          ? void 0
          : payloadProjection(eventPayload))
