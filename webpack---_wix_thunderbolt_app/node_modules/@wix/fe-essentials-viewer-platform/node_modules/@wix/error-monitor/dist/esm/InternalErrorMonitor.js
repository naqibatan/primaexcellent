...
import { extractDetailsFromHttpErrors } from "./utils/extractDetailsFromHttpErrors";
import { isWixHttpError } from "./utils/isWixHttpError";
import { isAxiosError } from "./utils/isAxiosError";
import { handleNonErrorException } from "./utils/handleNonErrorException";
/**
    ...
    if (isWixHttpError(exception) || isAxiosError(exception)) {
      options = Object.assign(Object.assign({}, options), {
        contexts: Object.assign(
          Object.assign(
            {},
            options === null || options === void 0 ? void 0 : options.contexts
          ),
