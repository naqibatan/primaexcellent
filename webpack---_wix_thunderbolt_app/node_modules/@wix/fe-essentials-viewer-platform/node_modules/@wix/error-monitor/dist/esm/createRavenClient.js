...
import { RavenToSentryAdapter } from "./utils/RavenToSentryAdapter";
import { InternalErrorMonitor } from "./InternalErrorMonitor";
import { createRavenToSentryTransportTestkitAdapter } from "./utils/createRavenToSentryTransportTestkitAdapter";
/**
...
export function createRavenClient(options) {
  ...
  const ravenOptions = Object.assign(
    Object.assign(
      Object.assign(
        Object.assign({}, beforeSend && { dataCallback: beforeSend }),
  ...
  if (transport) {
    const ravenTransportAdapter =
      createRavenToSentryTransportTestkitAdapter(transport);
