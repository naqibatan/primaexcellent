...
export function handleNonErrorException(exception) {
  var _a, _b;
  switch (true) {
    case "message" in exception &&
      (exception === null || exception === void 0
        ? void 0
        : exception.message): {
      return Object.assign(new Error(exception.message), exception);
    }
    case "error" in exception &&
      ((_a =
        exception === null || exception === void 0
          ? void 0
          : exception.error) === null || _a === void 0
        ? void 0
        : _a.message): {
      return Object.assign(
        new Error(exception.error.message),
        exception === null || exception === void 0 ? void 0 : exception.error
      );
    }
    case "exception" in exception &&
      ((_b =
        exception === null || exception === void 0
          ? void 0
          : exception.exception) === null || _b === void 0
        ? void 0
        : _b.message): {
      return Object.assign(
    ...
    default: {
      ...
      console.log(
        "ErrorMonitor: please pass instance of an Error, instead error monitor received",
        exception
      );
      return exception;
    }
