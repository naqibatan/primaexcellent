...
const convertStreetAddressToAddressLine = ({ name, number }, countryCode) => {
  if (!name && !number) {
    return "";
  }
  if (!name || !number) {
...
export const convertWixAdressToGoogleAddress = (
  ...
  if (address.streetAddress) {
    ...
    const addressLine2 =
      (_a = address.addressLine2) !== null && _a !== void 0
        ? _a
  ...
  return {
    name:
      addressContactDetails === null || addressContactDetails === void 0
        ? void 0
        : addressContactDetails.fullName,
    organization:
      addressContactDetails === null || addressContactDetails === void 0
        ? void 0
        : addressContactDetails.company,
