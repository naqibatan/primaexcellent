...
import { ConductionMethod } from "../conduction-method";
  ...
  return __assign(
    __assign(
      __assign(
        __assign(
          {},
          getValueOrEmptyObject(
            "useNewApi",
            GlobalDefaultKeys.UseNewApi,
            "boolean"
          )
        ),
        getValueOrEmptyObject(
          "conductionMethod",
          GlobalDefaultKeys.ConductionMethod,
          checkConductionMethod
        )
      ),
      getValueOrEmptyObject(
        "siteOwnerId",
        GlobalDefaultKeys.OwnerAccountId,
        "string"
      )
    ),
    getValueOrEmptyObject(
      "loggedInUserId",
      GlobalDefaultKeys.LoggedInUserId,
      "string"
    )
  );
}
