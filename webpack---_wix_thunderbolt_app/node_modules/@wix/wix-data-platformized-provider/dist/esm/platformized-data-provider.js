...
var PlatformizedWixDataProvider = /** @class */ (function () {
  ...
  PlatformizedWixDataProvider.prototype.insert = function (
    collectionName,
    item,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.update = function (
    collectionName,
    item,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.save = function (
    collectionName,
    item,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.truncate = function (
    collectionName,
    options
  ) {
    var _this = this;
  ...
  PlatformizedWixDataProvider.prototype.remove = function (
    collectionName,
    itemId,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.bulkRemove = function (
    collectionName,
    itemIds,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.get = function (
    collectionName,
    itemId,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.find = function (
    collectionName,
    filter,
    order,
    skip,
  ...
  PlatformizedWixDataProvider.prototype.runAggregate = function (
    collectionName,
    pipeline,
    pageSize,
    options,
          ...
          return _this
            ._post(
              ...
              __assign(
                ...
                _this._getAggregatePaging(pipeline, pageSize, cursor)
              )
            )
  ...
  PlatformizedWixDataProvider.prototype._optionsWithPlugins = function (
    options
  ) {
    var safeOptions = options || {};
    return safeOptions.showDrafts
      ? __assign(__assign({}, safeOptions), {
          pluginOptions: { showDrafts: true },
        })
      : safeOptions;
  };
  PlatformizedWixDataProvider.prototype._platformizedSort = function (
    pipeline
  ) {
  ...
  PlatformizedWixDataProvider.prototype._getDataQuery = function (
    filter,
    order,
    limit,
    skip,
  ...
  PlatformizedWixDataProvider.prototype._getAggregatePaging = function (
    pipeline,
    limit,
    cursor
  ) {
  ...
  PlatformizedWixDataProvider.prototype._getPaging = function (
    limit,
    skip,
    cursor
  ) {
    if (cursor && skip > 0) {
      throw wixDataError(
        messages.cursorPagingDoesNotSupportSkip(),
  ...
  PlatformizedWixDataProvider.prototype.count = function (
    collectionName,
    filter,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.distinct = function (
    collectionName,
    filter,
    order,
    fieldName,
  ...
  PlatformizedWixDataProvider.prototype.bulkInsert = function (
    collectionName,
    items,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.bulkSave = function (
    collectionName,
    items,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.bulkUpdate = function (
    collectionName,
    items,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.queryReferenced = function (
    collectionName,
    holdingItem,
    propertyName,
    options
  ...
  PlatformizedWixDataProvider.prototype.insertReference = function (
    collectionName,
    relationshipName,
    left,
    right,
    ...
    return this._traceWith("platformized-provider-insert-reference", {
      ...
      return _this.insertReferences(
        collectionName,
        [{ relationshipName: relationshipName, left: left, right: right }],
        options
      );
    });
  };
  PlatformizedWixDataProvider.prototype.insertReferences = function (
    collectionName,
    references,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.replaceReferences = function (
    collectionName,
    query,
    newReferences,
    options
  ...
  PlatformizedWixDataProvider.prototype.removeReference = function (
    collectionName,
    relationshipName,
    left,
    right,
  ...
  PlatformizedWixDataProvider.prototype.removeReferences = function (
    collectionName,
    references,
    options
  ) {
  ...
  PlatformizedWixDataProvider.prototype.isReferenced = function (
    collectionName,
    propertyName,
    left,
    right
  ...
  PlatformizedWixDataProvider.prototype._validateOrderBy = function (
    collectionName,
    order
  ) {
    ...
    var isInvalidSort = function (elem) {
      ...
      var isValid =
        values.length === 1 && (values[0] === "asc" || values[0] === "desc");
      return !isValid;
    };
    ...
    if (isNotArray(order)) {
      return Promise.reject(
        this._validationError(collectionName, [nonArrayMessage(order)])
      );
    }
  ...
  PlatformizedWixDataProvider.prototype._validateFilter = function (
    collectionName,
    filter
  ) {
    ...
    var comparisonOperatorType =
      messages.filterTreeValidations.comparisonOperatorType;
    ...
    var matchesOperatorRequiredProperty =
      messages.filterTreeValidations.matchesOperatorRequiredProperty;
    var matchesOperatorIgnoreCase =
      messages.filterTreeValidations.matchesOperatorIgnoreCase;
    var matchesOperatorSpecItems =
      messages.filterTreeValidations.matchesOperatorSpecItems;
    ...
    var getErrors = function (filterRecords) {
      ...
      var $and = filterRecords.$and,
        ...
        restOfFilter = __rest(filterRecords, [
          "$and",
          "$or",
          "$not",
          "$gt",
    ...
    if ([null, undefined].includes(filter)) {
      ...
      return Promise.reject(
        this._validationError(collectionName, [
  ...
  PlatformizedWixDataProvider.prototype._validationError = function (
    collectionName,
    invalidArguments
  ) {
    return validationError(
      messages.queryValidations.queryInvalid(collectionName, invalidArguments)
    );
  };
  PlatformizedWixDataProvider.prototype._getAuthHeader = function () {
    return Promise.resolve(
      isProvider(this.authHeader) ? this.authHeader.get() : this.authHeader
    );
  };
  PlatformizedWixDataProvider.prototype._post = function (path, body) {
    var _this = this;
    return Promise.all([this._getGridAppId(), this._getAuthHeader()]).then(
      function (_a) {
        var gridAppId = _a[0],
          authHeader = _a[1];
        return _this.traceWith("wix-data-api-call", {
          ...
          return _this
            .httpClientProvider(body.options)
  ...
  PlatformizedWixDataProvider.prototype._getGridAppId = function () {
    return Promise.resolve(
      isProvider(this.gridAppId) ? this.gridAppId.get() : this.gridAppId
    );
  };
  PlatformizedWixDataProvider.prototype._traceWith = function (
    methodName,
    options
  ) {
    var _this = this;
    return function (fn) {
      return _this._getGridAppId().then(function (gridAppId) {
        return _this.traceWith(
          methodName,
          __assign({ gridAppId: gridAppId, segment: _this.segment }, options)
        )(fn);
      });
    };
  };
...
export { PlatformizedWixDataProvider };
