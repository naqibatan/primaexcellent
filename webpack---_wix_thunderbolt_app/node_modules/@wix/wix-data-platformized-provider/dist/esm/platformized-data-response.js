...
function isApplicationError(error) {
  var _a;
  return (_a = error === null || error === void 0 ? void 0 : error.details) ===
    null || _a === void 0
    ? void 0
    : _a.applicationError;
}
...
function isHookError(error) {
  ...
  return (
    ((_b =
      (_a = error === null || error === void 0 ? void 0 : error.details) ===
        null || _a === void 0
        ? void 0
        : _a.applicationError) === null || _b === void 0
      ? void 0
      : _b.code) === HooksErrorCode
  );
}
...
function getBulkErrorDetails(error) {
  ...
  if (isHookError(error)) {
    var jsError =
      (_b = appError.data) === null || _b === void 0 ? void 0 : _b.jsErrorValue;
    if (jsError) {
      return {
    ...
    var value =
      (_c = appError.data) === null || _c === void 0 ? void 0 : _c.value;
  ...
  return {
    code:
      mapErrorCode(
        appError === null || appError === void 0 ? void 0 : appError.code
      ) || codes.UnknownError,
    message:
      (appError === null || appError === void 0
        ? void 0
