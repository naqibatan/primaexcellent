...
import { queryFactory, queryResultFactory } from "./query";
import { groupFactory } from "./group";
import { aggregateFactory, aggregateFetchFactory } from "./aggregate";
import { filterBuilderFactory } from "@wix/platformized-filter-builder";
  ...
  function WixDataApi(provider) {
    ...
    this.insert = withArgs(function (args, collectionName, item, options) {
      return apiValidator()
        ...
        .validateAndReject()
        .then(function () {
          return mutate(_this.provider, "insert")(
            collectionName,
            item,
            options
          );
    ...
    this.bulkRemove = withArgs(function (
      args,
      collectionName,
      itemIds,
      options
      ...
      return apiValidator()
        ...
        .then(function (bulkResult) {
          ...
          return __assign(__assign({}, bulkResult), { errors: errors });
        });
    });
    ...
    this.update = withArgs(function (args, collectionName, item, options) {
      return apiValidator()
        ...
        .validateAndReject()
        .then(function () {
          return mutate(_this.provider, "update")(
            collectionName,
            item,
            options
          );
    ...
    this.fetchReferenced = withArgs(function (
      args,
      collectionName,
      cursor,
      limit,
    ...
    this.fetchAggregate = withArgs(function (
      args,
      collectionName,
      cursor,
      limit,
      ...
      return apiValidator()
        ...
        .validateAndReject()
        .then(function () {
          var aggregateRequest = aggregateFetchFactory(
            _this.provider,
            collectionName,
            limit,
            cursor
    ...
    this.queryReferenced = withArgs(function (
      args,
      collectionName,
      holdingItem,
    ...
    this.insertReference = withArgs(function (
      args,
      collectionName,
      relationshipAttribute,
      left,
      ...
      return validate().then(function () {
        return _this.provider.insertReferences(
          collectionName,
          normalizeRefs(refs),
          opts
        );
    ...
    this.replaceReferences = withArgs(function (
      args,
      collectionName,
      relationshipAttribute,
      left,
      ...
      return apiValidator()
        ...
        .validateAndReject()
        .then(function () {
          return _this.provider.replaceReferences(
            collectionName,
            {
              relationshipName: relationshipAttribute,
              left: left,
    ...
    this.removeReference = withArgs(function (
      args,
      collectionName,
      relationshipAttribute,
      left,
      ...
      return apiValidator()
        ...
        .then(function () {
          if (right.length === 1) {
            return _this.provider.removeReference(
              collectionName,
              relationshipAttribute,
              left,
              right[0],
            ...
            return _this.provider.removeReferences(
              collectionName,
              right.map(function (r) {
                return {
                  relationshipName: relationshipAttribute,
    ...
    this.isReferenced = withArgs(function (
      args,
      collectionName,
      relationshipAttribute,
      left,
      ...
      return apiValidator()
        ...
        .validateAndReject()
        .then(function () {
          return _this.provider.isReferenced(
            collectionName,
            relationshipAttribute,
            normalizeRefParameter(left),
            normalizeRefParameter(right),
            options
          );
        });
    });
    ...
    if (item) {
      for (var prop in item) {
        if (item.hasOwnProperty(prop)) {
          if (
            !originalItem.hasOwnProperty(prop) ||
            ((_a = Object.getOwnPropertyDescriptor(originalItem, prop)) ===
              null || _a === void 0
              ? void 0
              : _a.writable) === true
          ) {
