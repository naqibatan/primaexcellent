...
import { isString, isNumber, clone } from "@wix/wix-data-utils";
import {
...
import { filterMixin } from "@wix/platformized-filter-builder";
...
var WixDataQuery = /** @class */ (function (_super) {
  ...
  WixDataQuery.prototype.distinct = function (fieldName, options) {
    ...
    return rejectIfInvalid(this.invalidArguments, this.collectionName)
      ...
      .then(function () {
        return _this.provider.distinct(
          _this.collectionName,
          _this.filterTree,
          _this.orderBy,
          fieldName,
  ...
  WixDataQuery.prototype._transformOrderingForAggregates = function (
    orderBy,
    fieldName
  ) {
    if (orderBy === void 0) {
  ...
  WixDataQuery.prototype._setQuerySpecificInvalidArguments = function (
    newQuery
  ) {
    ...
    var invalidArguments = __spreadArray(
      __spreadArray(
        [],
    ...
    return Object.assign(newQuery, { invalidArguments: invalidArguments });
  };
  WixDataQuery.prototype._queryValidator = function (
    operatorName,
    invalidArguments
  ) {
...
function rejectIfInvalid(invalidArguments, collectionName) {
  ...
  if (allInvalids.length > 0) {
    return Promise.reject(
      validationError(
        messages.queryValidations.queryInvalid(collectionName, allInvalids)
      )
    );
  } else {
...
var WixDataQueryResult = /** @class */ (function () {
  ...
  WixDataQueryResult.prototype._rejectNoPrevPage = function () {
    return Promise.reject(
      validationError(
        messages.queryValidations.noPrevPage(this.query.collectionName)
      )
    );
  };
  WixDataQueryResult.prototype._rejectNoNextPage = function () {
    return Promise.reject(
      validationError(
        messages.queryValidations.noNextPage(this.query.collectionName)
      )
    );
  };
  return WixDataQueryResult;
})();
export { WixDataQueryResult };
var QueryValidator = /** @class */ (function (_super) {
  ...
  QueryValidator.prototype._isNumber = function (specifier, operand) {
    ...
    return this.addValidation(
      ...
      function () {
        return messages.queryValidations.isNumber(
          _this.operatorName,
          specifier,
          operand
        );
  ...
  QueryValidator.prototype.isPositiveNumber = function (operand) {
    ...
    return this._isNumber("positive", operand).addValidation(
      ...
      function () {
        return messages.queryValidations.isPositiveNumber(
          _this.operatorName,
          operand
        );
      }
  ...
  QueryValidator.prototype.isNonNegativeNumber = function (operand) {
    ...
    return this._isNumber("non-negative", operand).addValidation(
      ...
      function () {
        return messages.queryValidations.isNonNegativeNumber(
          _this.operatorName,
          operand
        );
      }
  ...
  QueryValidator.prototype.notGreaterThan = function (operand, value) {
    ...
    return this.addValidation(
      ...
      function () {
        return messages.queryValidations.notGreaterThan(
          _this.operatorName,
          operand,
          value
        );
...
export function queryResultFactory(
  result,
  provider,
  collectionName,
  limit,
