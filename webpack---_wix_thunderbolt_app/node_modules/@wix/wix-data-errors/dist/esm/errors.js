import { typeForDisplay } from "@wix/wix-data-utils";
import { UserCodeError } from "@wix/cloud-base-errors-definitions";
...
export var messages = {
  ...
  invalidArgumentLength: function (method, from, to, actual) {
    return "WDE0008: wixData."
      .concat(method, " expects between ")
      .concat(from, " and ")
      .concat(to, " arguments, but was called with ")
      .concat(actual, ".");
  },
  ...
  aggregateValidations: {
    ...
    filterMustBeBuilder: function (operatorName) {
      return "WDE0011: Invalid "
        .concat(operatorName, " usage. ")
        .concat(operatorName, " requires WixDataFilter.");
    },
  ...
  referenceOperationFieldError: function (fieldName) {
    return "WDE0020: Provided property [".concat(
      fieldName,
      "] is not a multi-reference field."
    );
  },
  ...
  schemaDoesNotExist: function (collectionName) {
    return "WDE0025: The ".concat(
      collectionName,
      " collection does not exist. You cannot work with a collection using the Data API before it is created in the Editor."
    );
  },
  collectionDeleted: function (collectionName) {
    return "WDE0026: The ".concat(
      collectionName,
      " collection was removed, so you cannot work with it. To restore its data, create a new collection with the same name."
    );
  },
  permissionDenied: function (action, collectionName) {
    return "WDE0027: The current user does not have permissions to "
      .concat(action, " on the ")
      .concat(collectionName, " collection.");
  },
  ...
  queryValidations: {
    ...
    isNumber: function (operatorName, specifier, operand) {
      return "WDE0032: Invalid "
        .concat(operatorName, " parameter [")
        .concat(typeForDisplay(operand), "]. ")
        .concat(operatorName, " parameter must be a ")
        .concat(specifier, " number.");
    },
    isPositiveNumber: function (operatorName, operand) {
      return "WDE0033: Invalid "
        .concat(operatorName, " parameter [")
        .concat(operand, "]. ")
        .concat(operatorName, " parameter must be a positive number.");
    },
    isNonNegativeNumber: function (operatorName, operand) {
      return "WDE0034: Invalid "
        .concat(operatorName, " parameter [")
        .concat(operand, "]. ")
        .concat(operatorName, " parameter must be a non-negative number.");
    },
    isInteger: function (operatorName, operand) {
      return "WDE0035: Invalid "
        .concat(operatorName, " parameter [")
        .concat(operand, "]. ")
        .concat(operatorName, " parameter must be an integer.");
    },
    isNonEmptyString: function (operatorName) {
      return "WDE0094: Invalid "
        .concat(operatorName, " parameter. ")
        .concat(operatorName, " parameter must be non-empty string.");
    },
    notGreaterThan: function (operatorName, operand, value) {
      return "WDE0036: Invalid "
        .concat(operatorName, " parameter [")
        .concat(operand, "]. ")
        .concat(operatorName, " parameter cannot exceed ")
        .concat(value, ".");
    },
  ...
  arityValidations: {
    arityIsZero: function (operatorName) {
      return "WDE0038: Invalid "
        .concat(operatorName, " usage. ")
        .concat(operatorName, " does not take parameters.");
    },
    arityIsOne: function (operatorName) {
      return "WDE0039: Invalid "
        .concat(operatorName, " usage. ")
        .concat(operatorName, " requires one parameter.");
    },
    arityIsTwo: function (operatorName) {
      return "WDE0040: Invalid "
        .concat(operatorName, " usage. ")
        .concat(operatorName, " requires two parameters.");
    },
    arityIsThree: function (operatorName) {
      return "WDE0041: Invalid "
        .concat(operatorName, " usage. ")
        .concat(operatorName, " requires three parameters.");
    },
    arityIsAtLeastTwo: function (operatorName) {
      return "WDE0042: Invalid "
        .concat(operatorName, " usage. ")
        .concat(operatorName, " requires at least two parameters.");
    },
    arityIsAtLeastOne: function (operatorName) {
      return "WDE0043: Invalid "
        .concat(operatorName, " usage. ")
        .concat(operatorName, " requires at least one parameter.");
    },
  },
  filterValidations: {
    typeIsString: function (operatorName, value) {
      return "WDE0044: Invalid "
        .concat(operatorName, " parameter value [")
        .concat(typeForDisplay(value), "]. ")
        .concat(operatorName, " parameter must be a String.");
    },
    typeIsStringNumberOrDate: function (operatorName, value) {
      return "WDE0045: Invalid "
        .concat(operatorName, " parameter value [")
        .concat(typeForDisplay(value), "]. Valid ")
        .concat(operatorName, " parameter types are String, Number or Date.");
    },
    sameType: function (operatorName, first, second) {
      return "WDE0046: Invalid "
        .concat(operatorName, " parameter values [")
        .concat(typeForDisplay(first), "] and [")
        .concat(
          typeForDisplay(second),
    ...
    typeIsStringNumberOrDateForAll: function (operatorName) {
      return "WDE0047: Invalid "
        .concat(operatorName, " usage. ")
        .concat(operatorName, " supports only Number, String or Date items.");
    },
    validFieldName: function (operatorName, field) {
      return "WDE0048: Invalid "
        .concat(operatorName, " field value [")
        .concat(typeForDisplay(field), "]. ")
        .concat(operatorName, " field must be a String.");
    },
    isInstanceOfSameClass: function (operatorName, constructorName, obj) {
      return "WDE0049: Invalid "
        .concat(operatorName, " parameter [")
        .concat(typeForDisplay(obj), "]. ")
        .concat(operatorName, " expects ")
        .concat(constructorName, " only.");
    },
    isForCollection: function (operatorName, constructorName, collectionName) {
      return "WDE0050: Invalid "
        .concat(operatorName, " parameter query for [")
        .concat(collectionName, "]. ")
        .concat(operatorName, " accepts ")
        .concat(constructorName, " for the same collection only.");
    },
  ...
  filterTreeValidationsAjv: {
    objectType: function (operatorName) {
      return "WDE0056: ".concat(
        operatorName,
        " should be an Object. Got ${0} instead"
      );
    },
    arrayType: function (operatorName) {
      return "WDE0057: ".concat(
        operatorName,
        " should be an Array. Got ${0} instead"
      );
    },
    arrayLength: function (operatorName, expectedLength) {
      return "WDE0057: ${0}.length is ${0/length}. "
        .concat(operatorName, " Array should have length ")
        .concat(expectedLength);
    },
    comparisonOperatorType: function (operatorName) {
      return "WDE0058: ".concat(
        operatorName,
        " should be a Date, Number, or String. Got ${0} instead"
      );
    },
    stringOperatorType: function (operatorName) {
      return "WDE0059: ".concat(
        operatorName,
        " should be a String. Got ${0} instead"
      );
    },
    setOperatorItems: function (operatorName) {
      return "WDE0060: ".concat(
        operatorName,
        " Array should only contain values of types Date, Number, and String. Got ${0} instead"
      );
    },
    ...
    matchesOperatorRequiredProperty: function (propertyName) {
      return "WDE0062: $matches value ${0} does not have property ".concat(
        propertyName
      );
    },
  ...
  filterTreeValidations: {
    objectType: function (operatorName, value) {
      return "WDE0056: "
        .concat(operatorName, " should be an Object. Got ")
        .concat(stringify(value), " instead");
    },
    arrayType: function (operatorName, value) {
      return "WDE0057: "
        .concat(operatorName, " should be an Array. Got ")
        .concat(stringify(value), " instead");
    },
    arrayLength: function (operatorName, expectedLength, value) {
      return "WDE0057: "
        .concat(stringify(value), ".length is ")
        .concat(value.length, ". ")
        .concat(operatorName, " Array should have length ")
        .concat(expectedLength);
    },
    comparisonOperatorType: function (operatorName, value) {
      return "WDE0058: "
        .concat(operatorName, " should be a Date, Number, or String. Got ")
        .concat(stringify(value), " instead");
    },
    stringOperatorType: function (operatorName, value) {
      return "WDE0059: "
        .concat(operatorName, " should be a String. Got ")
        .concat(stringify(value), " instead");
    },
    ...
    matchesOperatorRequiredProperty: function (propertyName, value) {
      return "WDE0062: $matches value "
        .concat(stringify(value), " does not have property ")
        .concat(propertyName);
    },
  ...
  sortValidations: {
    typeIsStringOrArrayOfStrings: function (operatorName, effectiveArgs) {
      return "WDE0051: Invalid "
        .concat(operatorName, " parameters [")
        .concat(effectiveArgs.map(typeForDisplay), "]. Valid ")
        .concat(
          operatorName,
  ...
  operationNotSupported: function (collectionName, operation) {
    return ""
      .concat(collectionName, " does not support ")
  ...
  itemDoesNotExist: function (id, collectionName) {
    return "WDE0073: Item ["
      .concat(id, "] does not exist in collection [")
      .concat(collectionName, "].");
  },
  ...
  invalidIdForSingleItemCollection: function (
    collectionName,
    expectedId,
    receivedId
  ) {
    return "WDE0079: ["
      .concat(
        collectionName,
        "] is a single item collection and item must have id ["
      )
      .concat(expectedId, "], but got [")
      .concat(receivedId, "] instead.");
  },
...
export function dataHookError(err) {
  function buildObj(error) {
    if (error === undefined) {
      ...
      return {
        type: "error",
        value: { name: name_1, message: message, code: code },
      };
    } else {
...
export function schemaNotFoundError(collectionName) {
  return wixDataError(
    messages.schemaDoesNotExist(collectionName),
    codes.SchemaDoesNotExist
  );
}
