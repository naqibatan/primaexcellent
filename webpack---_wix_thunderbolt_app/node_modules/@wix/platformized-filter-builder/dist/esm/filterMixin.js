...
var filterMixin = function (Base) {
  ...
  return (function (_super) {
    ...
    class_2.prototype._validateCollectionName = function (
      query,
      originalQuery,
      operationName
    ) {
      ...
      var withCollectionName = withCollectionNameIfUnset(
        originalQuery,
        this.collectionName
      );
      var _a = new FilterValidator(
          operationName,
    ...
    class_2.prototype._matchesUrlized = function (field, operand) {
      var _a = this._filterValidator("._matchesUrlized")
        ...
        valid = _a[1];
      if (valid) {
        var newFilterTree = this._makeNewFilter.apply(
          this,
          __spreadArray([field], createMatchesOrInFilter(operand), false)
        );
...
var FilterValidator = (function (_super) {
  ...
  FilterValidator.prototype.typeIsString = function (value) {
    ...
    return this.addValidation(
      ...
      function () {
        return messages.filterValidations.typeIsString(
          _this.operatorName,
          value
        );
      }
  ...
  FilterValidator.prototype.typeIsStringNumberOrDate = function (value) {
    ...
    return this.addValidation(
      ...
      function () {
        return messages.filterValidations.typeIsStringNumberOrDate(
          _this.operatorName,
          value
        );
      }
  ...
  FilterValidator.prototype.sameType = function (first, second) {
    ...
    return this.addValidation(
      ...
      function () {
        return messages.filterValidations.sameType(
          _this.operatorName,
          first,
          second
        );
  ...
  FilterValidator.prototype.typeIsStringNumberOrDateForAll = function (values) {
    ...
    return this.addValidation(
      ...
      function () {
        return messages.filterValidations.typeIsStringNumberOrDateForAll(
          _this.operatorName
        );
      }
    );
  ...
  FilterValidator.prototype.validFieldName = function (field) {
    ...
    return this.addValidation(
      ...
      function () {
        return messages.filterValidations.validFieldName(
          _this.operatorName,
          field
        );
      }
  ...
  FilterValidator.prototype.isInstanceOfSameClass = function (obj) {
    ...
    return this.addValidation(
      ...
      function () {
        return messages.filterValidations.isInstanceOfSameClass(
          _this.operatorName,
  ...
  FilterValidator.prototype.isForCollection = function (
    otherFilterBuilder,
    ...
    return this.addValidation(
      ...
      function () {
        return messages.filterValidations.isForCollection(
          _this.operatorName,
          _this.constructorName,
...
function withCollectionNameIfUnset(filter, name) {
  ...
  return new filter.constructor(
    __assign(__assign({}, filter), { collectionName: collectionName })
  );
}
