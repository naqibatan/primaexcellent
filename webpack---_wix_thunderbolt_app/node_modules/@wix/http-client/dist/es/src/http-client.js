...
export class HttpClient {
  ...
  async request(requestOptionsOrFactory, overrides) {
    ...
    const requestOptions =
      typeof requestOptionsOrFactory === "function"
    ...
    const signedInstance =
      (overrides === null || overrides === void 0
        ? void 0
        : overrides.signedInstance) ||
      ((_b = (_a = this.opts).getAppToken) === null || _b === void 0
        ? void 0
        : _b.call(_a)) ||
      "";
  ...
  getCustomHeaders(requestOptions, signedInstance, urlObject) {
    ...
    const authHeader =
      signedInstance && isWixDomain(url)
        ? { authorization: signedInstance }
        : {};
    const customHeaders = this.opts.createHeaders();
    const originalUrlHeader = getUrlHeaders(
      getGlobalConfig(),
      requestOptions,
      urlObject
    );
    return Object.assign(
      Object.assign(Object.assign({}, originalUrlHeader), customHeaders),
      authHeader
    );
  }
  handleRequestError(error, requestOptions) {
    ...
    silent(() => {
      var _a;
      return (_a = requestOptions.onError) === null || _a === void 0
        ? void 0
        : _a.call(requestOptions, requestError);
    });
    throw requestError;
  }
  maybeFallbackRequest(err, requestOptions, urlObject, signedInstance) {
    var _a, _b, _c;
    const shouldFallbackRequest =
      isHttpMockServerEnabled() &&
      shouldAllowUnmocked() &&
  ...
  transformResponse(res, requestOptions) {
    ...
    return Object.assign(Object.assign({}, res), { data, requestId });
  }
}
          ...
          try {
            Object.keys(jsonResponse).forEach((key) => {
              if (typeof jsonResponse[key] === "string") {
                jsonResponse[key] = sanitizer.sanitizeFor(
                  "span",
                  jsonResponse[key]
                ).innerHTML;
