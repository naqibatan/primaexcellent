...
export var RequestHandler = function (
  config,
  urlBuilder,
  clientModuleExecutor,
  serverModuleResultExtractor,
  buildHttpClientAdapter,
  buildModuleMetricsReporter,
  ...
  return function (request) {
    ...
    var returnErrorOrAttemptFallback = function (
      siteAssetsUrl,
      httpRequestError
    ) {
      var siteAssetsServerError = new SiteAssetsServerError(
        siteAssetsUrl,
        httpRequestError
      );
    ...
    var executeModuleOnServer = function () {
      var siteAssetsUrl;
      try {
        siteAssetsUrl = urlBuilder.siteAssetsUrl(
          request,
      ...
      var siteAssetsServerHttpHandler =
        siteAssetsServerHttpHandlerBuilder.build(
          siteAssetsUrl,
          request.timeout,
          request.customRequestSource,
          request.customRouting,
          request.bypassSsrInternalCache,
          request.extendedTimeout
        );
      return httpClientAdapter
        .call(siteAssetsServerHttpHandler)
