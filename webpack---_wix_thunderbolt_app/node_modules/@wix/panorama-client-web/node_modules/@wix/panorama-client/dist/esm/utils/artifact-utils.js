import { StacktraceScriptType } from "../types";
import { last } from "./general-utils";
const scriptRegexs = [
  {
...
export const getArtifactDataFromBaseParams = (baseParams) => {
  const { fullArtifactId, artifactVersion } = baseParams;
  return {
...
export const isSameArtifact = (artifactData1, artifactData2) =>
  artifactData1.artifactId === artifactData2.artifactId;
export const isArtifactMismatch = (
  currentArtifactData,
  stackTraceArtifactsData
) =>
  stackTraceArtifactsData.length > 0 &&
  currentArtifactData.artifactId !== stackTraceArtifactsData[0].artifactId;
export const getFirstMatchingArtifact = (
  artifactData,
  stackTraceArtifactsData
) => {
