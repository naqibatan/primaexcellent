...
const extractWixHttpErrorDetailsRec = (error) => {
  ...
  return defaults(res, {
    ...
    requestId:
      (_httpClientError$resp =
        (_httpClientError$resp2 = httpClientError.response) == null ||
        (_httpClientError$resp2 = _httpClientError$resp2.headers) == null
          ? void 0
          : _httpClientError$resp2["x-wix-request-id"]) != null
        ? _httpClientError$resp
        : httpClientError.requestId,
  });
};
export const extractWixHttpErrorDetails = (error) =>
  defaults(extractWixHttpErrorDetailsRec(error), {
