...
import { DurationTracker } from "./lib/duration-tracker";
import {
  buildErrorPayload,
  buildLoggerPayload,
...
export class BasePanoramaClient {
  constructor(_ref) {
    var _this = this;
    let { baseParams, globalConfig, reporter, hooksManager, data, isMuted } =
      _ref;
  ...
  reportError(error, data, options) {
    ...
    data = this.data
      .addDataScope([data, options == null ? void 0 : options.data])
      .getData();
    if (
