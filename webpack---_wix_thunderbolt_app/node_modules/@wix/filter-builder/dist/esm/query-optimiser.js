...
function fullyOptimisedArray(query) {
  ...
  var somethingChanged =
    0 <
    optimisedElements.filter(function (_a) {
...
function applyFirstOptimisation(node) {
  for (
    var _i = 0, optimisations_1 = optimisations;
    _i < optimisations_1.length;
    _i++
  ) {
...
function optimisedAndsAsObjects(node) {
  ...
  args.forEach(function (arg) {
    if (isOperator(arg)) {
      operatorObjects = __spreadArray(
        __spreadArray([], operatorObjects, true),
        [arg],
        false
      );
    } else {
      basicObjects = __spreadArray(
        __spreadArray([], basicObjects, true),
        [arg],
        false
      );
    }
  ...
  var combinedBasicObjects = Object.assign.apply(
    Object,
    __spreadArray([{}], basicObjects, false)
  );
