...
var FilterValidator = (function () {
  ...
  FilterValidator.prototype.typeIsString = function (value) {
    ...
    return this.addValidation(
      ...
      function () {
        return "Invalid "
          .concat(_this.operatorName, " parameter value [")
          .concat(typeForDisplay(value), "]. ")
          .concat(_this.operatorName, " parameter must be a String.");
      }
    );
  };
  ...
  FilterValidator.prototype.sameType = function (first, second) {
    ...
    return this.addValidation(
      ...
      function () {
        return "Invalid "
          .concat(_this.operatorName, " parameter values [")
  ...
  FilterValidator.prototype.typeIsStringNumberOrDateForAll = function (values) {
    ...
    return this.addValidation(
      ...
      function () {
        return "Invalid "
          .concat(_this.operatorName, " usage. ")
          .concat(
            _this.operatorName,
  ...
  FilterValidator.prototype.validFieldName = function (field) {
    ...
    return this.addValidation(
      ...
      function () {
        return "Invalid "
          .concat(_this.operatorName, " field value [")
          .concat(typeForDisplay(field), "]. ")
          .concat(_this.operatorName, " field must be a String.");
      }
    );
  };
  FilterValidator.prototype.isInstanceOfSameClass = function (obj) {
    ...
    return this.addValidation(
      ...
      function () {
        return "Invalid "
          .concat(_this.operatorName, " parameter [")
          .concat(typeForDisplay(obj), "]. ")
          .concat(_this.operatorName, " expects FilterBuilder only.");
      }
    );
  };
  FilterValidator.prototype.arityIsOne = function (args) {
    ...
    return this.addValidation(
      ...
      function () {
        return "Invalid "
          .concat(_this.operatorName, " usage. ")
          .concat(_this.operatorName, " requires one parameter.");
      }
    );
  };
  FilterValidator.prototype.arityIsTwo = function (args) {
    ...
    return this.addValidation(
      ...
      function () {
        return "Invalid "
          .concat(_this.operatorName, " usage. ")
          .concat(_this.operatorName, " requires two parameters.");
      }
    );
  };
  FilterValidator.prototype.arityIsThree = function (args) {
    ...
    return this.addValidation(
      ...
      function () {
        return "Invalid "
          .concat(_this.operatorName, " usage. ")
          .concat(_this.operatorName, " requires three parameters.");
      }
    );
  };
  FilterValidator.prototype.arityIsAtLeastTwo = function (args) {
    ...
    return this.addValidation(
      ...
      function () {
        return "Invalid "
          .concat(_this.operatorName, " usage. ")
          .concat(_this.operatorName, " requires at least two parameters.");
      }
    );
  };
