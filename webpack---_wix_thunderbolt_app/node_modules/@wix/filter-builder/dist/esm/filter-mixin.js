...
var filterMixin = function (Base) {
  ...
  return (function (_super) {
    ...
    class_2.prototype._binaryAnd = function (
      ...
      var newFilterTree = this._makeNewFilter(
        field,
        filterOperatorSymbol,
        operand
      );
    ...
    class_2.prototype._AndLogicalEquivalence = function (
      filterOperatorSymbol,
      operatorName,
      args
    ) {
    ...
    class_2.prototype._AndStringOperand = function (
      filterOperatorName,
      operatorName,
      args
    ) {
    ...
    class_2.prototype._AndSetOperand = function (
      filterOperatorName,
      operatorName,
      args
    ) {
    ...
    class_2.prototype._makeNewFilter = function (
      field,
      filterOperatorName,
      operand
    ) {
      ...
      var newFilter = this._buildFilter(
        field,
        filterOperatorName,
        serializableOperand
      );
    ...
    class_2.prototype._buildFilter = function (
      field,
      filterOperatorName,
      operand
    ) {
