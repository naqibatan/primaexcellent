...
import { generateKeyVariations, isParamTranslatable } from "../../generateKey";
import { paramShouldInheritDesktop } from "../../utils/paramShouldInheritDesktop";
import { getTranslationDefaultFunction } from "./translationDefaultFunction";
...
export function getSettingsValue(publicData, param, _a, scope) {
  ...
  var shouldInheritFromAppScope =
    scope === "COMPONENT" && param.inheritFromAppScope;
...
export function getSettingsDefaultValue(values, scope, param, options) {
  ...
  var t =
    (_a = options.t) !== null && _a !== void 0
      ? _a
      : getTranslationDefaultFunction({
          environmentLabel:
            (_b = options.environmentLabel) !== null && _b !== void 0
              ? _b
  ...
  return param.getDefaultValue({
    ...
    getSettingParamValue: function (settingParam, overrides) {
      ...
      return getSettingsValue(
        values,
        settingParam,
        __assign(__assign(__assign({}, options), overrides), { t: t }),
        scope
      );
    },
  });
