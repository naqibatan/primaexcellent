...
import { getMultilingualLanguage, getQueryParams } from "./utils";
export var getSiteLanguage = function (wixCodeApi, isEditor) {
  var multilingualLanguage = getMultilingualLanguage(
...
export var isEditorX = function (styleParams) {
  var _a;
  return (_a =
    styleParams === null || styleParams === void 0
      ? void 0
      : styleParams.booleans.responsive) !== null && _a !== void 0
    ? _a
    : false;
};
