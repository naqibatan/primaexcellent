...
export var getPanelUrl = function (componentName, panelName, options) {
  ...
  if (isLocal) {
    return (
      "https://editor.wixapps.net/render/local/panels/" +
      componentName +
      "/" +
      panelName +
      "?cdnPort=" +
  ...
  return (
    "https://editor.wixapps.net/render/prod/panels/" +
...
export var getModalUrl = function (componentName, panelName, instance) {
  var _a;
  var isLocal = process.env.NODE_ENV === "development";
  var urlPostfix = componentName + "/" + panelName;
  if (isLocal) {
    return (
      "https://editor.wixapps.net/render/local/modals/" +
      urlPostfix +
      "?cdnPort=" +
