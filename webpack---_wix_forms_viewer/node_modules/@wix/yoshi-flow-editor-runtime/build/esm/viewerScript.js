...
import { PlatformControllerFlowAPI } from "./flow-api/PlatformController";
import {
...
var platformControllerWrapper = function (
  optionalDeps,
      ...
      switch (_a.label) {
        case 0:
          flowAPI = new OOIControllerFlowAPI({
            translations: viewerScriptFlowAPI.createTranslations(
              controllerDescriptor,
              optionalDeps
            ),
          ...
          return [
            ...
            controllerDescriptor.method({
              ...
              dangerousPublicDataOverride:
                createDangerousPublicDataOverride(flowAPI),
...
var blocksControllerWrapper = function (
  optionalDeps,
  controllerDescriptor,
  controllerConfig
) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            blocksControllerService.getWrappedController(
              controllerDescriptor,
              controllerConfig,
              flowAPI,
              optionalDeps
...
var ooiControllerWrapper = function (
  optionalDeps,
  controllerDescriptor,
  controllerConfig
) {
  ...
  var wrappedController = Promise.all([
    controllerWithErrorBoundary(
      ...
      flowAPI,
      controllerDescriptor.appName,
      controllerDescriptor.componentName
    ),
...
var wrapControllerByWidgetType = function (
  optionalDeps,
  controllerDescriptor,
  controllerConfig
) {
  switch (controllerDescriptor.widgetType) {
    case BLOCKS_COMPONENT_TYPE:
      return blocksControllerWrapper(
        optionalDeps,
        controllerDescriptor,
        controllerConfig
      );
    ...
    case PLATFORM_WIDGET_COMPONENT_TYPE_DEPRECATED:
      return platformControllerWrapper(
        optionalDeps,
        controllerDescriptor,
        controllerConfig
      );
...
export var createControllers = function (
  optionalDeps,
  createController,
  translationsConfig,
  experimentsConfig,
...
var getControllerFromControllerModule = function (controllerModule) {
  ...
  var controllerKey =
    Object.keys(controllerModule).find(function (key) {
...
var isBlocksController = function (controllerConfig) {
  var _a, _b, _c;
  return (
    ((_a = controllerConfig.appParams) === null || _a === void 0
      ? void 0
      : _a.blocksData) ||
    ((_c =
      (_b = controllerConfig.appParams) === null || _b === void 0
        ? void 0
        : _b.appData) === null || _c === void 0
      ? void 0
      : _c.blocksPreviewData)
  );
};
// imported from code generation wrappers/templates/CommonViewerScriptEntry.ts
export var createControllersWithDescriptors = function (
  optionalDeps,
  controllerDescriptors,
  includeControllersInViewerScript
) {
  ...
  return function (controllerConfigs, controllerModulesMap) {
    ...
    controllerConfigs.forEach(function (controllerConfig) {
      ...
      var controllerDescriptor = getDescriptorForConfig(
        widgetId,
        controllerDescriptors
      );
      ...
      if (!controllerDescriptor) {
        ...
        console.error(
          'Seems like you have components outside of editor flow project. Please, move the component "' +
            widgetId +
            '" to "' +
            (controllerDescriptor === null || controllerDescriptor === void 0
              ? void 0
              : controllerDescriptor.projectName) +
      ...
      if (!controllerDescriptor) {
        if (process.env.NODE_ENV === "development") {
          console.info(
            "Yoshi Editor Flow doesn't support initializing controllers from non-editor flow artifacts. Please, consider moving \"" +
              widgetId +
              '" controller to yoshi-flow-editor project. For now this controller will be skipped.'
          );
        }
        return;
      }
      if (controllerDescriptor.widgetType !== BLOCKS_COMPONENT_TYPE) {
        ...
        if (shouldUseExternalController) {
          var controllerModule =
            controllerModulesMap === null || controllerModulesMap === void 0
              ? void 0
              : controllerModulesMap[widgetId];
          if (!controllerModule) {
            return;
          }
          controllerDescriptor.method =
