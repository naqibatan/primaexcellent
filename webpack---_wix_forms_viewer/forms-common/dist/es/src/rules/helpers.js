...
var OppositeOperations =
  ((_a = {}),
  (_a["filled" /* ConditionOperationType.Filled */] = [
    "not filled" /* ConditionOperationType.NotFilled */,
  ]),
  (_a["filled with" /* ConditionOperationType.FilledWith */] = [
    "not filled" /* ConditionOperationType.NotFilled */,
  ]),
...
var isActionOperationEquals = function (rule1, rule2) {
  return (
    _.get(rule1, "actions[0].operation") ===
    _.get(rule2, "actions[0].operation")
  );
};
...
var isOppositeConditionOperation = function (rule1, rule2) {
  return isOppositeOperation(
    getConditionOperationType(rule1),
    getConditionOperationType(rule2)
  );
};
...
var contradictionType1 = function (_a) {
  ...
  return (
    conditionFieldEquals && oppositeConditionOperation && actionOperationEquals
  );
};
var contradictionType2 = function (_a) {
  ...
  return (
    conditionFieldEquals && conditionOperationEquals && oppositeActionOperation
  );
};
var findContradictionRuleIndex = function (comparedRule, rules, fromIndex) {
  return _.findIndex(
    ...
    function (rule) {
      ...
      var conditionOperationEquals = isConditionOperationEquals(
        comparedRule,
        rule
      );
      var oppositeConditionOperation = isOppositeConditionOperation(
        comparedRule,
        rule
      );
      var oppositeActionOperation =
        commonFields.length > 0 &&
        isOppositeActionOperation(comparedRule, rule);
      var actionOperationEquals =
        commonFields.length > 0 && isActionOperationEquals(comparedRule, rule);
      var predsInput = {
